...
; The absolute path to a PHP binary file in case Matomo cannot detect your PHP binary. Ensure the configured PHP binary
; is of type CLI and not for example cgi or litespeed. To find out the type of interface for a PHP binary execute
; this command: php -r "echo php_sapi_name();"
php_binary_path = ""
