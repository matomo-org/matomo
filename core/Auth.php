...
interface Auth
{
     ...
     *
     * An implementation that cannot verify a hash, such as one authenticating against an external
     * directory, may reject any value it is given. A caller passing null only to clear previously set
     * state has to tolerate that rejection rather than treat it as an authentication error.
     *
