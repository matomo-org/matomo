...
class Db
{
    ...
    {
        return self::fromContainer()->exec($sql);
    }
    ...
    {
        return self::fromContainer()->query($sql, $parameters);
    }
    ...
    {
        return self::fromContainer()->fetchAll($sql, $parameters);
    }
    ...
    {
        return self::fromContainer()->fetchRow($sql, $parameters);
    }
    ...
    {
        return self::fromContainer()->fetchOne($sql, $parameters);
    }
    ...
    {
        return self::fromContainer()->fetchAssoc($sql, $parameters);
    }
