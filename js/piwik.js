 ...
 * - Opera 7
 *
 * For compatibility with IE6 and IE7 or later version in document modes < 8 it is necessary to include a JSON library like JSON3.
 */
            ...
            function getRequest(request, customData, pluginMethod, currentEcommerceOrderTs) {
                ...
                if (!ses) {
                    ...
                    if (referralUrl.length
                        ...
                        setCookie(refname, JSON.stringify(attributionCookie), configReferralCookieTimeout, configCookiePath, configCookieDomain);
                    }
                }
                ...
                if (customVariables) {
                    ...
                    if (configStoreCustomVariablesInCookie) {
                        setCookie(cvarname, JSON.stringify(customVariables), configSessionCookieTimeout, configCookiePath, configCookieDomain);
                    }
                }
