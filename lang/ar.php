...
$translations = array(
	...
	'Goals_HelpMultipleConversionsPerVisit' => 'نوصي بأن يتم بتحديد هذا الاختيار على سبيل المثال في أهداف المواقع التجارية حيث قد يضع الزائر عدة طلبات في الزيارة ذاتها، وترغب في تتبع كافة هذه الطلبات على أنها تحويلات للهدف.',
