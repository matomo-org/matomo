...
$translations = array(
	...
	'General_PiwikIsACollaborativeProjectYouCanContribute' => '%1$s Piwik %2$s je společný projekt. %3$s Pokud jej míte rádi, můžete nám pomoct! Prohlédněte si %4$s Jak přispět do Piwiku?%5$s ',
	'General_YouAreCurrentlyViewingDemoOfPiwik' => 'Prohlížíte si demo %s; %stáhněte si%s plnou verzi! Prohlédněte si %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Je k dispozici Piwik %1$s. %2$s Prosím aktualizujte jej!%3$s (viz %4$s změny%5$s).',
	...
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Databáze Piwiku bude aktualizována z verze %1$s na novou verzi %2$s.',
	...
	'CoreUpdater_HelpMessageContent' => 'Zkontrolujte %1$s Piwik FAQ %2$s , který vysvětluje nejčastějsí chybi při aktualizaci. %3$s Požádejte vašeho systémového administrátora - může vám pomoct s chybou, která je nejčastěji způsobena nastavením serveru MySQL.',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'One Click aktualizace Piwiku byla stornována. Pokud nemůžete opravit chybu je doporučeno Piwik aktualizovat manuálně. %1$s Prosím zkontrolujte pro začátek %2$sDokumentaci k aktualizaci%3$s!',
	...
	'UsersManager_ExceptionInvalidLoginFormat' => 'Přihlašovací jméno musí obsahovat mezi %1$s a %2$s znaky a obsahovat pouze písměna, čísla, nebo znaky \'_\' nebo \'-\' nebo \'.\'',
	...
	'Installation_TablesWithSameNamesFound' => 'Některé %1$s tabulky ve vaší databázi %2$s mají stejná jména jako tabulky, které se snaží vytvořit Piwik',
	...
	'Installation_ErrorInvalidState' => 'Chyba: zdá se, že se snažíte přeskočit krok instalace, nebo máte zakázány cookies, nebo již je konfigurační soubor Piwiku vytvořen. %1$sUjistěte se, že máte povoleny cookies%2$s a vraťte se zpět %3$s na první stránku instalace %4$s.',
