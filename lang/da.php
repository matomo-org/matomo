...
$translations = array(
	...
	'General_DashboardForASpecificWebsite' => 'Kontrolpanel for et specifik website',
	'General_MultiSitesSummary' => 'Alle websites',
	'General_AllWebsitesDashboard' => 'Kontrolpanel for alle websites',
	'General_SingleWebsitesDashboard' => 'Kontrolpanel for et website',
	'General_API' => 'API',
	...
	'General_VisitTypeExample' => 'F. eks., for at vælge alle besøgende, som er vendt tilbage til websitet, herunder dem, der har købt noget i deres tidligere besøg, vil API-anmodningen indeholde %s',
	...
	'General_ColumnNbUniqVisitorsDocumentation' => 'Antal unikke besøg på dit website. Hver besøgende tælles kun én gang, selvom websitet besøges flere gange om dagen.',
	'General_ColumnNbVisits' => 'Besøg',
	'General_ColumnNbVisitsDocumentation' => 'Hvis en besøgende kommer til websitet for første gang, eller hvis det sidste besøg er mere end 30 minutter efter første besøg, vil det blive registreret som et nyt besøg.',
	...
	'General_ColumnAvgTimeOnSite' => 'Gennemsnitstid på websitet',
	...
	'General_ColumnExitRateDocumentation' => 'Procentdel af besøg, der forlod websitet efter at have set denne side.',
	'General_ColumnTotalPageviews' => 'Totale sidevisninger',
	'General_ColumnViewedAfterSearch' => 'Klikkede i søgeresultater',
	'General_ColumnViewedAfterSearchDocumentation' => 'Antallet af gange denne side er blevet besøgt efter en besøgende lavede en søgning på dit website, og klikkede på denne side i søgeresultaterne.',
	...
	'General_ColumnBouncesDocumentation' => 'Antal besøg, der startede og sluttede på siden. Det betyder, at den besøgende forlod websitet efter kun at have set denne side.',
	...
	'General_ColumnAverageTimeOnPageDocumentation' => 'Den gennemsnitlige tid, besøgende har brugt på siden (kun denne side, ikke hele websitet).',
	...
	'General_ArchivingInlineHelp' => 'For websites med medium til høj trafik anbefales det at deaktivere Piwik-arkivering udløst fra browseren. I stedet anbefales det at køre et cron job hver time til at behandle Piwik rapporter.',
	...
	'General_SmallTrafficYouCanLeaveDefault' => 'For websites med lidt trafik brug standard %s sekunder og få adgang til alle rapporter i realtid.',
	'General_MediumToHighTrafficItIsRecommendedTo' => 'For websites med medium til høj trafik anbefales det kun at behandle rapporter for i dag højst hver halve time (%s sekunder) eller hver time (%s sekunder).',
	...
	'General_ExceptionPrivilegeAtLeastOneWebsite' => 'Du kan ikke få adgang til denne ressource, da det kræver en %s adgang til mindst ét website.',
	'General_ExceptionPrivilegeAccessWebsite' => ' Du kan ikke få adgang til denne ressource, da det kræver en %s adgang til website id = %d.',
	...
	'General_ChooseWebsite' => 'Vælg website',
	...
	'General_Add' => 'Tilføj',
	'Actions_PluginDescription' => 'Rapporter om sidevisninger, udgående links og downloads. Udgående links og downloads spores automatisk!',
	...
	'Actions_WidgetSearchKeywords' => 'Sitesøgningssøgeord',
	'Actions_WidgetSearchCategories' => 'Søge kategorier',
	'Actions_WidgetSearchNoResultKeywords' => 'Søgeord uden nogen resultater',
	'Actions_WidgetPageUrlsFollowingSearch' => 'Sider efter en sitesøgning',
	'Actions_WidgetPageTitlesFollowingSearch' => 'Sidetitler efter en sitesøgning',
	'Actions_PageUrls' => 'Side URL\'er',
	'Actions_SubmenuOutlinks' => 'Udgående links',
	'Actions_SubmenuDownloads' => 'Downloads',
	'Actions_SubmenuSitesearch' => 'Sitesøgning',
	...
	'Actions_OutlinkDocumentation' => 'Et udgåendelink er et link, der fører den besøgende væk fra dit website (til et andet domæne)',
	'Actions_DownloadsReportDocumentation' => 'Rapporten viser, hvilke filer dine besøgende har downloadet. %s Hvad Piwik tæller som et download, er klikket på et link. Hvorvidt overførelsen er afsluttet eller ej ved Piwik ikke.',
	...
	'Actions_ColumnUniqueDownloads' => 'Unikke downloads',
	...
	'Actions_ColumnSearchExitsDocumentation' => 'Procentdelen af ​​besøg, der forlod websitet efter en søgning på søgeordet i din sitesøgemaskine.',
	...
	'CoreAdminHome_OptOutExplanation' => 'Piwik er dedikeret til at værne om personlige oplysninger på internettet. For at give dine besøgende valgmulighed for at framelde Piwik Web Analyse, kan du tilføje den følgende HTML-kode på en af dine websites, f. eks. på en fortrolighedspolitik side.',
	...
	'CoreAdminHome_OptOutComplete' => 'Opt-out udført; dine besøg på websitet bliver ikke registreret af analyseværktøjet.',
	...
	'CoreAdminHome_YouMayOptOut' => 'Du kan vælge ikke at have en unik web analyse cookie identifikationsnummer tildelt til computeren for at undgå aggregering og analyse af data indsamlet på dette website.',
	...
	'Dashboard_PluginDescription' => 'Kontrolpanelet kan tilpasses: tilføj nye widgets, ændre rækkefølgen af dem. Hver bruger kan få adgang til sit eget brugerdefinerede kontrolpanel.',
	'Dashboard_Dashboard' => 'Kontrolpanel',
	'Dashboard_AddAWidget' => 'Tilføj en widget...',
	'Dashboard_DeleteWidgetConfirm' => 'Bekræft fjernelse af widget fra kontrolpanelet?',
	'Dashboard_SelectWidget' => 'Vælg widget som skal tilføjes kontrolpanelet.',
	...
	'Dashboard_LoadingWidget_js' => 'Indlæser widget, vent venligst...',
	...
	'Dashboard_EmptyDashboard' => 'Tomt kontrolpanel - Vælg selv favorit widgets',
	'Dashboard_DefaultDashboard' => 'Standard kontrolpanel - Bruger standard widgets og udformning',
	'Dashboard_RemoveDashboard' => 'Fjern kontrolpanel',
	'Dashboard_SetAsDefaultWidgets' => 'Angiv som standard widgets udvælgelse',
	'Dashboard_SetAsDefaultWidgetsConfirm' => 'Skal den nuværende widgets udvælgelse og kontrolpanel udformning bruges som standard kontrolpanel skabelon?',
	'Dashboard_SetAsDefaultWidgetsConfirmHelp' => 'Widgets udvælgelse og kontrolpanelets udformning vil blive brugt når en bruger opretter et nyt kontrolpanel, eller når "%s" -funktionen bruges.',
	'Dashboard_RemoveDashboardConfirm' => 'Bekræft fjernelse af kontrolpanel "%s"?',
	'Dashboard_NotUndo' => 'Handlingen kan ikke fortrydes.',
	'Dashboard_DashboardEmptyNotification' => 'Kontrolpanelet indeholder ikke nogen widgets. Start med at tilføje nogle widgets eller nulstille kontrolpanel til standard.',
	...
	'DBStats_LearnMore' => 'Hvis du vil vide mere om, hvordan Piwik behandler data, og hvordan man kan få Piwik til arbejde godt på mellem til stærkt trafikerede websites, se dokumentationen på %s.',
	'DBStats_Table' => 'Tabel',
	...
	'ExampleRssWidget_PluginDescription' => 'Programudvidelse eksempel: Hvordan oprettes en ny widget, der læser et RSS-feed?',
	...
	'Feedback_WhyAreMyVisitsNoTracked' => 'Hvorfor spores besøg på mit website ikke?',
	...
	'Goals_YouCanEnableEcommerceReports' => 'Du kan aktivere %s for dette website på %s siden.',
	...
	'Installation_SiteSetup' => 'Opsæt venligst det første website, som du vil spore og analysere med Piwik:',
	...
	'Installation_SiteSetupFootnote' => 'Bemærk: når Piwik installationen er færdig, vil du have mulighed for at tilføje flere websites som du vil spore!',
	...
	'Login_ConfirmationLinkSent' => 'Et bekræftelselink er blevet sendt til din indbakke. Tjek din e-mail og besøge dette link for at godkende ændringen af din adgangskode.',
	...
	'MultiSites_PluginDescription' => 'Viser multi-site resumé/statistik. Vedligeholdes som et Piwik-kerne udvidelsesmodul.',
	'MultiSites_Evolution' => 'Udvikling',
	'MultiSites_TopLinkTooltip' => 'Sammenlign webanalyse statistik for alle dine websites.',
	...
	'Referers_PluginDescription' => 'Rapporterer henvisningsdata: Søgemaskiner, søgeord, websites, kampagnesporing, direkte træf.',
	'Referers_Referers' => 'Henvisninger',
	'Referers_EvolutionDocumentation' => 'Oversigt over henvisninger, der førte besøgende til dit website.',
	...
	'Referers_SearchEnginesReportDocumentation' => 'Rapporten viser hvilke søgemaskiner, der henviser brugere til dit website. %s Klik på en række i tabellen for at se, hvad brugerne søgte efter ved brug af en bestemt søgemaskine.',
	'Referers_Keywords' => 'Søgeord',
	'Referers_KeywordsReportDocumentation' => 'Rapport viser hvilke søgeord brugere søgte efter, før de blev henvist tildit website. %s Klik på en række i tabellen for at se fordelingen af søgemaskiner, der blev forespurgt om søgeordet.',
	'Referers_DirectEntry' => 'Direkte træf',
	'Referers_Websites' => 'Websites',
	'Referers_WebsitesReportDocumentation' => 'Tabellen viser, hvilke websites, der henviser besøgende til dit website. %s Klik på en række i tabellen, for at se, hvilke URL\'er links til dit website er på.',
	'Referers_Campaigns' => 'Kampagner',
	'Referers_CampaignsReportDocumentation' => 'Rapporten viser, hvilke kampagner der førte besøgende til dit website. %s Finde flere oplysninger om sporing af kampagner, læs %skampagne dokumentation på piwik.org%s',
	...
	'Referers_DirectEntryDocumentation' => 'En besøgende har indtastet URL-adressen i browseren og gik direkte til dit website. Den besøgende kom direkte ind på websitet.',
	'Referers_SearchEnginesDocumentation' => 'Besøgende blev henvist til dit website fra en søgemaskine. %s Se rapporten %s for yderligere oplysninger.',
	'Referers_WebsitesDocumentation' => 'Besøgende fulgte et link fra et anden website, der førte til dit website. %s Se %s rapport for yderligere oplysninger.',
	'Referers_CampaignsDocumentation' => 'Besøgende kom til dit website som følge af en kampagne. %s Se %s rapport for yderligere oplysninger.',
	'Referers_ColumnRefererType' => 'Henvisningstype',
	'Referers_ColumnSearchEngine' => 'Søgemaskine',
	'Referers_ColumnWebsite' => 'Website',
	'Referers_ColumnWebsitePage' => 'Website side',
	...
	'Referers_TypeWebsites' => '%s fra websites',
	...
	'Referers_DistinctWebsites' => 'forskellige websites',
	...
	'Referers_WidgetExternalWebsites' => 'Eksterne websites',
	...
	'SitesManager_PluginDescription' => 'Website styring i Piwik: Tilføj et ny website, rediger et eksisterende, vis JavaScript-koden til at inkludere på dine sider. Alle handlinger er også tilgængelige via API.',
	'SitesManager_Sites' => 'Websites',
	'SitesManager_TrackingTags' => 'Sporingskode for %s',
	'SitesManager_WebsitesManagement' => 'Administration af websites',
	'SitesManager_MainDescription' => 'Dine webanalyse rapporter behøver websites! Tilføj, opdater, slet websites og vis JavaScriptkoden, som skal indsættes på dine sider.',
	'SitesManager_YouCurrentlyHaveAccessToNWebsites' => 'Du har adgang til %s websites.',
	'SitesManager_OnlyOneSiteAtTime_js' => 'Du kan kun redigere et website ad gangen. Gem eller Annullér de aktuelle ændringer på websitet %s.',
	...
	'SitesManager_NoWebsites' => 'Du har ingen websites at administrere.',
	'SitesManager_AddSite' => 'Tilføj et nyt website',
	'SitesManager_NotFound' => 'Ingen websites for',
	'SitesManager_AliasUrlHelp' => 'Det anbefales, men er ikke nødvendigt at angive de forskellige netadresser, en på hver linje, som besøgende kan komme ind på websitet. Alias netadresser for et netsted, vises ikke i Henvisning> Websites rapport. Bemærk, at det ikke er nødvendigt at specificere netadresser med og uden \'www\' da Piwik automatisk finder begge.',
	'SitesManager_Urls' => 'URLer',
	'SitesManager_MenuSites' => 'Websites',
	'SitesManager_DeleteConfirm_js' => 'Bekræft sletning af følgende website? %s',
	'SitesManager_ExceptionDeleteSite' => 'Det er ikke muligt at slette websitet. Det er den eneste oprettede. Tilføj et ny website, og slet så denne.',
	'SitesManager_ExceptionNoUrl' => 'Angiv mindst én URL til websitet.',
	'SitesManager_ExceptionEmptyName' => 'Websitets navn kan ikke være tomt.',
	...
	'SitesManager_SuperUserCan' => 'Superbrugeren kan også %s angive globale indstillinger%s for nye websites.',
	'SitesManager_ExcludedIps' => 'Udeluk IP-adresser',
	'SitesManager_GlobalListExcludedIps' => 'Liste over udelukkede IP-adresser',
	'SitesManager_ListOfIpsToBeExcludedOnAllWebsites' => 'Indtast IP-adresser, som skal udelukkes fra at blive sporet på alle websites.',
	...
	'SitesManager_ListOfQueryParametersToBeExcludedOnAllWebsites' => 'URL-søgeparameterne nedenfor vil blive udelukket fra URL\'er på alle websites.',
	...
	'SitesManager_GlobalWebsitesSettings' => 'Globale websites indstillinger',
	'SitesManager_DefaultTimezoneForNewWebsites' => 'Standard tidszone for nye websites',
	'SitesManager_SelectDefaultTimezone' => ' Vælg standard tidszone for nye websites.',
	'SitesManager_Currency' => 'Valuta',
	'SitesManager_CurrencySymbolWillBeUsedForGoals' => 'Valuta symbol vises ved siden af mål indtægter.',
	'SitesManager_DefaultCurrencyForNewWebsites' => 'Standard valuta for nye websites',
	'SitesManager_SelectDefaultCurrency' => 'Vælg standard valuta for nye websites.',
	'SitesManager_EnableEcommerce' => 'E-handel aktiveret',
	'SitesManager_NotAnEcommerceSite' => 'Ikke et e-handel website',
	'SitesManager_EnableSiteSearch' => 'Sitesøgningssporing aktiveret',
	'SitesManager_DisableSiteSearch' => 'Spor ikke sitesøgning',
	...
	'SitesManager_TrackingSiteSearch' => 'Sporing af intern sitesøgning',
	'SitesManager_SiteSearchUse' => 'Du kan bruge Piwik til at spore og rapportere hvad besøgende søger efter i dit websites interne søgemaskine.',
	'SitesManager_SearchParametersNote2' => 'For at deaktivere sitesøgning for nye websites, efterlad disse to felter tomme.',
	'SitesManager_SearchKeywordLabel' => 'Søgeparameter',
	'SitesManager_SearchCategoryLabel' => 'Kategoriparameter',
	'SitesManager_SearchUseDefault' => 'Brug %sstandard%s sitesøgningsparametre',
	...
	'UserCountry_GeoIPCannotFindMbstringExtension' => 'Kan ikke finde %1$s funktionen. Sørg venligst for at %2$s udvidelsen er installeret og indlæst.',
	...
	'UserCountry_HowToSetupGeoIP_Step1' => '%1$sDownload%2$s GeoLite City databasen fra %3$sMaxMind%4$s.',
	...
	'UserCountry_getCountryDocumentation' => 'Denne rapport viser hvilke lande dine besøgende var i da de besøgte dit website.',
	'UserCountry_getContinentDocumentation' => 'Denne rapport viser hvilke kontinenter dine besøgende var i da de besøgte dit website.',
	'UserCountry_getRegionDocumentation' => 'Denne rapport viser hvilke regioner dine besøgende var i da de besøgte dit website.',
	'UserCountry_getCityDocumentation' => 'Denne rapport viser hvilke byer dine besøgende var i da de besøgte dit website.',
	...
	'UsersManager_ApplyToAllWebsites' => 'Tilføj til alle websites',
	...
	'VisitsSummary_NbSearchesDescription' => '%s søgninger på dit website',
	...
	'VisitTime_WidgetByDayOfWeekDocumentation' => 'Denne graf viser antallet af besøg dit website har modtaget på hver dag i ugen.',
	'Widgetize_PluginDescription' => 'Programudvidelsen gør det nemt at eksportere Piwik widgets til din blog, website eller på iGoogle og Netvibes!',
	'Widgetize_TopLinkTooltip' => 'Eksporter Piwik rapporter som widgets og indlejre dit kontrolpanel i din applikation som en iframe.',
	...
	'Transitions_FromWebsites' => 'Fra websites',
	'Transitions_FromWebsitesInline' => '%s fra websites',
	...
	'Insight_Insight' => 'Indsigt',
	'Insight_Page' => 'Side',
	'Insight_MainMetrics' => 'Vigtigste målinger',
	'Insight_NoData' => 'Der er ingen data for denne side i den valgte periode.',
	'Insight_OpenFullScreen' => 'Gå i fuldskærm',
	'Insight_CloseFullScreen' => 'Afslut fuldskærm',
