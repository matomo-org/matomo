...
$translations = array(
	...
	'General_DateRangeInPeriodList' => 'Χρονικό Έυρος',
	...
	'General_LastDays' => 'Τελευτείες %s ημέρες (με τη σημερινή)',
	...
	'General_IfArchivingIsFastYouCanSetupCronRunMoreOften' => 'Υποθέτοντας ότι η αρχειοθέτηση είναι γρήγορη για την εγκατάστασή σας, μπορείτε να εγκαταστήσετε το crontab για να τρέχει πιοι συχνά.',
	...
	'General_SelectYesIfYouWantToSendEmailsViaServer' => 'Επιλέξτε «Ναι», αν θέλετε να αποστείλεται την ηλεκτρονική επιστολή μέσω ενός ονομασμένου διακομιστή αντί της τοπικής συνάρτησης αλληλογραφίας',
	...
	'General_OnlyUsedIfUserPwdIsSet' => 'Χρησιμοποιήστε το μόνο αν έχει οριστεί όνομα χρήστη/κωδικός πρόσβασης. Ρωτήστε τον πάροχό σας αν δεν είσετ σίγουρος/η ποια μέθοδο να χρησιμοποιήσετε',
	...
	'General_EncryptedSmtpTransport' => 'Εισάγετε το κρυπτογραφημένο επίπεδο μεταφοράς που απαιτείται από τον διακομιστή SMTP sας.',
	...
	'CoreAdminHome_OptOutComplete' => 'Η απενεργοποιήση ολοκληρώθηκε. Οι επισκέψεις σας σε αυτή την ιστοσελίδα δεν θα καταγράφονται από το εργαλείο Στατιστικών Ιστού.',
	...
	'Dashboard_WidgetPreview_js' => 'Προεπισκόπηση Μικροεφαρμογή',
	'Dashboard_Close_js' => 'Κλείσιμο',
	'Dashboard_Maximise_js' => 'Μεγιστοποιήση',
	...
	'Goals_HelpMultipleConversionsPerVisit' => 'Σας προτείνουμε να επιλέξετε αυτή την επιλογή για παράδειγμα για Στόχους Ηλεκτρονικού Εμπορίου, όπου ένας επισκέπτης μπορεί να κάνει πολλές παραγγελίες στην ίδια επίσκεψη και θέλετε να καταγράψετε όλες αυτές της παραγγελίες ως μετατροπές Στόχων.',
	...
	'Installation_SystemCheckWarnLibXmlHelp' => 'Πρέπει να ενεργοποιήσετε την επέκταση «libxml» (π.χ.: «εγκατάσταση του πακέτου php-libxml») καθώς απατείται από άλλες επεκτάσεις PHP.',
...
Σημείωση: αυτό το τεκμήριο θα εκπεύσει σε 24 ώρες.',
	...
	'Mobile_MultiChartLabel' => 'Προβολή μικροδιαγραμματων',
	...
	'TranslationsAdmin_StatusOfStringsTranslated' => 'Κατάσταση: %1$s από %2$s φράσεις μεταφράσττηκαν',
	...
	'TranslationsAdmin_CannotOpenForWriting' => 'Αδύνατο το άγοιγμα του %s για εγγραφή',
	...
	'VisitsSummary_NbActionsPerVisit' => '%s δραστηρίοτητες ανά επίσκεψη',
