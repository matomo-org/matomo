...
$translations = array(
	...
	'General_ColumnExitRateDocumentation' => 'Το ποσοστό των επισκέψεων που άφησαν την ιστοσελίδα αφού είδαν αυτή τη σελίδα (μοναδικές προβολές σελίδων διαιρεμένες με τις υπάρχουσες)',
	...
	'Live_VisitorLogDocumentation' => 'Αυτός ο πίνακας δείχνει τις τελευταίες επισκέψεις εντός της επιλεγμένης χρονικής περιόδου.%s Αν η χρονική περίοδος περιλαμβάνει τη σημερινή μέρα, μπορείτε να δείτε τους επισκέπτες σας σε πραγματικό χρόνο! %s Τα δεδομένα που εμφανίζονται εδώ είναι σε απευθείας μετάδοση, ανεξάρτητα αν και πόσο συχνά χρησιμοποιείτε την εργασία αρχειοθέτησης.',
	'Live_Time' => 'Ώρα',
	...
	'SEO_YahooIndexedPages' => 'Σελίδες Ευρετηρίου Yahoo',
	'SEO_DomainAge' => 'Ηλικία Domain',
	'SEO_YahooBacklinks' => 'Επιστρεφόμενοι Σύνδεσμοι Yahoo',
	...
	'UserCountry_country_a1' => 'Ανώνυμος Proxy',
	...
	'VisitFrequency_ColumnAverageVisitDurationForReturningVisitors' => 'Μέση Διάρκεια Επισκέψεων για Επιστρεφόμενους Επισκέπτες (σε δευτερόλεπτα)',
	...
	'VisitsSummary_NbActions' => '%s δραστηριότητες',
