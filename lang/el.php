...
$translations = array(
	...
	'General_TranslatorName' => 'Jim Black www.jblack.info',
	'General_TranslatorEmail' => 'jimaek@hotmail.com',
	...
	'General_SaveImageOnYourComputer_js' => 'Για να αποθηκέυσετε αυτήν την εικόνα στον υπολογιστή σας, κάντε δεξί κλικ πάνω στην φωτογραφία και επιλέξτε "Αποθήκευση Φωτογραφίας Ως..."',
	'General_RequiresFlash' => 'Εμφάνιση γραφημάτων στο Piwik απαιτεί Flash',
	'General_GraphHelp' => 'Περισσότερες πληροφορίες σχετικά με την εμφάνιση των γραφημάτων στο Piwik.',
	'General_ExceptionDatabaseVersion' => 'H %s έκδοσή σας ειναι η %s αλλα το Piwik απαιτεί τουλάχιστον %s',
);