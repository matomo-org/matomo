...
Merci d\'utiliser Piwik!',
	...
	'PDFReports_Segment_Help' => 'Vous pouvez sélectionner un segment personnalisé existant pour l\'appliquer à des données dans ce rapport par courriel. Vous pouvez créer et modifier les segments personnalisés depuis votre tableau de bord %s(cliquez ici pour l\'ouvrir)%s, cliquez ensuite sur la zone "%s", puis "%s".',
	'PDFReports_Segment_Deletion_Error' => 'Ce segment ne peut être supprimé, car il est utilisé pour générer le(s) rapport(s) par courriel suivant(s) %s. Pour supprimer ce segment vous devez d\'abord modifier ces rapports de sorte qu\'ils n\'utilisent plus ce segment.',
	...
	'PDFReports_SegmentAppliedToReports' => 'Le segment \'%s\' est appliqué au rapport.',
	'PDFReports_CustomVisitorSegment' => 'Segment de visiteur personnalisé:',
	...
	'PDFReports_ReportIncludeNWebsites' => 'Le rapport incluera les métriques principales pour tous les sites web qui ont au moins une visite (depuis les %s sites web actuellement disponibles)',
	...
	'SegmentEditor_YouMustBeLoggedInToCreateSegments' => 'Vous devez être identifié(e) pour créer et modifier des segments de visiteurs personnalisés.',
	...
	'SegmentEditor_ThisSegmentIsVisibleTo' => 'Ce segment est visible pour :',
	...
	'SegmentEditor_AreYouSureDeleteSegment' => 'Etes vous sûr(e) de vouloir supprimer ce segment?',
	'SegmentEditor_ChooseASegment' => 'Choisir un segment',
	'SegmentEditor_LoadingSegmentedDataMayTakeSomeTime' => 'Le traitement des données visiteurs segmentées peut prendre quelques minutes...',
	'SegmentEditor_AutoArchiveRealTime' => 'les rapports segmentés sont traités en temps réel',
	'SegmentEditor_AutoArchivePreProcessed' => 'les rapports segmentés sont pré-traités (plus rapide, requiert un cron sur archive.php)',
