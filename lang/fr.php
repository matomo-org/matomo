...
$translations = array(
 ...
 Dans votre php.ini, ajoutez les lignes suivantes: %s',
	...
	'CoreHome_ThereIsNoDataForThisReport' => 'Il n\'y aucune donnée pour cet export.',
...
Vous pouvez soit corriger les permissions du répertoire/fichier, soit télécharger le package et installer la version %s manuellement:',
	...
	'Login_MailPasswordRecoveryBody' => 'Bonjour %1$s, Une requête de remise à zéro du mot de passe a été reçue depuis %2$s. Pour remettre à zéro le mot de passe: 1) Rendez vous au formulaire de remise à zéro du mot de passe à l\'adresse : %3$s 

2) Entrez la clef suivante: %4$s 

3) Remplissez le formulaire (en entrant deux fois votre nouveaux mot de passe) et soumettez le.

Note: cette clef expirera dans 24h.',
