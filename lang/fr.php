...
$translations = array(
	...
	'General_ExceptionIncompatibleClientServerVersions' => 'La version de votre client %1$s est %2$s ce qui est incompatible avec le server de version %3$s.',
	...
	'General_WarningFileIntegritySkipped' => 'Environement de dévelopement détecté. Contrôle d\'intégrité ignoré.',
	...
	'CoreHome_NoPrivileges' => 'Vous êtes connecté en tant que \'%s\' mais vous n\'avez apparement aucune permission de définie dans Piwik.<br />Demandez à votre administrateur Piwik de vous donner l\'accès \'voir\' à un site web.',
	...
	'Dashboard_PluginDescription' => 'Votre tableau de bord de statistiques web. Vous pouvez personnaliser votre tableau de bord: ajoutez de nouveau widgets, changez l\'ordre de vos widgets. Chaque utilisateur peut accèder à son propre tableau de bord.',
	...
	'ExampleAPI_PluginDescription' => 'Plugin d\'exemple: Comment créer une API pour votre plugin, exporter vos données dans de multiples formats sans aucun dévelopement spécial?',
	'ExampleFeedburner_PluginDescription' => 'Plugin d\'exemple: Comment afficher vostre abonement Feedburner dans un Widget dans le tableau de bord?',
	'ExampleRssWidget_PluginDescription' => 'Plugin d\'exemple: Comment créer un nouveau widget qui lit un flux RSS?',
	'ExampleUI_PluginDescription' => 'Plugin d\'exemple: Ce plugin montre comment fonctionne l\'insterface utilisateur de Piwik: création de tables, graphs, etc.',
	...
	'Feedback_ExceptionBodyLength' => 'Le message doit faire au moins %s characters de longueur.',
    ...
    'Goals_CaseSensitive' => 'Coresspondance sensible à la case',
	...
	'Installation_DatabaseClientCharset' => 'Jeu de caractères client de la base de données',
	'Installation_ConnectionCharacterSetNotUtf8' => 'La connexion au serveur de base de données n\'est pas en UTF8. Ceci n\'est pas une erreur critique: <b>Piwik devrait fonctionner correctement</b>. Par soucis de cohérence il est recommandé d\'effectuer les tâches suivantes: <ul style="list-style: disc;margin-left:10px"><li>dans votre config/config.ini.php de piwik, ajoutez <code>charset = utf8</code> en dessous de la section  [database] </li><li>recompilez libmysql --with-charset=utf8</li></ul>',
	'Installation_DatabaseTimezone' => 'Fuseau horaire de la base de données',
	'Installation_TimezoneMismatch' => 'PHP date.timezone n\'est pas la même que le le fuseau horaire du serveur de base de données. Ceci pourrait causer un problème de décallage des heures et jours dans les rapports. Plus d\'informations ici %s',
	...
	'Installation_ConfigurationHelp' => 'Votre configuration de Piwik semble être erronée. Vous pouvez ou bien supprimer config/config.inc.php et reprendre l\'installation ou corriger les paramètres de connection.',
	...
	'MultiSites_PluginDescription' => 'Affiche le sommaire/les statistiques multi-site. Actuellement maintenu comme un plugin Piwik coeur.',
	...
	'Referers_PluginDescription' => 'Effectue des rapports sur les données des référants: moteurs de recherche, mots clefs, sites web, suivi de campagne, entrée directe. ',
	...
	'SecurityInfo_PluginDescription' => 'Basé sur PhpSecInfo du Consortium de Sécurité de PHP, ce plugin fournit des information de sécurité à propos de votre environement PHP et donne des suggestions pour son amélioration. C\'est un outil d\'approche sécurité multi-couches. Cela ne remplace ni les pratiques de dévelopement sécurisé ni les audit du code.',
	'SecurityInfo_Security' => 'Securité',
	...
	'SitesManager_AliasUrlHelp' => 'Il est recommandé, mais pas requis, de spécifier les URL différentes que vos utilisateurs utilisent pour accéder au site web. Les URL d\'alias pour un site n\'apparaitront pas dans Reférents > Sites Internet. Il n\'est pas nécessaire d\'entrer les URL avec et sans les www, Piwik les traite automatiquement.',
	'SitesManager_Id' => 'Id',
	...
	'VisitsSummary_PluginDescription' => 'Effectue des rapports sur les valeures générales des statistiques: visites, visiteurs uniques, nombre d\'actions, taux de rebond, etc.',
