...
$translations = array(
	...
	'General_ColumnAverageTimeOnPageDocumentation' => '이 페이지를 방문한 방문자의 머문 평균 시간 (페이지만 해당, 전체 웹사이트 아님).',
	...
	'General_ExceptionUnreadableFileDisabledMethod' => '설정 파일 {%s}를 로드할 수 없습니다. 서버 %s가 비활성화 되었을 수 있습니다.',
	...
	'API_GenerateVisits' => '오늘에 해당하는 데이터가없는 경우는 %s 플러그인을 사용하여 처음 약간의 데이터를 생성할 수 있습니다. %s 플러그인을 활성화하고 관리 영역에서 \'방문자 생성기\'메뉴를 클릭하세요.',
	...
	'PrivacyManager_DeleteLogDescription2' => '자동으로 로그 삭제를 활성화 할 때 데이터가 손실되지 않도록 모든 이전의 일일 보고서가 처리되고 있는지 확인해야합니다.',
	...
	'CoreHome_JavascriptDisabled' => 'Piwik의 표준보기를 이용하려면 JavaScript가가 활성화 되어 있어야 합니다.<br />하지만, 당신의 브라우저는 활성화 되어있지 않거나 지원되지 않는 것 같습니다.<br />표준보기를 이용하려면 브라우저 옵션을 변경하여 JavaScript를 활성화하고 <br /> %1$s다시 시도하세요%2$s.<br />',
...
그리고 Piwik을 사용하여 주셔서 감사합니다!',
	...
	'MobileMessaging_MobileReport_NoPhoneNumbers' => '접근 단위로 하나 이상의 전화 번호를 활성화 해주세요',
	...
	'SEO_Rank' => '순위',
	'SEO_Pages' => '페이지',
	'SEO_Google_IndexedPages' => 'Google에서 색인된 페이지',
	...
	'UserCountry_NoDataForGeoIPReport2' => '더 정확한 위치 정보를 활성화 시키려면 %1$s이 곳%2$s의 설정을 %3$s도시 수준의 데이터베이스%4$s로 사용해야 합니다.',
	...
	'UserSettings_PluginDetectionDoesNotWorkInIE' => '참고: Internet Explorer에서는 플러그인 검색이 작동하지 않습니다. 이 보고서는 IE 브라우저가 아닌 경우에만 출력됩니다.',
	...
	'VisitorInterest_visitsByVisitCount' => '방문 별 방문수',
	...
	'Overlay_ClicksFromXLinks' => '%2$s 링크중 중 한 번의 %1$s 클릭',
	'Overlay_Link' => '링크',
