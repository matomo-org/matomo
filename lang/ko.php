...
$translations = array(
	...
	'General_PiwikIsACollaborativeProjectYouCanContribute' => '%s Piwik %s 은 협력 프로젝트입니다. %s 만약 Piwik이 마음에 드신다면, 도와주실 수 있습니다! %s 어떻게 Piwik에 도움을 줄 수 있는지 보시겠습니까?%s ',
	'General_YouAreCurrentlyViewingDemoOfPiwik' => '현재 %s 의 데모를 보고 있습니다; 풀버전을 %sdownload%s 받으세요! %s 확인하세요',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Piwik %s 이 사용 가능합니다. %s 지금 업데이트하세요!%s (보기: %s 변경%s).',
	...
	'CoreHome_JavascriptDisabled' => '스탠다드 뷰로 Piwik을 사용하기 위해 자바스크립트가 활성화되어 있어야 합니다.<br />하지만, 자바스크립트가 비활성화되있거나 브라우저에서 지원하지 않는 것 같습니다.<br />스탠다드 뷰를 사용하기 위해서, 브라우저 옵션을 변경하여 자바스크립트를 활성화하세요. 그리고 %1s재시도를 해보세요%2s.<br />',
	...
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Piwik 데이터베이스가 %s 버전에서 %s 새 버전으로 업그레이드됩니다.',
	...
	'CoreUpdater_HelpMessageContent' => '업데이트 도중에 발생하는 공통적인 에러가 설명되어 있는 %s Piwik FAQ %s 를 확인하세요. %s 시스템 관리자에게 물어보세요 - 에러는 서버나 MySQL 설정과 관련되어 있는 경우가 많아 도움을 줄 수도 있습니다.',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Piwik 원클릭 업데이트가 취소되었습니다. 만약 위의 에러 메세지를 고칠 수 없다면, 수동으로 Piwik을 업데이트하는 것을 권장합니다. %s 시작하기 위해 %s업데이트 문서%s 를 확인하세요!',
	...
	'Referers_MetricsFromRefererTypeGraphLegend' => '%1s (%2s 로부터)',
	...
	'Referers_UsingNDistinctUrls' => ' (%2s 개의 고유 URL을 사용해서)',
	...
	'VisitorInterest_BetweenXYMinutes' => '%1s-%1s분',
	'VisitorInterest_OnePage' => '1 개의 페이지',
	'VisitorInterest_NPages' => '%s 개의 페이지',
	'VisitorInterest_BetweenXYSeconds' => '%1s-%2s초',
	...
	'UsersManager_ExceptionInvalidLoginFormat' => '아이디는 %s 에서 %s 사이의 글자 수여야 하고 오직 문자,숫자, 또는 \'_\' 나 \'-\' 또는 \'.\'만 포함해야 합니다.',
	...
	'Installation_TablesWithSameNamesFound' => '몇몇의 테이블: %s / 데이터베이스: %s 가 Piwik이 생성하려고 하는 테이블 이름과 같습니다.',
	...
	'Installation_ErrorInvalidState' => '에러: 설치 과정의 단계를 뛰어넘으려고 하는 것 같습니다, 또는 쿠키가 비활성화거나, 또는 Piwik 설정 파일이 이미 생성되었습니다. %s쿠키가 활성화되어 있는지 확인하시고%s 설치 첫페이지로 %s 돌아가세요 %s.',
