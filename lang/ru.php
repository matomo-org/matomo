...
$translations = array(
	...
	'Actions_WidgetSearchKeywords' => 'Поисковые ключевые слова сайта',
	...
	'CoreAdminHome_YouMayOptOutBis' => 'Снимите галочку и получите исключающий cookie для отказа сбора данных.',
	'CoreAdminHome_YouAreOptedIn' => 'Статистика о вас собирается.',
	'CoreAdminHome_YouAreOptedOut' => 'Вы отказались от сбора статистических данных.',
	...
	'CoreAdminHome_JSTracking_MergeAliases' => 'В отчёте "Внешние ссылки" скрыть клики известных алиасов',
	'CoreAdminHome_JSTracking_MergeAliasesDesc' => 'Переходы по ссылкам на псевдонимы домена (например, %s) не будут учитываться как "Внешние ссылки".',
	...
	'CoreAdminHome_JSTracking_CustomCampaignQueryParam' => 'Использовать пользовательские имена параметров в запросе для названия кампании и ключевого слова',
	'CoreAdminHome_JSTracking_CodeNote' => 'Удостоверьтесь, что этот код содержится на каждой странице вашего сайта перед тегом %1$s.',
	'CoreAdminHome_JSTracking_CustomCampaignQueryParamDesc' => 'Примечание: %1$sPiwik автоматически определит параметры Google Analytics.%2$s',
	...
	'Referers_ViewReferrersBy' => 'Посмотреть Источники по %s',
	...
	'SEO_ViewBacklinksOnMajesticSEO' => 'Посмотреть Внешние обратные ссылки на сайте MajesticSEO.com',
	...
	'SitesManager_AliasUrlHelp' => 'Рекомендуется, но необязательно, указывать все домены для сайта (каждый домен - новая линия), которые пользователи могут использовать для доступа к сайту.  Алиасы для различных доменов сайта не будут отображаться в разделе Источики трафика > Сайты. Заметьте, что нет необходимости указывать варианты адресов с "www" и без него. Piwik автоматически учитывает оба.',
	...
	'SitesManager_KeepURLFragments' => 'Отслеживание фрагментов url страницы',
	'SitesManager_KeepURLFragmentsHelp' => 'Если флажок не установлен, фрагменты URL (всё после %1$s) будут удалены при отслеживании: %2$s будут отслеживаться как %3$s',
	'SitesManager_KeepURLFragmentsHelp2' => 'Вы также можете переопределить этот параметр для отдельных веб-сайтов выше.',
	'SitesManager_KeepURLFragmentsLong' => 'Сохранять дополнительные фрагменты url при отслеживании  страниц',
	...
	'PDFReports_Segment_Help' => 'Вы можете выбрать существующий пользовательский сегмент для применения к данным для этого отчёта. Вы можете создавать и редактировать пользовательские сегменты на панели инструментов %s(нажмите здесь, чтобы открыть)%s, далее нажмите на "%s", затем "%s".',
	...
	'SegmentEditor_SelectSegmentOfVisitors' => 'Выберите сегмент посетителей:',
