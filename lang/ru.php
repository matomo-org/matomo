...
$translations = array(
	...
	'CoreAdminHome_JSTrackingIntro1' => 'Вы можете отслеживать посетителей разными способами. Мы рекомендуем использовать для этого JavaScript. Чтобы использовать это метод вы должны убедиться, что каждая страница на сайте имеет код, который вы можете сгенерировать на этой странице',
