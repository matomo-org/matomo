...
$translations = array(
	...
	'General_PageBounceRateDefinition' => 'Доля посещений, начавшихся с просмотра этой страницы, после чего посетитель ушел с сайта.',
	'General_ColumnExitRate' => 'Процент выходов',
	'General_PageExitRateDefinition' => 'Доля посетителей, ушедших после просмотра этой страницы.',
	...
	'General_BouncesDefinition' => 'Количество посещений, начавшихся с просмотра этой страницы, после чего посетитель ушел с сайта.',
	'General_ColumnEntrances' => 'Входы на сайт',
	'General_EntrancesDefinition' => 'Количество посетителей, которые начали с этой страницы.',
	'General_ColumnExits' => 'Выходы из сайта',
	'General_ExitsDefinition' => 'Количество посетителей, которые закончили на этой странице.',
	'General_ColumnAverageTimeOnPage' => 'Среднее время просмотра страницы',
	'General_AverageTimeOnPageDefinition' => 'Среднее время проведенное посетителями при просмотре этой страницы.',
	...
	'Goals_HelpMultipleConversionsPerVisit' => 'Мы рекоммендуем выбирать эту опцию, например, для отслеживания целей ECommerce, где посетитель может делать несколько покупок за одно и то же поещение, и вы хотите принять все эти покупки как достижение цели.',
