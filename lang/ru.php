...
$translations = array(
	...
	'CorePluginsAdmin_Plugins' => 'Модули',
	...
	'CorePluginsAdmin_MenuPlugins' => 'Модули',
	...
	'Dashboard_AddWidget' => 'Добавить информер...',
	'Dashboard_DeleteWidgetConfirm' => 'Вы уверены, что хотите удалить информер с панели приборов?',
	'Dashboard_SelectWidget' => 'Выберите информер для добавления на информпанель',
	'Dashboard_AddPreviewedWidget' => 'Добавить предпросмотренный информер на информпанель',
	'Dashboard_WidgetPreview' => 'Предпросмотр информера',
	'Dashboard_TitleWidgetInDashboard_js' => 'Информер уже существует на информпанели',
	...
	'Dashboard_LoadingWidget_js' => 'Загрузка информера, пожалуйста подождите...',
	'Dashboard_WidgetNotFound_js' => 'Информер не найден',
	...
	'SitesManager_Id' => 'ID',
	'SitesManager_Name' => 'Наименование',
	...
	'General_Widgets' => 'Информеры',
	'General_Settings' => 'Настройки',
	'General_GiveUsYourFeedback' => 'Обратная связь',
	'General_Export' => 'Экспорт',
	'General_Visitors' => 'Посетители',
	'General_ColumnActionsPerVisit' => 'Действий в визит',
	'General_ColumnAvgTimeOnSite' => 'Ср. время на сайте',
	...
	'General_PiwikIsACollaborativeProject' => '%s Piwik %s - коллективный проект и находится в стадии Бета тестирования. Если Вы хотите помочь проекту, пожалуйста, %s напишите нам! %s',
	'General_YouAreCurrentlyViewingDemoOfPiwik' => 'Сейчас Вы используете Demo версию продукта %s; %sскачайте%s полную версию!%s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Piwik %s доступен для скачивания. %s Пожалуйста, обновитесь!%s (см. %sизменения%s).',
	'General_BackToPiwik' => 'Вернуться к Piwik',
	'Actions_Actions' => 'Действия',
	'CorePluginsAdmin_PluginsManagement' => 'Управление модулями',
	'CorePluginsAdmin_MainDescription' => 'Модули расширяют функциональность Piwik. После установки модуля Вы можете активировать или деактивировать его.',
	'CorePluginsAdmin_Plugin' => 'Модуль',
	'CorePluginsAdmin_Version' => 'Версия',
	'CorePluginsAdmin_Description' => 'Примечание',
	'CorePluginsAdmin_Status' => 'Статус',
	'CorePluginsAdmin_Action' => 'Действие',
	'CorePluginsAdmin_PluginHomepage' => 'Дом. страница модуля',
	'CorePluginsAdmin_Active' => 'Активно',
	'CorePluginsAdmin_Inactive' => 'Неактивно',
	...
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Следующие модули будут обновлены: %s.',
	'CoreUpdater_TheUpgradeProcessMayTakeAWhilePleaseBePatient' => 'Обновление базы данных может занять некоторое время, поэтому будьте терпеливы.',
	'CoreUpdater_UpgradePiwik' => 'Обновить Piwik',
	'CoreUpdater_HelpMessageContent' => 'Проверьте %s Piwik FAQ %s, в котором обсуждается большинство известных ошибок во время обновления. %s Обратитесь к системному администратору - он может помочь Вам с решением проблемы на сервере или с настройками MySQL.',
	...
	'CoreUpdater_HelpMessageIntroductionWhenWarning' => 'Обновление завершено успешно, однако в процессе возникло несколько предупреждений. Пожалуйста, прочтите примечания ниже. Для дальнейшей помощи:',
	'CoreUpdater_UpgradeComplete' => 'Обновление завершено!',
	'CoreUpdater_WarningMessages' => 'Предупреждения:',
	'CoreUpdater_ErrorDuringPluginsUpdates' => 'Ошибка во время обновления модуля:',
	'CoreUpdater_WeAutomaticallyDeactivatedTheFollowingPlugins' => 'Следующие модули автоматически деактивированы: %s',
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Piwik успешно обновлен!',
	'CoreUpdater_ContinueToPiwik' => 'Продолжить к Piwik',
	...
	'CoreUpdater_UpdateHasBeenCancelled' => 'Обновление отменено.',
	'CoreUpdater_VerifyingUnpackedFiles' => 'Проверка неархивированных файлов',
	'CoreUpdater_CreatingBackupOfConfigurationFile' => 'Создание копии конфигурационного файла в %s',
	...
	'GeoIP_Continent' => 'Континент',
	'GeoIP_DistinctCountries' => '',
	'GeoIP_SubmenuLocations' => 'Локации',
	'GeoIP_WidgetContinents' => 'Континеты посетителей',
	'GeoIP_WidgetCountries' => 'Страны посетителей',
	'GeoIP_country_' => 'Данные недоступны',
	'GeoIP_country_ac' => '',
	'GeoIP_country_ad' => '',
	'GeoIP_country_ae' => '',
	'GeoIP_country_af' => '',
	...
	'GeoIP_country_zr' => '',
	'GeoIP_country_zw' => '',
	'GeoIP_continent_' => 'Данные недоступны',
	'GeoIP_continent_eur' => 'Европа',
	'GeoIP_continent_afr' => 'Африка',
	'GeoIP_continent_asi' => 'Азия',
	'GeoIP_continent_ams' => 'Южная и Центральная Америка',
	'GeoIP_continent_amn' => 'Северная Америка',
	'GeoIP_continent_oce' => 'Океания',
	'Installation_ContinueToPiwik' => 'Продолжить к Piwik',
	'Installation_SuperUserLogin' => 'суперюзер',
	'Installation_Password' => 'пароль',
	'Installation_PasswordRepeat' => 'пароль (повтор)',
	'Installation_Email' => 'е-маил',
	'Installation_SecurityNewsletter' => '',
	'Installation_CommunityNewsletter' => '',
	'Installation_PasswordDoNotMatch' => 'пароли не одинаковы',
	'Installation_SubmitGo' => 'Вперед!',
	'Installation_DatabaseCreatedSuccess' => 'База %s создана успешно!',
