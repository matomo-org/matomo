...
$translations = array(
	...
	'General_TranslatorEmail' => 'heyheyftw@gmail.com, onix@onix.name, taktip@gmail.com, djsoldier@mail.ru',
	...
	'General_DateRangeFrom_js' => 'С',
	'General_DateRangeTo_js' => 'По',
	'General_LastDaysShort' => '%s последних дней',
	'General_PreviousDaysShort' => '%s предыдущих дней',
	'General_PreviousDays' => '%s предыдущих дней (не включая сегодня)',
	'General_LastDays' => '%s предыдущих дней (включая сегодня)',
	'General_LoadingData' => 'Загрузка данных...',
	'General_Loading_js' => 'Загрузка...',
	'General_GoTo' => 'Перейти к %s',
	'General_Next' => 'Следуюещму',
	...
	'Actions_SiteSearchCategories2' => 'Например, сайты электронной коммерции обычно имеют выбор `Категорий` товаров\услуг, чтобы посетителям было удобно их сортировать и искать.',
	...
	'CustomVariables_ScopeVisit' => 'расширить посещение',
	'CustomVariables_ScopePage' => 'расширить страницу',
	...
	'Installation_SuperUserSetupSuccess' => 'Супер Администратор создан успешно!',
	...
	'Mobile_HttpTimeout' => 'HTTP Таймаут',
	...
	'Referers_WebsitesReportDocumentation' => 'В этой таблице вы можете видеть сайты, которые привели посетителей на ваш. %s Кликнув на конкретный ряд таблицы, вы увидите на каких сайтах есть ссылка на ваш сайт.',
	...
	'Referers_SubmenuWebsites' => 'Веб-сайты и соцсети',
	...
	'UserCountry_NoDataForGeoIPReport' => 'Нет данных для этого отчета, потому что нет доступных данных по локациям. Чтобы включить точную геолокацию, измените настройки %1$sздесь%2$s. Чтобы получить окацию ваших старых посетителей, используйте скрипт, описанный %3$sздесь%4$s.',
	...
	'PDFReports_PleaseFindBelow' => 'Пожалуйста, ниже вашего %1$s находится отчет за %2$s.',
