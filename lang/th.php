...
$translations = array(
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Piwik %1$s ออกแล้ว %2$s กรุณาอัพเดทเดี๋ยวนี้ %3$s (ดู %4$s การเปลี่ยนแปลง %5$s)',
	...
	'General_PiwikIsACollaborativeProjectYouCanContribute' => '%1$s Piwik %2$s เป็นโปรเจ็กทำด้วยความร่วมมือกัน %3$s หากคุณชอบ Piwik คุณสามารถช่วยเราได้!ลองดูว่า %4$s คุณสามารถสนับสนุน Piwik ได้อย่างไร ? %5$s',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'การอัพเดท Piwik ในคลิกเดียวถูกยกเลิกแล้ว หากคุณไม่สามารถแก้ไขข้อความข้อผิดพลาด แนะนำให้คุณอัพเดท Piwik แบบ Manual %1$s กรุณาตรวจสอบ %2$s เอกสารการอัพเดท %3$s เพื่อเริ่มดำเนินการ',
...
ดูที่คำสั่ง max_execution_time ในไฟลล์ php.ini หากต้องการ',
	...
	'UsersManager_ExceptionInvalidLoginFormat' => 'ชือ Login จะต้องยาว %1$s-%2$s และประกอบด้วย ตัวอักษร,ตัวเลข หรือตัว \'_\'หรือ\'-\'หรือ \'.\'',
