...
$translations = array(
	...
	'CorePluginsAdmin_Inactive' => '不活動的',
	...
	'API_QuickDocumentation' => '<h2>API 快速文件</h2><p>假如您今天沒有資料，您可以先使用此造訪產生器腳本 <a href=\'misc/generateVisits.php\' target=_blank>產生一些資料</a> ！</p><p>您可以為每種方法嘗試任何不同可用的格式，從 Piwik 擷取任何資料是非常容易的。</p><p><b>欲取得更多的資訊請查看 <a href=\'http://dev.piwik.org/trac/wiki/API\'>官方 API 文件</a> 或 <a href=\'http://dev.piwik.org/trac/wiki/API/Reference\'>API 參考文件</a>！</b></P><h2>使用者驗證</h2><p>假如您想要 <b>使用一個 crontab 例行排程以您的腳本請求資料等等... </b> 您必須增加參數 <code><u>&token_auth=%s</u></code> 至需要驗證的 API 呼叫 URL 位址中！</p><p>此 token_auth 使您的登入帳號及密碼更加安全，故 <b>請勿將之洩露給任何人！</p>',
	...
	'CoreUpdater_UpdateTitle' => 'Piwik &rsaquo; 升級',
	'CoreUpdater_UpdateRequired' => '需要升級',
	'CoreUpdater_YourDatabaseIsOutOfDate' => '您的 Piwik 資料庫已經過期了，所以您必須先升級才可以繼續！',
	'CoreUpdater_PiwikWillBeUpgradedToVersionX' => 'Piwik 將升級至版本 %s！',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => '以下外掛將被升級： %s！',
	'CoreUpdater_TheUpgradeProcessMayTakeAWhilePleaseBePatient' => '升級過程可能需要一段時間，所以請耐心等待！',
	'CoreUpdater_UpgradePiwik' => '升級 Piwik',
	'CoreUpdater_HelpMessageContent' => '請檢查 %s Piwik FAQ %s ，在其中已試圖解釋最常見的升級過程中的錯誤。 %s 請詢問您的系統管理員 - 他們可以協助您解決幾乎所有有關您的伺服器或 MySQL 設定的問題！',
	'CoreUpdater_CriticalErrorDuringTheUpgradeProcess' => '在升級過程中發生嚴重的錯誤：',
	'CoreUpdater_HelpMessageIntroductionWhenError' => '以上是核心的錯誤訊息。它應有助於解釋原因，但如果您需要進一步的說明，請：',
	'CoreUpdater_HelpMessageIntroductionWhenWarning' => '此次升級成功完成，但在過程中有發生一些問題，請仔細閱讀上面的詳細說明。如需更進一步的說明：',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Piwik 已成功升級！',
	...
	'Dashboard_AddPreviewedWidget' => '增加已預覽的器件至儀表板',
	'Dashboard_WidgetPreview' => '器件預覽',
	'Dashboard_TitleWidgetInDashboard_js' => '器件已存在儀表板',
	'Dashboard_TitleClickToAdd_js' => '點擊以增加至儀表板',
	'Dashboard_LoadingPreview_js' => '載入預覽中，請稍候...',
	...
	'Referers_OtherDistinctKeywords' => '%s 個不同的關鍵字',
	'Referers_OtherDistinctWebsites' => '%1s 個不同的網站 (使用 %2s 個不同的 URL 位址)',
	'Referers_OtherDistinctPartners' => '%1s 個不同的友站 (使用 %2s 個不同的 URL 位址)',
	'Referers_OtherDistinctCampaigns' => '%s 個不同的廣告活動',
	'Referers_TagCloud' => '標籤雲輸出',
	...
	'Referers_SubmenuPartners' => '友站',
	'Referers_WidgetKeywords' => '關鍵字清單',
	'Referers_WidgetPartners' => '友站清單',
	...
	'UserCountry_country_ru' => '俄羅斯聯邦',
	'UserCountry_country_rs' => '俄羅斯',
	...
	'VisitsSummary_NbBounced' => '%s 個單頁瀏覽造訪數 (於瀏覽單一網頁後離開站台)',
	'VisitsSummary_Evolution' => '最近 30 %ss 的發展趨勢',
	...
	'VisitsSummary_WidgetLastVisitors' => '最近絕對獨一訪客圖形',
	'VisitsSummary_WidgetOverviewGraph' => '概觀以圖形表示',
	'VisitsSummary_SubmenuOverview' => '概觀',
	'VisitFrequency_Evolution' => '此統計週期的發展趨勢',
	'VisitFrequency_ReturnVisits' => '%s 個重返造訪數',
	'VisitFrequency_ReturnActions' => '%s 個活動數由重返造訪所產生',
	'VisitFrequency_ReturnMaxActions' => '%s 由單一個重返造訪所產生的最大活動數',
	'VisitFrequency_ReturnTotalTime' => '%s 重返造訪總停留時間',
	'VisitFrequency_ReturnBounces' => '%s 個單頁瀏覽重返造訪數 (於瀏覽單一網頁後離開站台)',
	'VisitFrequency_WidgetOverview' => '造訪頻率概觀',
	'VisitFrequency_WidgetGraphReturning' => '圖形表示重返造訪次數',
	...
	'VisitorInterest_WidgetPages' => '頁每個造訪',
	...
	'Login_ContactAdmin' => '可能的原因：您的主機可能已經停用了 mail() 函式！ <br />請聯絡您的 Piwik 管理員！',
	...
	'SitesManager_MainDescription' => '您的網站分析報告需要網站！增加、更新、刪除網站，並顯示 Javascript 追蹤碼以插入在您的網頁之中！',
	...
	'Installation_GoToPiwik' => '開始 Piwik',
	...
	'Installation_SystemCheckGD' => 'GD &gt; 2.x (圖形函式庫)',
	...
	'Installation_SystemCheckWarning' => 'Piwik 將正常工作，但某些功能可能會遺失',
	'Installation_Tables' => '建立資料表中',
	'Installation_TablesWarning' => '部份 <span id="linkToggle">Piwik 資料表</span> 早已安裝在資料庫之中',
	'Installation_TablesFound' => '以下的資料表在資料庫之中已經被找到',
	'Installation_TablesWarningHelp' => '要麼就選擇重複使用現存的資料表，再不然就選擇全新安裝，以清除所有現存資料庫中的資料！',
	...
	'Installation_TablesDeleteConfirm' => '您確定要從此資料庫刪除所有的 Piwik 資料表嗎？',
	'Installation_Welcome' => '歡迎使用！',
	'Installation_WelcomeHelp' => '<p>Piwik 是一個讓您能夠輕易取得您所想要的訪客資訊的開放原始碼網頁分析軟體！</p><p>此安裝過程分為 %s 個簡易的步驟，並且將僅花大約 5 分鐘的時間！</p>',
