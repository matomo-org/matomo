...
$translations = array(
	...
	'General_YouMustBeLoggedIn' => '你必須登入才能存取這個功能。',
	...
	'Mobile_YouAreOffline' => '抱歉，你目前離線狀態',
	'SitesManager_NotFound' => '找不到網站',
	'UserCountryMap_map' => '地圖',
	'UserCountryMap_worldMap' => '世界地圖',
	'UserCountryMap_toggleFullscreen' => '切換全螢幕',
	'PDFReports_PluginDescription' => '建立及下載你的自訂 PDF 報表，然後讓它們每日、每週或每月寄到信箱。',
	'PDFReports_ManagePdfReports' => '管理 PDF 報表',
	'PDFReports_PDF' => 'PDF',
	'PDFReports_EmailSchedule' => 'Email 排程',
	'PDFReports_SendReportTo' => '寄送報告至',
	'PDFReports_SentToMe' => '寄給我',
	'PDFReports_CreateAndSchedulePDFReport' => '建立及排程一份 PDF 報表',
	'PDFReports_CancelAndReturnToPDF' => '取消並 %s返回 PDF 報表清單%s',
	'PDFReports_DescriptionWillBeFirstPage' => '報表描述將顯示於 PDF 報表的第一頁。',
	'PDFReports_WeeklyScheduleHelp' => '每週排程：報表將會在每週的星期一寄出。',
	'PDFReports_MonthlyScheduleHelp' => '每月排程：報表江蕙在每月的第一天寄出。',
	'PDFReports_AlsoSendReportToTheseEmails' => '也將報表寄到這些電子郵件地址（一行一個信箱）：',
	'PDFReports_ReportsIncludedInPDF' => '報表以 PDF 形式',
	'PDFReports_CreatePDFReport' => '建立 PDF 報表',
	'PDFReports_UpdatePDFReport' => '更新 PDF 報表',
	'PDFReports_PiwikReports' => 'Piwik 報表',
	'PDFReports_DefaultPDFContainingAllReports' => '預設 PDF 包含所有可用的報表。',
	'PDFReports_EmailHello' => '你好，',
	'PDFReports_PleaseFindAttachedFile' => '請在你的報表 %2$s 找到附件 %1$s 。',
	'PDFReports_AreYouSureYouWantToDeleteReport' => '你確定要刪除這個 PDF 報表排程嗎？',
	'PDFReports_ThereIsNoPDFReportToManage' => '網站 %s 沒有 PDF 報表可以管理',
	'PDFReports_YouMustBeLoggedIn' => '你必須登入才能建立及排程自訂 PDF 報表。',
);
