...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
     ...
     *
     * Version 2015091800, Last Updated Fri Sep 18 07:07:01 2015 UTC -- with manual additions!
     *
                ...
                if (preg_match('/([^.]{2,63})$/iu', end($domainParts), $matches)
                    ...
                    if ($this->_options['idn'] &&  isset($this->_validIdns[strtoupper($this->_tld)])) {
                        if (is_string($this->_validIdns[strtoupper($this->_tld)])) {
                            $regexChars += include(__DIR__ . DIRECTORY_SEPARATOR . $this->_validIdns[strtoupper($this->_tld)]);
                        } else {
