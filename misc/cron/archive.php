...
\n\n";
    ...
    if('' === Piwik\Common::getRequestVar('token_auth', '', 'string')) {
        echo "
<b>You must specify the Superuser token_auth as a parameter to this script, eg. <code>?token_auth=XYZ</code> if you wish to run this script through the browser. </b><br>
...
<code>$ /path/to/php /path/to/piwik/console core:archive --url=https://your-website.org/path/to/piwik/</code>
\n\n";
        exit;
    }
