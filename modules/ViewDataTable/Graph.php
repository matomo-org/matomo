...
//		print($url);exit;
	...
	{ 
		...
		$this->codeEmbed = "<embed src='$urlGraph' quality='high' bgcolor='#FFFFFF' width='". $width ."' height='". $height ."' name='open-flash-chart' type='application/x-shockwave-flash' id='". $obj_id ."'/>";
