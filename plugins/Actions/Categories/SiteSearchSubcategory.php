...
class SiteSearchSubcategory extends Subcategory
{
    ...
    public function getHelp()
    {
        return '<p>' . Piwik::translate('Actions_SiteSearchSubcategoryHelp1') . '</p>'
            ...
            . '<p><a href="https://matomo.org/docs/site-search/?mtm_campaign=App_Help&mtm_source=Matomo_App" rel="noreferrer noopener" target="_blank">' . Piwik::translate('Actions_SiteSearchSubcategoryHelp3') . '</a></p>';
    }
}
