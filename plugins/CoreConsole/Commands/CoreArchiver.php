...
* Enjoy!");
        ...
        $command->addOption('start-date', null, InputOption::VALUE_OPTIONAL, "If set, will force Piwik to re-archive since this date up till value of end-date or yesterday");
