...
function CopyToClipboard_onClickHandler(binding, event) {
  if (event.target) {
    var el = event.target;

    if (el.parentElement && el.parentElement.parentElement) {
      var pre = el.parentElement.parentElement.getElementsByTagName('pre')[0];
      ...
      if (pre) {
        ...
        var icon = el.parentElement.getElementsByTagName('i')[0];
        ...
        var copied = el.parentElement.parentElement.getElementsByClassName('copyToClipboardCopiedDiv')[0];
...
function onTransitionEndHandler(binding, event) {
  if (event.target) {
...
/* harmony default export */ var CopyToClipboard = ({
  mounted: function mounted(el, binding) {
    ...
    if (tagName === 'pre') {
      ...
      binding.value.onClickHandler = CopyToClipboard_onClickHandler.bind(null, binding);
