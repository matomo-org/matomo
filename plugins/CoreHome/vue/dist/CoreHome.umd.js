...
(${errorType}: ${realSrc})`;
  ...
  const _sfc_main$h = vue.defineComponent({
    ...
    computed: {
      ...
      isEnriched() {
        return !!(this.featureName || this.inlineHelp || this.reportGenerated || this.editUrl || this.helpUrl);
      },
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["reportHeader", { "reportHeader--flush": _ctx.isFullPage }])
    }, [
      vue.createElementVNode("div", _hoisted_1$f, [
        (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.titleTag), {
          ...
          onKeydown: [
            vue.withKeys(vue.withModifiers(_ctx.onTitleClick, ["prevent"]), ["enter"]),
            vue.withKeys(vue.withModifiers(_ctx.onTitleClick, ["prevent"]), ["space"])
          ]
        }, {
          default: vue.withCtx(() => [
            _ctx.isEnriched ? (vue.openBlock(), vue.createBlock(_component_EnrichedHeadline, {
              key: 0,
              ...
              default: vue.withCtx(() => [
                vue.createElementVNode("span", null, vue.toDisplayString(_ctx.reportTitle), 1)
              ]),
              _: 1
            }, 8, ["feature-name", "inline-help", "report-generated", "edit-url", "help-url"])) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$a, vue.toDisplayString(_ctx.reportTitle), 1))
          ]),
          _: 1
    ...
    methods: {
      ...
      loadWidgetUrl(parameters, thisChangeId) {
        ...
        AjaxHelper.fetch(this.getWidgetUrl(Object.assign(parameters, searchFilters)), {
          ...
          if (this.widgetName) {
            const $header = $content.find('[vue-entry="CoreHome.ReportHeader"]').first();
            if ($header.length) {
