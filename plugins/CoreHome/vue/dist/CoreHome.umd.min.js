 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */let D;const{piwik:P,broadcast:T,piwikHelper:V}=window;function N(){return window.CoreHome.ReportingMenuStore}function x(){return window.CoreHome.ComparisonsStoreInstance}function B(e){var t;if("string"!==typeof e)return;const o=e.trim(),i=x();if(i){const t=i.getSegmentComparisons();if(!o&&t.length)return t[0].title;const n=t.find(t=>t.params.segment===e);if(n)return n.title}if(!o)return a("SegmentEditor_DefaultAllVisits");const n=document.querySelector(".segmentEditorPanel .segmentationTitle"),r=null===n||void 0===n||null===(t=n.textContent)||void 0===t?void 0:t.trim();return r||a("SegmentEditor_CustomSegment")}P.helper=V,P.broadcast=T,P.updateDateInTitle=function(e,t){if($(".top_controls #periodString").length&&(D=D||document.title,0===D.indexOf(P.currentSiteName))){const o=` - ${c.parse(t,e).getPrettyString()} `;document.title=`${P.currentSiteName}${o}${D.slice(P.currentSiteName.length)}`}},P.updateTitle=function(e,t,o,i,n){if(!$(".top_controls #periodString").length)return;let a,r;const s=N();if(s&&o&&i){var l,d;const e=s.findSubcategory(o,i);a=null===e||void 0===e||null===(l=e.category)||void 0===l?void 0:l.name,r=null===e||void 0===e||null===(d=e.subcategory)||void 0===d?void 0:d.name}if(D=D||document.title,0===D.indexOf(P.currentSiteName)){const o=` - ${c.parse(t,e).getPrettyString()} `,i=[a,r].filter(e=>!!e).filter((e,t,o)=>o.indexOf(e)===t).map(e=>V.htmlEntities(e)),s=i.length?" - "+i.join(" > "):"",l=B(n),d=l?" - "+V.htmlEntities(l):"";document.title=`${P.currentSiteName}${o}${s}${d}${D.slice(P.currentSiteName.length)}`}},P.hasUserCapability=function(e){return Array.isArray(P.userCapabilities)&&-1!==P.userCapabilities.indexOf(e)},P.on=function(e,t){function o(e){t(...e.detail)}t.wrapper=o,window.addEventListener(e,o)},P.off=function(e,t){t.wrapper&&window.removeEventListener(e,t.wrapper)},P.postEvent=function(e,...t){const o=new CustomEvent(e,{detail:t});window.dispatchEvent(o)};const I=P;var M=I;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
