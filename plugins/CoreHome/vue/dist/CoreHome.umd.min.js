 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function C(){const e={getSearchParam:I.getSearchParam.bind(I)};return e}window.ajaxHelper=x,C.$inject=[],angular.module("piwikApp.service").service("piwikUrl",C);var R=r("8bbf");const A={class:"loadingPiwik"},E=Object(R["createElementVNode"])("img",{src:"plugins/Morpheus/images/loading-blue.gif",alt:""},null,-1);function S(e,t,r,a,n,i){return Object(R["withDirectives"])((Object(R["openBlock"])(),Object(R["createElementBlock"])("div",A,[E,Object(R["createElementVNode"])("span",null,Object(R["toDisplayString"])(e.loadingMessage),1)],512)),[[R["vShow"],e.loading]])}var M=Object(R["defineComponent"])({props:{loading:{type:Boolean,required:!0,default:!1},loadingMessage:{type:String,required:!1,default:i("General_LoadingData")}}});M.render=S;var _=M;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function q(){return{restrict:"A",scope:{loading:"<",loadingMessage:"<"},template:"",link:function(e,t){const r=Object(R["createApp"])({template:'<activity-indicator :loading="loading" :loadingMessage="loadingMessage"/>',data(){return{loading:e.loading,loadingMessage:e.loadingMessage}}});r.component("activity-indicator",_);const a=r.mount(t[0]);e.$watch("loading",e=>{a.loading=e}),e.$watch("loadingMessage",e=>{a.loadingMessage=e||i("General_LoadingData")})}}}function F(e,t,r,a,n,i){return Object(R["openBlock"])(),Object(R["createElementBlock"])("div",{class:Object(R["normalizeClass"])(["alert",{["alert-"+e.severity]:!0}])},[Object(R["renderSlot"])(e.$slots,"default")],2)}q.$inject=[],angular.module("piwikApp").directive("piwikActivityIndicator",q);var H=Object(R["defineComponent"])({props:{severity:{type:String,required:!0}}});H.render=F;var U=H;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function L(){return{restrict:"A",transclude:!0,scope:{severity:"@piwikAlert"},template:"<div ng-transclude/>",compile:function(){return{post:function(e,t){const r=t.find("[ng-transclude]"),a=Object(R["createApp"])({template:'<alert :severity="severity"><div ref="transcludeTarget"/></alert>',data(){return{severity:e.severity}},setup(){const e=Object(R["ref"])(null);return{transcludeTarget:e}}});a.component("alert",U);const n=a.mount(t[0]);e.$watch("severity",e=>{n.severity=e}),$(n.transcludeTarget).append(r)}}}}}L.$inject=[],angular.module("piwikApp").directive("piwikAlert",L)}})}));
