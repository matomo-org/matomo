 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */const kc={class:"main-duplicator-modal-content"},Sc={class:"modal-header"},Cc=Object(E["createElementVNode"])("span",{class:"btn-close modal-close"},[Object(E["createElementVNode"])("i",{class:"icon-close"})],-1),Ec={key:0,class:"modal-content duplicator-modal-loading"},Dc={class:"Piwik_Popover_Loading"},Pc={class:"Piwik_Popover_Loading_Name"},Tc={class:"modal-sub-header"},Vc=["innerHTML"],Nc={class:"modal-content"},xc={class:"modal-inputs"},Bc={class:"modal-sub-footer"},Ic=["innerHTML"],Mc=["innerHTML"],Lc={class:"modal-footer"},Fc=["disabled"];function Ac(e,t,o,i,n,a){const r=Object(E["resolveComponent"])("Field"),s=Object(E["resolveDirective"])("form");return Object(E["openBlock"])(),Object(E["createElementBlock"])("div",{class:Object(E["normalizeClass"])({modal:!0,"entity-duplicator-modal":!0,"slot-configured":e.$slots.default}),ref:"root"},[Object(E["withDirectives"])(Object(E["createElementVNode"])("div",kc,[Object(E["createElementVNode"])("div",Sc,[Cc,Object(E["createElementVNode"])("h2",null,Object(E["toDisplayString"])(e.getModalTitle),1)]),e.isLoading?(Object(E["openBlock"])(),Object(E["createElementBlock"])("div",Ec,[Object(E["createElementVNode"])("div",Dc,[Object(E["createElementVNode"])("div",Pc,[Object(E["createElementVNode"])("h2",null,Object(E["toDisplayString"])(e.translate("General_Loading")),1)])])])):(Object(E["openBlock"])(),Object(E["createElementBlock"])(E["Fragment"],{key:1},[Object(E["createElementVNode"])("div",Tc,[Object(E["createElementVNode"])("p",null,[Object(E["createTextVNode"])(Object(E["toDisplayString"])(e.getDuplicateDescription)+"  ",1),e.descriptionLearnMoreLink?(Object(E["openBlock"])(),Object(E["createElementBlock"])("span",{key:0,innerHTML:e.$sanitize(e.getLearnMoreLink)},null,8,Vc)):Object(E["createCommentVNode"])("",!0)]),Object(E["createVNode"])(r,{uicontrol:"site",name:"siteSelector",title:e.translate("CoreHome_ChooseWebsite"),modelValue:e.site,"onUpdate:modelValue":t[0]||(t[0]=t=>e.site=t),"ui-control-attributes":{sitesWithAtLeastWriteAccess:!0,siteTypesToExclude:["rollup"]}},null,8,["title","modelValue"])]),Object(E["createElementVNode"])("div",Nc,[Object(E["withDirectives"])((Object(E["openBlock"])(),Object(E["createElementBlock"])("div",xc,[Object(E["renderSlot"])(e.$slots,"default")])),[[s]])]),Object(E["createElementVNode"])("div",Bc,[e.duplicationErrors.length>0?(Object(E["openBlock"])(),Object(E["createElementBlock"])("div",{key:0,class:Object(E["normalizeClass"])(e.getAlertClasses)},[Object(E["createElementVNode"])("ul",null,[(Object(E["openBlock"])(!0),Object(E["createElementBlock"])(E["Fragment"],null,Object(E["renderList"])(e.duplicationErrors,(t,o)=>(Object(E["openBlock"])(),Object(E["createElementBlock"])("li",{key:o,innerHTML:e.$sanitize(t)},null,8,Ic))),128))])],2)):Object(E["createCommentVNode"])("",!0),0===e.duplicationErrors.length?(Object(E["openBlock"])(),Object(E["createElementBlock"])("p",{key:1,class:"note-text",innerHTML:e.$sanitize(e.getNoteText)},null,8,Mc)):Object(E["createCommentVNode"])("",!0)]),Object(E["createElementVNode"])("div",Lc,[Object(E["createElementVNode"])("button",{class:"btn",disabled:!e.getIsValid||e.hasBeenSubmitted,onClick:t[1]||(t[1]=t=>e.submitDuplicationRequest())},Object(E["toDisplayString"])(e.translate("General_Copy")),9,Fc)])],64))],512),[[E["vShow"],e.isModalVisible]])],2)}function _c(e,t,o){return t in e?Object.defineProperty(e,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[t]=o,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */class Rc{constructor(e,t,o){_c(this,"state",Object(E["reactive"])({isModalVisible:!1,isWatchSuppressed:!1,commonFormData:{},entityFormData:{},duplicateEntityType:"",duplicateEntityTypeTranslation:""})),this.state.duplicateEntityType=e,this.state.duplicateEntityTypeTranslation=t,this.state.commonFormData=null!==o&&void 0!==o?o:{}}showModal(e){this.resetFormData(),Object.entries(null!==e&&void 0!==e?e:{}).forEach(([e,t])=>{this.state.entityFormData[e]=t}),this.state.isModalVisible=!0}hideModal(){this.state.isModalVisible=!1,this.resetFormData()}resetFormData(){this.state.isWatchSuppressed=!0,Object.keys(this.state.entityFormData).forEach(e=>{delete this.state.entityFormData[e]})}disableWatchSuppression(){this.state.isWatchSuppressed=!1}getFormValues(e){const t=Array.isArray(e)?e:[];return e&&!Array.isArray(e)&&t.push(e),Object.assign(Object.assign({module:"CoreHome",action:"duplicateEntity",idSite:x.idSite||_.parsed.value.idSite,idDestinationSites:t,entityTypeName:this.state.duplicateEntityType},this.state.commonFormData),this.state.entityFormData)}get getEntityTypeTranslation(){let e="CoreHome_ReportLowercase";return this.state.duplicateEntityTypeTranslation&&(e=this.state.duplicateEntityTypeTranslation),r(e)}}function Hc(e,t,o){return Object(E["reactive"])(new Rc(e,t,o))}const $c=be("CorePluginsAdmin","Field"),Uc=be("CorePluginsAdmin","Form"),{$:qc}=window;var Wc=Object(E["defineComponent"])({directives:{Form:Uc},components:{Field:$c},props:{modalStore:{type:Rc,required:!0}},data(){return{isLoading:!0,isValidated:!1,descriptionLearnMoreLink:"",duplicationErrors:[],site:null,hasSiteBeenInitialised:!1,hasBeenSubmitted:!1}},emits:["duplicationSuccessful","duplicationFailed"],watch:{isModalVisible(e){e&&(this.showDuplicateModal(),this.isLoading=!1)},site(){this.onSiteChange()}},methods:{closeModal(){const e=this.$refs.root,t=qc(e);t.modal("close")},resetModal(){this.modalStore.hideModal(),this.site=null,this.isLoading=!0,this.isValidated=!1,this.duplicationErrors=[],this.hasSiteBeenInitialised=!1,this.hasBeenSubmitted=!1},showDuplicateModal(){const e=this.$refs.root,t=qc(e);t.modal({dismissible:!0,onCloseEnd:()=>{this.resetModal()}}).modal("open")},submitDuplicationRequest(){var e;if(this.hasBeenSubmitted=!0,this.modalStore.disableWatchSuppression(),this.validateFormFields(),!this.getIsValid)return void(this.hasBeenSubmitted=!1);const t=new W;t.removeDefaultParameter("date"),t.removeDefaultParameter("period"),t.removeDefaultParameter("segment"),t.withTokenInUrl(),t.addParams(this.modalStore.getFormValues(null===(e=this.site)||void 0===e?void 0:e.id),"POST"),t.setFormat("json"),t.send().then(e=>{e&&e.isDuplicationSuccessful?(this.$emit("duplicationSuccessful",e),this.closeModal()):this.emitFailureAndSetErrorMessage()}).catch(e=>{this.emitFailureAndSetErrorMessage(),console.log("Unexpected server error during request.",e)}).finally(()=>{this.hasBeenSubmitted=!1})},validateFormFields(){var e;if(this.isValidated=!0,this.duplicationErrors=[],!this.modalStore.state.isModalVisible)return;const t={formValues:this.modalStore.getFormValues(null===(e=this.site)||void 0===e?void 0:e.id),errorMessages:[]};x.postEvent("EntityDuplicator:validateFormFields",t),t&&Array.isArray(t.errorMessages)&&t.errorMessages.length>0&&(this.duplicationErrors=t.errorMessages)},onSiteChange(){this.isValidated=!1},emitFailureAndSetErrorMessage(e=null){let t=e;t||(t={isDuplicationSuccessful:!1,errorMessage:a("General_ErrorRequest")}),t.errorMessage&&0!==t.errorMessage.length||(t.errorMessage=a("General_ErrorRequest")),this.duplicationErrors=[],this.duplicationErrors.push(t.errorMessage),this.$emit("duplicationFailed",t)}},mounted(){Object(E["watch"])(()=>this.modalStore.state.entityFormData,()=>{this.modalStore.state.isWatchSuppressed||(this.isValidated=!1)},{deep:!0})},computed:{isModalVisible(){var e;return null!==(e=this.modalStore.state.isModalVisible)&&void 0!==e&&e},getModalTitle(){return a("CoreHome_CopyX",this.modalStore.getEntityTypeTranslation)},getNoteText(){const e=a("CoreHome_CopyModalNote","<strong>","</strong>",this.modalStore.getEntityTypeTranslation);return""+e},getDuplicateDescription(){return a("CoreHome_CopyXDescription",this.modalStore.getEntityTypeTranslation)},getLearnMoreLink(){if(!this.descriptionLearnMoreLink)return"";const e=ne(this.descriptionLearnMoreLink);return a("CoreHome_LearnMoreFullStop",e,"</a>")},getAlertClasses(){const e=this.duplicationErrors.length>1?" error-list":"";return"alert alert-danger"+e},getIsValid(){return!this.isValidated||Array.isArray(this.duplicationErrors)&&0===this.duplicationErrors.length}}});Wc.render=Ac;var zc=Wc;const Gc=["title","aria-disabled"];function Yc(e,t,o,i,n,a){const r=Object(E["resolveDirective"])("tooltips");return Object(E["withDirectives"])((Object(E["openBlock"])(),Object(E["createElementBlock"])("a",{class:Object(E["normalizeClass"])([{"entity-duplicator-action":!0,"table-action":!0,"icon-content-copy":!0,"is-disabled":!e.isActionEnabled},e.extraClasses]),title:e.getActionTooltip,"aria-disabled":!e.isActionEnabled,onClick:t[0]||(t[0]=t=>!e.isActionEnabled||e.handleClick())},null,10,Gc)),[[r],[E["vShow"],e.isActionVisible]])}var Jc=Object(E["defineComponent"])({props:{actionFormData:{type:Object,required:!0},modalStore:{type:Rc,required:!0},isActionVisible:{type:Boolean,required:!0,default:!1},isActionEnabled:{type:Boolean,required:!1,default:!1},tooltipTextOverride:{type:String,required:!1,default:""},tooltipTextOverrideDisabled:{type:String,required:!1,default:""},extraClasses:{type:[String,Array,Object],default:""}},directives:{Tooltips:Ze},methods:{handleClick(){this.modalStore.showModal(this.actionFormData)}},computed:{getActionTooltip(){return this.isActionEnabled&&this.tooltipTextOverride.length?r(this.tooltipTextOverride):!this.isActionEnabled&&this.tooltipTextOverrideDisabled.length?r(this.tooltipTextOverrideDisabled):a("CoreHome_CopyX",this.modalStore.getEntityTypeTranslation)}}});Jc.render=Yc;var Kc=Jc;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
