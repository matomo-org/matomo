 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */var pt={},mt=120,ft=50,ht=1e3;function gt(e){if(pt[e])return pt[e];if(window[e])return Promise.resolve(window[e]);var t,n,r,i="?module=Proxy&action=getPluginUmdJs&plugin=".concat(e),o=document.createElement("script");o.charset="utf-8",o.timeout=mt,o.src=i;var a=new Error,l=function(i){o.onerror=null,o.onload=null,clearTimeout(r);var l=0;function c(){if(l+=ft,t&&n)if(window[e]&&n)try{n(window[e])}finally{t=void 0,n=void 0}else if(l>ht)try{var r=i&&("load"===i.type?"missing":i.type),o=i&&i.target&&i.target.src;a.message="Loading plugin ".concat(e," on demand failed.\n(").concat(r,": ").concat(o,")"),a.name="PluginOnDemandLoadError",a.type=r,a.request=o,t(a)}finally{t=void 0,n=void 0}else setTimeout(c,ft)}setTimeout(c,ft)};return r=setTimeout((function(){l({type:"timeout",target:o})}),mt),o.onerror=l,o.onload=l,document.head.appendChild(o),new Promise((function(e,r){n=e,t=r}))}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var pn=window,mn=pn.$,fn={mounted:function(e,t){var n=mn(e),r=t.value.sensitiveData,i=t.value.showCharacters||6,o=t.value.clickElementSelector||n,a="";function l(){n.html(r),mn(o).css({cursor:""}),mn(o).tooltip("destroy")}i>0&&(a+=r.slice(0,i)),a+=r.slice(i).replace(/./g,"*"),n.html(a),mn(o).tooltip({content:C("CoreHome_ClickToSeeFullInformation"),items:"*",track:!0}),mn(o).one("click",l),mn(o).css({cursor:"pointer"})}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function lc(){return{get pages(){return Tl.pages.value},findPageInCategory:function(){return At(Tl.findPageInCategory.apply(Tl,arguments))},findPage:function(){return At(Tl.findPage.apply(Tl,arguments))},reloadAllPages:function(){return Tl.reloadAllPages().then((function(e){return Bt(e)}))},getAllPages:function(){return Tl.getAllPages().then((function(e){return Bt(e)}))}}}function cc(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function sc(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function uc(e,t,n){return t&&sc(e.prototype,t),n&&sc(e,n),e}function dc(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */window.angular.module("piwikApp.service").factory("reportingMenuModel",ac),window.angular.module("piwikApp.service").factory("reportingPagesModel",lc);var pc=function(){function e(){var t=this;cc(this,e),dc(this,"privateState",Object(o["reactive"])({reports:[]})),dc(this,"state",Object(o["readonly"])(this.privateState)),dc(this,"reports",Object(o["computed"])((function(){return t.state.reports}))),dc(this,"reportsPromise",void 0)}return uc(e,[{key:"findReport",value:function(e,t){return this.reports.value.find((function(n){return n.module===e&&n.action===t}))}},{key:"fetchReportMetadata",value:function(){var e=this;return this.reportsPromise||(this.reportsPromise=Ze.fetch({method:"API.getReportMetadata",filter_limit:"-1",idSite:S.idSite||Ee.parsed.value.idSite}).then((function(t){return e.privateState.reports=t,t}))),this.reportsPromise.then((function(){return e.reports.value}))}}]),e}(),mc=new pc;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function Au(e,t){var n,r=parseInt(t,10),i=parseInt(e,10)-r;return n=0===i||Number.isNaN(i)?0:0===r||Number.isNaN(r)?100:i/r*100,n}function Bu(e){return"".concat(e>0?S.numbers.symbolPlus:"").concat(Math.round(e),"}%")}function Iu(e,t){var n=Au(e,t);return Bu(n)}Tu.$inject=["$parse"],window.angular.module("piwikApp").directive("piwikAjaxForm",Tu);var xu={ref:"root"};function Mu(e,t,n,r,i,a){return Object(o["openBlock"])(),Object(o["createElementBlock"])("div",xu,[e.componentWrapper?(Object(o["openBlock"])(),Object(o["createBlock"])(Object(o["resolveDynamicComponent"])(e.componentWrapper),{key:0})):Object(o["createCommentVNode"])("",!0)],512)}var Lu=Object(o["defineComponent"])({props:{html:String},mounted:function(){S.helper.compileVueEntryComponents(this.$refs.root)},beforeUnmount:function(){S.helper.destroyVueComponent(this.$refs.root)},computed:{componentWrapper:function(){return this.html?Object(o["markRaw"])({template:this.html}):null}}});Lu.render=Mu;var Ru=Lu,Fu=Vt({component:Oa,scope:{loading:{vue:"loading",angularJsBind:"<"},loadingMessage:{vue:"loadingMessage",angularJsBind:"<",default:function(){return C("General_LoadingData")}}},$inject:[],directiveName:"piwikActivityIndicator"});
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
