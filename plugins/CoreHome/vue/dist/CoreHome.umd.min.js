 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */const{piwik:D,broadcast:P,piwikHelper:T}=window;function V(){var e;return null===(e=window.CoreHome)||void 0===e?void 0:e.ReportingMenuStore}function N(){var e;return null===(e=window.CoreHome)||void 0===e?void 0:e.ComparisonsStoreInstance}function x(e){var t;if("string"!==typeof e)return;const o=e.trim(),i=N();if(i){const t=i.getSegmentComparisons();if(!o&&t.length)return t[0].title;const n=t.find(t=>t.params.segment===e);if(n)return n.title}if(!o)return a("SegmentEditor_DefaultAllVisits");const n=document.querySelector(".segmentEditorPanel .segmentationTitle"),r=null===n||void 0===n||null===(t=n.textContent)||void 0===t?void 0:t.trim();return r||a("SegmentEditor_CustomSegment")}D.helper=T,D.broadcast=P,D.updateTitle=async function(e,t,o,i,n){let r,s,l="";""!==t&&""!==e&&(l=c.parse(t,e).getPrettyString()+" ");const d=a("CoreHome_WebAnalyticsReports")+" - Matomo",u=V();if(u&&o&&i){var m,p,h,g;const e=u.findSubcategory(o,i);if(!e.category)return;r=null!==(m=null===e||void 0===e||null===(p=e.category)||void 0===p?void 0:p.name)&&void 0!==m?m:"",s=null!==(h=null===e||void 0===e||null===(g=e.subcategory)||void 0===g?void 0:g.name)&&void 0!==h?h:"",r===s&&(s=""),r=T.htmlEntities(r),s=T.htmlEntities(s);const t=r?`${r}  ${s?"> "+s:""}`:"",a=x(n),c=a?""+T.htmlEntities(a):"";document.title=`${D.siteName} - ${l} - ${t} - ${c} - ${d}`}else document.title=`${D.siteName} - ${l} - ${d}`},D.hasUserCapability=function(e){return Array.isArray(D.userCapabilities)&&-1!==D.userCapabilities.indexOf(e)},D.on=function(e,t){function o(e){t(...e.detail)}t.wrapper=o,window.addEventListener(e,o)},D.off=function(e,t){t.wrapper&&window.removeEventListener(e,t.wrapper)},D.postEvent=function(e,...t){const o=new CustomEvent(e,{detail:t});window.dispatchEvent(o)};const B=D;var I=B;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function se(e,t,o){return Q.formatNumber(e,t,o)}function le(e,t,o){return Q.formatPercent(e,t,o)}function ce(e,t,o,i){return Q.formatCurrency(e,t,o,i)}function de(e,t,o,i){return Q.formatEvolution(e,t,o,i)}function ue(e,t,o){return Q.calculateAndFormatEvolution(e,t,o)}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
