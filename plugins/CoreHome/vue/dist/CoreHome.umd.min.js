 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */l.addCustomPeriod("year",x);const{piwik:H,broadcast:N}=window;function F(e,t){try{return l.parse(e,t),!0}catch(r){return!1}}class A{constructor(){I(this,"urlQuery",Object(o["ref"])("")),I(this,"hashQuery",Object(o["ref"])("")),I(this,"urlParsed",Object(o["computed"])(()=>N.getValuesFromUrl("?"+this.urlQuery.value,!0))),I(this,"hashParsed",Object(o["computed"])(()=>N.getValuesFromUrl("?"+this.hashQuery.value,!0))),I(this,"parsed",Object(o["computed"])(()=>Object(o["readonly"])({...this.urlParsed.value,...this.hashParsed.value}))),this.setUrlQuery(window.location.search),this.setHashQuery(window.location.hash),h.on("$locationChangeSuccess",()=>{const e=h.helper.getAngularDependency("$location"),t=e.absUrl(),r=t.indexOf("?"),n=t.indexOf("#");this.setUrlQuery(t.substring(r,n)),this.setHashQuery(t.substring(n))}),this.updatePeriodParamsFromUrl()}updateHash(e){const t="string"!==typeof e?this.stringify(e):e,r=h.helper.getAngularDependency("$location");r.search(t)}getSearchParam(e){const t=window.location.href.split("#"),r=new RegExp(e+"(\\[]|=)");if(t&&t[1]&&r.test(decodeURIComponent(t[1]))){const t=window.broadcast.getValueFromHash(e,window.location.href);if(t||"date"!==e&&"period"!==e&&"idSite"!==e)return t}return window.broadcast.getValueFromUrl(e,window.location.search)}onLocationChange(e){window.addEventListener("hashchange",()=>{const t=new URLSearchParams(window.location.hash.replace(/^[#?/]+/,""));e(t)})}parseHashQuery(){return this.parseQueryString(window.location.hash.replace(/^[#?/]+/,""))}parseQueryString(e){const t=new URLSearchParams(e),r={};return Array.from(t.keys()).forEach(e=>{/[[\]]/.test(e)||-1!==e.indexOf("%5B%5D")?r[e]=t.getAll(e):r[e]=t.get(e)}),r}stringify(e){return $.param(e)}updatePeriodParamsFromUrl(){let e=this.getSearchParam("date");const t=this.getSearchParam("period");if(!F(t,e))return;if(H.period===t&&H.currentDateString===e)return;H.period=t;const r=l.parse(t,e).getDateRange();H.startDateString=f(r[0]),H.endDateString=f(r[1]),H.updateDateInTitle(e,t),"range"===H.period&&(e=`${H.startDateString},${H.endDateString}`),H.currentDateString=e}setUrlQuery(e){this.urlQuery.value=e.replace(/^\?/,"")}setHashQuery(e){this.hashQuery.value=e.replace(/^[#/?]+/,"")}}const B=new A;var R=B;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
