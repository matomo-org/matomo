 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */const{piwik:D,broadcast:P,piwikHelper:T}=window;async function V(){const e=window.CoreHome;return null===e||void 0===e?void 0:e.ReportingMenuStore}function N(){const e=window.CoreHome;return null===e||void 0===e?void 0:e.ComparisonsStoreInstance}function x(e){var t;if("string"!==typeof e)return;const o=e.trim(),i=N();if(i){const t=i.getSegmentComparisons();if(!o&&t.length)return t[0].title;const n=t.find(t=>t.params.segment===e);if(n)return n.title}if(!o)return a("SegmentEditor_DefaultAllVisits");const n=document.querySelector(".segmentEditorPanel .segmentationTitle"),r=null===n||void 0===n||null===(t=n.textContent)||void 0===t?void 0:t.trim();return r||a("SegmentEditor_CustomSegment")}D.helper=T,D.broadcast=P,D.updateTitle=async function(e,t,o,i,n){let r="",s="",l="";""!==t&&""!==e&&(l=c.parse(t,e).getPrettyString()+" ");const d=a("CoreHome_WebAnalyticsReports")+" - Matomo",u=await V();if(u&&o&&i){var m,p,h,g;console.log("i got store ",u,"c ",o,"s ",i,"segment ",n);const e=o,t=i;let a=u.findSubcategory(e,t);a.category||(await u.fetchMenuItems(),a=u.findSubcategory(e,t)),console.log("found ",a,"categryId ",e,"subcategoryId ",t,"store ",u),r=null!==(m=null===(p=a)||void 0===p||null===(p=p.category)||void 0===p?void 0:p.name)&&void 0!==m?m:"",s=null!==(h=null===(g=a)||void 0===g||null===(g=g.subcategory)||void 0===g?void 0:g.name)&&void 0!==h?h:"",r===s&&(s=""),r=T.htmlEntities(r),s=T.htmlEntities(s);const c=r?`${r}  ${s?"> "+s:""}`:"",b=x(n),f=b?""+T.htmlEntities(b):"";document.title=`${D.siteName} - ${l} - ${c} - ${f} - ${d}`}},D.hasUserCapability=function(e){return Array.isArray(D.userCapabilities)&&-1!==D.userCapabilities.indexOf(e)},D.on=function(e,t){function o(e){t(...e.detail)}t.wrapper=o,window.addEventListener(e,o)},D.off=function(e,t){t.wrapper&&window.removeEventListener(e,t.wrapper)},D.postEvent=function(e,...t){const o=new CustomEvent(e,{detail:t});window.dispatchEvent(o)};const B=D;var I=B;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
