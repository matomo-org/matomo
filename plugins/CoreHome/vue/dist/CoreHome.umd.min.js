 ...
 */window.hasBlockedContent=!1},"8bbf":function(t,r){t.exports=e},fae3:function(e,t,r){"use strict";if(r.r(t),r.d(t,"activityIndicatorAdapter",(function(){return B})),r.d(t,"ActivityIndicator",(function(){return V})),r.d(t,"translate",(function(){return j})),r.d(t,"alertAdapter",(function(){return K})),r.d(t,"AjaxHelper",(function(){return F})),r.d(t,"MatomoUrl",(function(){return o})),r.d(t,"Matomo",(function(){return D})),r.d(t,"Periods",(function(){return d})),r.d(t,"Day",(function(){return T})),r.d(t,"Week",(function(){return x})),r.d(t,"Month",(function(){return O})),r.d(t,"Year",(function(){return R})),r.d(t,"Range",(function(){return M})),r.d(t,"format",(function(){return c})),r.d(t,"getToday",(function(){return g})),r.d(t,"parseDate",(function(){return h})),r.d(t,"todayIsInRange",(function(){return p})),"undefined"!==typeof window){var a=window.document.currentScript,n=a&&a.src.match(/(.+\/)[^/]+\.js(\?.*)?$/);n&&(r.p=n[1])}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function j(e,t=[]){return window._pk_translate(e,t)}function I(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */class T{constructor(e){I(this,"dateInPeriod",void 0),this.dateInPeriod=e}static parse(e){return new T(h(e))}static getDisplayText(){return j("Intl_PeriodDay")}getPrettyString(){return c(this.dateInPeriod)}getDateRange(){return[new Date(this.dateInPeriod.getTime()),new Date(this.dateInPeriod.getTime())]}containsToday(){return p(this.getDateRange())}}function S(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */d.addCustomPeriod("day",T);class x{constructor(e){S(this,"dateInPeriod",void 0),this.dateInPeriod=e}static parse(e){return new x(h(e))}static getDisplayText(){return j("Intl_PeriodWeek")}getPrettyString(){const e=this.getDateRange(),t=c(e[0]),r=c(e[1]);return j("General_DateRangeFromTo",[t,r])}getDateRange(){const e=(this.dateInPeriod.getDay()+6)%7,t=new Date(this.dateInPeriod.getTime());t.setDate(this.dateInPeriod.getDate()-e);const r=new Date(t.getTime());return r.setDate(t.getDate()+6),[t,r]}containsToday(){return p(this.getDateRange())}}function C(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */d.addCustomPeriod("week",x);class O{constructor(e){C(this,"dateInPeriod",void 0),this.dateInPeriod=e}static parse(e){return new O(h(e))}static getDisplayText(){return j("Intl_PeriodMonth")}getPrettyString(){const e=j("Intl_Month_Long_StandAlone_"+(this.dateInPeriod.getMonth()+1));return`${e} ${this.dateInPeriod.getFullYear()}`}getDateRange(){const e=new Date(this.dateInPeriod.getTime());e.setDate(1);const t=new Date(this.dateInPeriod.getTime());return t.setDate(1),t.setMonth(t.getMonth()+1),t.setDate(0),[e,t]}containsToday(){return p(this.getDateRange())}}function A(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */d.addCustomPeriod("month",O);class R{constructor(e){A(this,"dateInPeriod",void 0),this.dateInPeriod=e}static parse(e){return new R(h(e))}static getDisplayText(){return j("Intl_PeriodYear")}getPrettyString(){return this.dateInPeriod.getFullYear().toString()}getDateRange(){const e=new Date(this.dateInPeriod.getTime());e.setMonth(0),e.setDate(1);const t=new Date(this.dateInPeriod.getTime());return t.setMonth(12),t.setDate(0),[e,t]}containsToday(){return p(this.getDateRange())}}function E(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */d.addCustomPeriod("year",R);class M{constructor(e,t,r){E(this,"startDate",void 0),E(this,"endDate",void 0),E(this,"childPeriodType",void 0),this.startDate=e,this.endDate=t,this.childPeriodType=r}static getLastNRange(e,t,r){const a=Math.max(parseInt(t.toString(),10)-1,0);if(Number.isNaN(a))throw new Error("Invalid range strAmount");let n=r?h(r):g(),i=new Date(n.getTime());if("day"===e)i.setDate(i.getDate()-a);else if("week"===e)i.setDate(i.getDate()-7*a);else if("month"===e)i.setDate(1),i.setMonth(i.getMonth()-a);else{if("year"!==e)throw new Error(`Unknown period type '${e}'.`);i.setFullYear(i.getFullYear()-a)}if("day"!==e){const t=d.periods[e].parse(i),r=d.periods[e].parse(n);[i]=t.getDateRange(),[,n]=r.getDateRange()}const o=new Date(1991,7,6);if(i.getTime()-o.getTime()<0)switch(e){case"year":i=new Date(1992,0,1);break;case"month":i=new Date(1991,8,1);break;case"week":i=new Date(1991,8,12);break;case"day":default:i=o;break}return new M(i,n,e)}static parse(e,t="day"){if(/^previous/.test(e)){const r=M.getLastNRange(t,"2").startDate;return M.getLastNRange(t,e.substring(8),r)}if(/^last/.test(e))return M.getLastNRange(t,e.substring(4));const r=decodeURIComponent(e).split(",");return new M(h(r[0]),h(r[1]),t)}static getDisplayText(){return j("General_DateRangeInPeriodList")}getPrettyString(){const e=c(this.startDate),t=c(this.endDate);return j("General_DateRangeFromTo",[e,t])}getDateRange(){return[this.startDate,this.endDate]}containsToday(){return p(this.getDateRange())}}function _(){return{getAllLabels:d.getAllLabels.bind(d),isRecognizedPeriod:d.isRecognizedPeriod.bind(d),get:d.get.bind(d),parse:d.parse.bind(d),parseDate:h,format:c,RangePeriod:M,todayIsInRange:p}}function q(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
