 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */let D;const{piwik:P,broadcast:T,piwikHelper:V}=window;function N(){var e;return null===(e=window.CoreHome)||void 0===e?void 0:e.ReportingMenuStore}function x(){var e;return null===(e=window.CoreHome)||void 0===e?void 0:e.ComparisonsStoreInstance}function B(e){var t;if("string"!==typeof e)return;const o=e.trim(),i=x();if(i){const t=i.getSegmentComparisons();if(!o&&t.length)return t[0].title;const n=t.find(t=>t.params.segment===e);if(n)return n.title}if(!o)return a("SegmentEditor_DefaultAllVisits");const n=document.querySelector(".segmentEditorPanel .segmentationTitle"),r=null===n||void 0===n||null===(t=n.textContent)||void 0===t?void 0:t.trim();return r||a("SegmentEditor_CustomSegment")}P.helper=V,P.broadcast=T,P.updateDateInTitle=function(e,t){if($(".top_controls #periodString").length&&(D=D||document.title,0===D.indexOf(P.siteName))){const o=` - ${c.parse(t,e).getPrettyString()} `;document.title=`${P.siteName}${o}${D.slice(P.siteName.length)}`}},P.updateTitle=async function(e,t,o,i,n){let a,r;const s=N();if(s){if(console.log("storre is ",s),console.log("c is ",o),console.log("s is ",i),s&&o&&i){var l,d;const e=s.activeCategory.value;console.log("active category is ",e);const t=s.activeSubcategory.value;console.log("active subcategory is ",t);let o=s.findSubcategory(e,t);console.log("found is ",o),o.category||(await s.reloadMenuItems(),o=s.findSubcategory(e,t)),a=null===(l=o)||void 0===l||null===(l=l.category)||void 0===l?void 0:l.name,r=null===(d=o)||void 0===d||null===(d=d.subcategory)||void 0===d?void 0:d.name}if(console.log("cat is ",a),console.log("subcat is ",r),D=D||document.title,0===D.indexOf(P.siteName)){const o=` - ${c.parse(t,e).getPrettyString()} `,i=[a,r].filter(e=>!!e).filter((e,t,o)=>o.indexOf(e)===t).map(e=>V.htmlEntities(e)),s=i.length?" - "+i.join(" > "):"",l=B(n),d=l?" - "+V.htmlEntities(l):"";document.title=`${P.siteName}${o}${s}${d}${D.slice(P.siteName.length)}`}}},P.hasUserCapability=function(e){return Array.isArray(P.userCapabilities)&&-1!==P.userCapabilities.indexOf(e)},P.on=function(e,t){function o(e){t(...e.detail)}t.wrapper=o,window.addEventListener(e,o)},P.off=function(e,t){t.wrapper&&window.removeEventListener(e,t.wrapper)},P.postEvent=function(e,...t){const o=new CustomEvent(e,{detail:t});window.dispatchEvent(o)};const I=P;var M=I;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 ...
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
const{$:Z}=window;class ee{constructor(){this.setup()}setup(){Object(E["watch"])(()=>U.parsed.value.popover,()=>this.onPopoverParamChanged()),U.parsed.value.popover&&this.onPopoverParamChangedInitial()}onPopoverParamChangedInitial(){Z(()=>{setTimeout(()=>{this.openOrClose()})})}onPopoverParamChanged(){Z(()=>{this.openOrClose()})}openOrClose(){this.close();const e=U.parsed.value.popover;e?this.open(e):window.broadcast.resetPopoverStack()}close(){window.Piwik_Popover.close()}open(e){let t=decodeURIComponent(e);t=t.replace(/\$/g,"%"),t=decodeURIComponent(t);const o=t.split(":"),i=o[0];o.shift();const n=o.join(":");"undefined"===typeof window.broadcast.popoverHandlers[i]||window.broadcast.isLoginPage()||window.broadcast.popoverHandlers[i](n)}}new ee;function te(e,t,o){const i=new Date;o||(o=432e4),i.setTime(i.getTime()+o),document.cookie=`${e}=${t}; expires=${i.toUTCString()}; path=/`}function oe(e){const t="; "+document.cookie,o=t.split(`; ${e}=`);if(2==o.length){const e=o.pop().split(";").shift();if("undefined"!==typeof e)return e}return null}function ie(e){const t=new Date;t.setTime(t.getTime()+-864e5),document.cookie=`${e}=; expires=${t.toUTCString()}; path=/`}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */const{$:ne}=window;function ae(){let e=!!parseInt(oe("zenMode"),10);const t=ne(".top_controls .icon-arrowup");function o(){e?(ne("body").addClass("zenMode"),t.addClass("icon-arrowdown").removeClass("icon-arrowup"),t.prop("title",a("CoreHome_ExitZenMode"))):(ne("body").removeClass("zenMode"),t.removeClass("icon-arrowdown").addClass("icon-arrowup"),t.prop("title",a("CoreHome_EnterZenMode")))}M.helper.registerShortcut("z",a("CoreHome_ShortcutZenMode"),t=>{t.altKey||(e=!e,te("zenMode",e?"1":"0"),o())}),t.click(()=>{window.Mousetrap.trigger("z")}),o()}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function le(e,t,o){return X.formatNumber(e,t,o)}function ce(e,t,o){return X.formatPercent(e,t,o)}function de(e,t,o,i){return X.formatCurrency(e,t,o,i)}function ue(e,t,o,i){return X.formatEvolution(e,t,o,i)}function me(e,t,o){return X.calculateAndFormatEvolution(e,t,o)}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
