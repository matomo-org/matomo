 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function Mt(e,t,n){var r=t.value.isMouseDown&&t.value.hasScrolled;t.value.isMouseDown=!1,t.value.hasScrolled=!1,r||e.contains(n.target)||t.value&&t.value.blur()}function _t(e,t){t.value.hasScrolled=!0}function Rt(e,t){t.value.isMouseDown=!0,t.value.hasScrolled=!1}function Ft(e,t,n){27===n.which&&setTimeout((function(){t.value.isMouseDown=!1,t.value.hasScrolled=!1,t.value.blur&&t.value.blur()}),0)}var Ht=document.documentElement,Ut={mounted:function(e,t){t.value.isMouseDown=!1,t.value.hasScrolled=!1,t.value.onEscapeHandler=Ft.bind(null,e,t),t.value.onMouseDown=Rt.bind(null,e,t),t.value.onClickOutsideElement=Mt.bind(null,e,t),t.value.onScroll=_t.bind(null,e,t),Ht.addEventListener("keyup",t.value.onEscapeHandler),Ht.addEventListener("mousedown",t.value.onMouseDown),Ht.addEventListener("mouseup",t.value.onClickOutsideElement),Ht.addEventListener("scroll",t.value.onScroll)},unmounted:function(e,t){Ht.removeEventListener("keyup",t.value.onEscapeHandler),Ht.removeEventListener("mousedown",t.value.onMouseDown),Ht.removeEventListener("mouseup",t.value.onClickOutsideElement),Ht.removeEventListener("scroll",t.value.onScroll)}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
