 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */const{$:xt}=window;function Nt(e,t){e.value.focusedElement!==t.target&&(e.value.focusedElement=t.target,xt(t.target).select())}function Bt(e){const t=document.createRange();t.selectNode(e.target);const i=window.getSelection();i&&i.rangeCount>0&&i.removeAllRanges(),i&&i.addRange(t)}function Mt(e){delete e.value.focusedElement}var It={mounted(e,t){const i=e.tagName.toLowerCase();t.value.elementSupportsSelect="textarea"===i,t.value.elementSupportsSelect?(t.value.onFocusHandler=Nt.bind(null,t),t.value.onBlurHandler=Mt.bind(null,t),e.addEventListener("focus",t.value.onFocusHandler),e.addEventListener("blur",t.value.onBlurHandler)):(t.value.onClickHandler=Bt,e.addEventListener("click",t.value.onClickHandler))},unmounted(e,t){t.value.elementSupportsSelect?(e.removeEventListener("focus",t.value.onFocusHandler),e.removeEventListener("blur",t.value.onBlurHandler)):e.removeEventListener("click",t.value.onClickHandler)}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
