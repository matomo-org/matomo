 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */var dt={},pt=120,mt=50,ft=1e3;function ht(e){if(dt[e])return dt[e];if(window[e])return Promise.resolve(window[e]);var t,n,r,i="?module=Proxy&action=getPluginUmdJs&plugin=".concat(e),a=document.createElement("script");a.charset="utf-8",a.timeout=pt,a.src=i;var o=new Error,l=function(i){a.onerror=null,a.onload=null,clearTimeout(r);var l=0;function c(){if(l+=mt,t&&n)if(window[e]&&n)try{n(window[e])}finally{t=void 0,n=void 0}else if(l>ft)try{var r=i&&("load"===i.type?"missing":i.type),a=i&&i.target&&i.target.src;o.message="Loading plugin ".concat(e," on demand failed.\n(").concat(r,": ").concat(a,")"),o.name="PluginOnDemandLoadError",o.type=r,o.request=a,t(o)}finally{t=void 0,n=void 0}else setTimeout(c,mt)}setTimeout(c,mt)};return r=setTimeout((function(){l({type:"timeout",target:a})}),pt),a.onerror=l,a.onload=l,document.head.appendChild(a),new Promise((function(e,r){n=e,t=r}))}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
