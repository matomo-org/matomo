 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function dm(e){um.scrollTo(e,20)}function mm(e){e&&e.preventDefault()}function pm(e,t){var n,r;if(e&&-1===e.indexOf("&")){var o=null;try{o=um("#".concat(e))}catch(a){return}if(null!==(n=o)&&void 0!==n&&n.length)return dm(o),void mm(t);o=um("a[name=".concat(e,"]")),null!==(r=o)&&void 0!==r&&r.length&&(dm(o),mm(t))}}function fm(e,t){return(!e||!e.origin||-1!==t.indexOf(e.origin))&&((!e||!e.pathname||-1!==t.indexOf(e.pathname))&&(!e||!e.search||-1!==t.indexOf(e.search)))}function hm(){if("#/"===window.location.hash.slice(0,2)){var e=window.location.hash.slice(2);pm(e,null)}}function bm(){Object(K["watch"])((function(){return Ce.url.value}),(function(e,t){if(e){var n=e.href.indexOf("#/");if(-1!==n&&(!t||fm(t,e.href))){var r=e.href.slice(n+2);pm(r,null)}}}))}function gm(){Object(K["nextTick"])(hm)}bm(),um(hm);var vm={class:"jsTrackerInstallCheck"},ym={class:"system-success success-message"},Om=Object(K["createElementVNode"])("span",{class:"icon-ok"},null,-1),jm={class:"system-errors test-error"},wm=Object(K["createElementVNode"])("span",{class:"icon-warning"},null,-1);function km(e,t,n,r,o,a){var i=Object(K["resolveComponent"])("ActivityIndicator");return Object(K["openBlock"])(),Object(K["createElementBlock"])(K["Fragment"],null,[Object(K["createElementVNode"])("li",null,Object(K["toDisplayString"])(e.translate("CoreHome_TestInstallationDescription")),1),Object(K["createElementVNode"])("div",vm,[Object(K["withDirectives"])(Object(K["createElementVNode"])("span",{class:"btn testInstallBtn",onClick:t[0]||(t[0]=function(){return e.initiateTrackerTest&&e.initiateTrackerTest.apply(e,arguments)})},Object(K["toDisplayString"])(e.translate("CoreHome_TestInstallationBtnText")),513),[[K["vShow"],!e.isTesting&&!e.isTestSuccess]]),Object(K["createVNode"])(i,{loading:e.isTesting,loadingMessage:e.translate("General_Testing")},null,8,["loading","loadingMessage"]),Object(K["withDirectives"])(Object(K["createElementVNode"])("div",ym,[Om,Object(K["createTextVNode"])(" "+Object(K["toDisplayString"])(e.translate("CoreHome_JsTrackingCodeInstallCheckSuccessMessage")),1)],512),[[K["vShow"],e.isTestSuccess]]),Object(K["withDirectives"])(Object(K["createElementVNode"])("div",jm,[wm,Object(K["createTextVNode"])(" "+Object(K["toDisplayString"])(e.translate("CoreHome_JsTrackingCodeInstallCheckFailureMessage")),1)],512),[[K["vShow"],e.isTestComplete&&!e.isTestSuccess]])])],64)}var Sm=10,Cm=1e3,Em=Object(K["defineComponent"])({components:{ActivityIndicator:xt},data:function(){return{checkNonce:"",isTesting:!1,isTestComplete:!1,isTestSuccess:!1,testTimeoutCount:0}},props:{site:{type:Object,required:!0}},created:function(){this.checkWhetherSuccessWasRecorded()},watch:{site:function(){this.onSiteChange()}},methods:{onSiteChange:function(){this.checkNonce="",this.isTesting=!1,this.isTestComplete=!1,this.isTestSuccess=!1,this.testTimeoutCount=0,this.checkWhetherSuccessWasRecorded()},initiateTrackerTest:function(){var e=this;this.isTesting=!0,this.isTestComplete=!1,this.isTestSuccess=!1,this.testTimeoutCount=0;var t=this.site;Qe.post({module:"API",method:"JsTrackerInstallCheck.initiateJsTrackerInstallTest"},{idSite:t.id}).then((function(t){var n=t&&t.url&&t.nonce;if(n){e.checkNonce=t.nonce;var r=window.open(t.url);e.setCheckInTime(),setTimeout((function(){r&&!r.closed&&(r.close(),e.testTimeoutCount=Sm)}),Sm*Cm)}}))},setCheckInTime:function(){setTimeout(this.checkWhetherSuccessWasRecorded,Cm)},checkWhetherSuccessWasRecorded:function(){var e=this,t=this.site,n=this.checkNonce?"checkForJsTrackerInstallTestSuccess":"getJsTrackerInstallTestResult",r={idSite:t.id,nonce:this.checkNonce};this.checkNonce&&(r.nonce=this.checkNonce),Qe.post({module:"API",method:"JsTrackerInstallCheck.".concat(n)},r).then((function(t){if(e.isTestSuccess=t&&t.isSuccess,e.checkNonce&&!e.isTestSuccess&&e.testTimeoutCount<Sm)return e.testTimeoutCount+=1,void e.setCheckInTime();e.isTestComplete=!!e.checkNonce,e.isTesting=!1}))}}});Em.render=km;var Dm=Em;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
