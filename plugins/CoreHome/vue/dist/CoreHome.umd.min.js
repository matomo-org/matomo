 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function tu(e){return{restrict:"A",scope:{reportTitle:"@",requestParams:"@",reportFormats:"@",apiMethod:"@",maxFilterLimit:"@"},link:function(t,n){var r={instance:null,value:{reportTitle:t.reportTitle,requestParams:t.requestParams,reportFormats:"string"===typeof t.reportFormats?JSON.parse(t.reportFormats):t.reportFormats,apiMethod:t.apiMethod,maxFilterLimit:parseInt(t.maxFilterLimit,10),onClose:function(){e((function(){window.angular.element(document).injector().get("$rootScope").$apply()}),10)}},oldValue:null,modifiers:{},dir:{}};eu.mounted(n[0],r)}}}tu.$inject=["$timeout"],window.angular.module("piwikApp").directive("piwikReportExport",tu);var nu=["src","width","height"];function ru(e,t,n,r,i,o){return Object(a["openBlock"])(),Object(a["createElementBlock"])("img",{loading:"lazy",alt:"",src:e.sparklineUrl,width:e.width,height:e.height},null,8,nu)}function iu(e){return iu="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"===typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},iu(e)}var au=Object(a["defineComponent"])({props:{seriesIndices:Array,params:[Object,String],width:Number,height:Number},data:function(){return{isWidget:!1}},mounted:function(){this.isWidget=!!this.$el.closest("[widgetId]")},computed:{sparklineUrl:function(){var e=this.seriesIndices,t=this.params,n=S.getSparklineColors();e&&(n.lineColor=n.lineColor.filter((function(t,n){return-1!==e.indexOf(n)})));var r=JSON.stringify(n),i={forceView:"1",viewDataTable:"sparkline",widget:this.isWidget?"1":"0",showtitle:"1",colors:r,random:Date.now(),date:this.defaultDate,segment:Ee.parsed.value.segment},a="object"===iu(t)?t:Ee.parse(t.substring(t.indexOf("?")+1)),o=new Ze,l=o.mixinDefaultGetParams(Object.assign(Object.assign({},i),a)),c=Ee.parsed.value.token_auth;return c&&c.length&&S.shouldPropagateTokenAuth&&(l.token_auth=c),"?".concat(Ee.stringify(l))},defaultDate:function(){if("range"===S.period)return"".concat(S.startDateString,",").concat(S.endDateString);var e=H.getLastNRange(S.period,30,S.currentDateString).getDateRange(),t=new Date(S.minDateYear,S.minDateMonth-1,S.minDateDay);e[0]<t&&(e[0]=t);var n=D(e[0]),r=D(e[1]);return"".concat(n,",").concat(r)}}});au.render=ru;var ou=au,lu=(kt({component:ou,scope:{seriesIndices:{angularJsBind:"<"},params:{angularJsBind:"<"}},directiveName:"piwikSparkline",restrict:"E"}),{class:"progressbar"}),cu={class:"progress"},su=Object(a["createElementVNode"])("img",{src:"plugins/Morpheus/images/loading-blue.gif",style:{"margin-right":"3.5px"}},null,-1),uu=["innerHTML"];
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function du(e,t,n,r,i,o){return Object(a["openBlock"])(),Object(a["createElementBlock"])("div",lu,[Object(a["createElementVNode"])("div",cu,[Object(a["createElementVNode"])("div",{class:"determinate",style:Object(a["normalizeStyle"])([{width:"0"},{width:"".concat(e.actualProgress,"%")}])},null,4)]),Object(a["withDirectives"])(Object(a["createElementVNode"])("span",null,[su,Object(a["createElementVNode"])("span",{class:"label",innerHTML:e.$sanitize(e.label)},null,8,uu)],512),[[a["vShow"],!!e.label]])])}var pu=Object(a["defineComponent"])({props:{progress:{type:Number,required:!0},label:String},computed:{actualProgress:function(){return this.progress>100?100:this.progress<0?0:this.progress}}});pu.render=du;var mu=pu,fu=(kt({component:mu,scope:{progress:{angularJsBind:"="},label:{angularJsBind:"="}},directiveName:"piwikProgressbar"}),{mounted:function(e){e.classList.add("piwik-content-intro")},updated:function(e){Object(a["nextTick"])((function(){e.classList.add("piwik-content-intro")}))}});
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function Du(e,t){var n,r=parseInt(t,10),i=parseInt(e,10)-r;return n=0===i||Number.isNaN(i)?0:0===r||Number.isNaN(r)?100:i/r*100,n}function Pu(e){return"".concat(e>0?S.numbers.symbolPlus:"").concat(Math.round(e),"}%")}function Vu(e,t){var n=Du(e,t);return Pu(n)}Eu.$inject=["$parse"],window.angular.module("piwikApp").directive("piwikAjaxForm",Eu);var Nu={ref:"root"};function Tu(e,t,n,r,i,o){return Object(a["openBlock"])(),Object(a["createElementBlock"])("div",Nu,[e.componentWrapper?(Object(a["openBlock"])(),Object(a["createBlock"])(Object(a["resolveDynamicComponent"])(e.componentWrapper),{key:0})):Object(a["createCommentVNode"])("",!0)],512)}var Au=Object(a["defineComponent"])({props:{html:String},mounted:function(){S.helper.compileVueEntryComponents(this.$refs.root)},beforeUnmount:function(){S.helper.destroyVueComponent(this.$refs.root)},computed:{componentWrapper:function(){return this.html?Object(a["markRaw"])({template:this.html}):null}}});Au.render=Tu;var Bu=Au,Iu=kt({component:go,scope:{loading:{vue:"loading",angularJsBind:"<"},loadingMessage:{vue:"loadingMessage",angularJsBind:"<",default:function(){return C("General_LoadingData")}}},$inject:[],directiveName:"piwikActivityIndicator"});
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
