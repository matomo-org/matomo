 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function Vn(e,t){if(t.target){var n=t.target;if(n.parentElement&&n.parentElement.parentElement){var r=n.parentElement.parentElement.getElementsByTagName("pre")[0];if(r){var o=document.createElement("textarea");o.value=r.innerHTML,o.setAttribute("readonly",""),o.style.position="absolute",o.style.left="-9999px",document.body.appendChild(o),o.select(),document.execCommand("copy"),document.body.removeChild(o);var a=n.parentElement.getElementsByTagName("i")[0];a&&(a.classList.remove("copyToClipboardIcon"),a.classList.add("copyToClipboardIconCheck"));var i=n.parentElement.parentElement.getElementsByClassName("copyToClipboardCopiedDiv")[0];i&&(i.style.display="inline-block",setTimeout((function(){i.style.display="none"}),2e3))}}}}function Nn(e,t){if(t.target)if(e.value.transitionOpen){var n=t.target;if(n.parentElement&&n.parentElement.parentElement){var r=n.parentElement.getElementsByTagName("i")[0];r&&(r.classList.remove("copyToClipboardIconCheck"),r.classList.add("copyToClipboardIcon"))}e.value.transitionOpen=!1}else e.value.transitionOpen=!0}var In={mounted:function(e,t){var n=e.tagName.toLowerCase();if("pre"===n){var r=document.createElement("button");r.setAttribute("type","button"),r.className="copyToClipboardButton";var o=document.createElement("i");o.className="copyToClipboardIcon",r.appendChild(o);var i=document.createElement("span");i.className="copyToClipboardSpan",i.innerHTML=a("General_Copy"),r.appendChild(i);var l=document.createElement("div");l.className="copyToClipboardCopiedDiv",l.innerHTML=a("General_CopiedToClipboard");var c=e.parentElement;c&&(c.classList.add("copyToClipboardWrapper"),c.appendChild(r),c.appendChild(l)),t.value.onClickHandler=Vn.bind(null,t),r.addEventListener("click",t.value.onClickHandler),t.value.onTransitionEndHandler=Nn.bind(null,t),r.addEventListener("transitionend",t.value.onTransitionEndHandler)}},unmounted:function(e,t){e.removeEventListener("click",t.value.onClickHandler),e.removeEventListener("transitionend",t.value.onTransitionEndHandler)}},xn={mounted:function(e,t){t.value.activator&&setTimeout((function(){if(!t.value.initialized){t.value.initialized=!0;var n=vt.getRef(t.value.activator,t);if(n){window.$(n).show();var r=n.getAttribute("data-target");window.$("#".concat(r)).sidenav({closeOnClick:!0})}}e.classList.contains("collapsible")&&window.$(e).collapsible()}))}},Bn={key:0,class:"title",tabindex:"6"},An=["href","title"],Ln={class:"iconsBar"},Mn=["href","title"],_n=Object(K["createElementVNode"])("span",{class:"icon-help"},null,-1),Fn=[_n],Rn=["title"],Hn=Object(K["createElementVNode"])("span",{class:"icon-info"},null,-1),Un=[Hn],$n={class:"ratingIcons"},qn={class:"inlineHelp"},Wn=["innerHTML"],zn=["innerHTML"],Gn=["href"];
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
