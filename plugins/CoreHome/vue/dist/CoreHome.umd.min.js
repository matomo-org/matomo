 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function It(e,t){e.value.focusedElement!==t.target&&(e.value.focusedElement=t.target,angular.element(t.target).select())}function xt(e){var t=document.createRange();t.selectNode(e.target);var n=window.getSelection();n&&n.rangeCount>0&&n.removeAllRanges(),n&&n.addRange(t)}function Bt(e){e.value.focusedElement=null}At.$inject=[],angular.module("piwikApp").directive("piwikExpandOnHover",At);var Mt={mounted:function(e,t){var n=e.tagName.toLowerCase();t.value.elementSupportsSelect="textarea"===n,t.value.elementSupportsSelect?(t.value.onFocusHandler=It.bind(null,t),t.value.onBlurHandler=Bt.bind(null,t),e.addEventListener("focus",t.value.onFocusHandler),e.addEventListener("blur",t.value.onBlurHandler)):(t.value.onClickHandler=xt,e.addEventListener("click",t.value.onClickHandler))},unmounted:function(e,t){t.value.elementSupportsSelect?(e.removeEventListener("focus",t.value.onFocusHandler),e.removeEventListener("blur",t.value.onBlurHandler)):e.removeEventListener("click",t.value.onClickHandler)}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function xu(e,t,n,r,o,a){return Object(i["openBlock"])(),Object(i["createElementBlock"])("div",Nu,[Object(i["createElementVNode"])("div",Tu,[Object(i["createElementVNode"])("div",{class:"determinate",style:Object(i["normalizeStyle"])([{width:"0"},{width:"".concat(e.actualProgress,"%")}])},null,4)]),Object(i["withDirectives"])(Object(i["createElementVNode"])("span",null,[Au,Object(i["createElementVNode"])("span",{class:"label",innerHTML:e.$sanitize(e.label)},null,8,Iu)],512),[[i["vShow"],!!e.label]])])}var Bu=Object(i["defineComponent"])({props:{progress:Number,label:String},computed:{actualProgress:function(){return this.progress>100?100:this.progress<0?0:this.progress}}});Bu.render=xu;var Mu=Bu,Lu=(rn({component:Mu,scope:{progress:{angularJsBind:"="},label:{angularJsBind:"="}},directiveName:"piwikProgressbar"}),{mounted:function(e){e.classList.add("piwik-content-intro")}});
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
