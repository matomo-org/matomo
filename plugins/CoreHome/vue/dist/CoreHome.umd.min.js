 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */let D;const{piwik:P,broadcast:T,piwikHelper:V}=window;function N(){var e;return null===(e=window.CoreHome)||void 0===e?void 0:e.ReportingMenuStore}function x(){var e;return null===(e=window.CoreHome)||void 0===e?void 0:e.ComparisonsStoreInstance}function B(e){var t;if("string"!==typeof e)return;const o=e.trim(),i=x();if(i){const t=i.getSegmentComparisons();if(!o&&t.length)return t[0].title;const n=t.find(t=>t.params.segment===e);if(n)return n.title}if(!o)return a("SegmentEditor_DefaultAllVisits");const n=document.querySelector(".segmentEditorPanel .segmentationTitle"),r=null===n||void 0===n||null===(t=n.textContent)||void 0===t?void 0:t.trim();return r||a("SegmentEditor_CustomSegment")}P.helper=V,P.broadcast=T,P.updateDateInTitle=function(e,t){if($(".top_controls #periodString").length&&(D=D||document.title,0===D.indexOf(P.siteName))){const o=` - ${c.parse(t,e).getPrettyString()} `;document.title=`${P.siteName}${o}${D.slice(P.siteName.length)}`}},P.updateTitle=async function(e,t,o,i,n){let a,r;const s=N();if(s&&o&&i){var l,d,u,m;let p=s.findSubcategory(o,i);if(p.category||(await s.reloadMenuItems(),p=s.findSubcategory(o,i)),a=null!==(l=null===(d=p)||void 0===d||null===(d=d.category)||void 0===d?void 0:d.name)&&void 0!==l?l:"",r=null!==(u=null===(m=p)||void 0===m||null===(m=m.subcategory)||void 0===m?void 0:m.name)&&void 0!==u?u:"",console.log("i got catname here",a),console.log("i got subcatname here",r),a===r&&(r=""),a=V.htmlEntities(a),r=V.htmlEntities(r),console.log("updateTitle",a,r),D=D||document.title,0===D.indexOf(P.siteName)){const o=` - ${c.parse(t,e).getPrettyString()} `,i=a?`${a}  ${r?"> "+r:""}`:"",s=B(n),l=s?" - "+V.htmlEntities(s):"";document.title=`${P.siteName}${o}${i}${l}${D.slice(P.siteName.length)}`}}},P.hasUserCapability=function(e){return Array.isArray(P.userCapabilities)&&-1!==P.userCapabilities.indexOf(e)},P.on=function(e,t){function o(e){t(...e.detail)}t.wrapper=o,window.addEventListener(e,o)},P.off=function(e,t){t.wrapper&&window.removeEventListener(e,t.wrapper)},P.postEvent=function(e,...t){const o=new CustomEvent(e,{detail:t});window.dispatchEvent(o)};const I=P;var M=I;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
