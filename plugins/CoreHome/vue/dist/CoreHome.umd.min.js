 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function ae(e){const{component:t,element:r,scope:n,$inject:a,directiveName:i}=e,o={};function s(){return{restrict:"A",scope:o,link:function(e,a){let i="<root-component";Object.entries(n).forEach(([,e])=>{i+=` :${e.vue}="${e.vue}"`}),i+="/>";const o=Object(Z["createApp"])({template:i,data(){const t={};return Object.entries(n).forEach(([r,n])=>{t[n.vue]=e[r]}),t}});o.config.globalProperties.$sanitize=window.vueSanitize,o.component("root-component",t);const s=o.mount(r&&r[0]||a[0]);Object.entries(n).forEach(([t,a])=>{e.$watch(t,e=>{"undefined"!==typeof a.default&&"undefined"===typeof e?s[t]=a.default instanceof Function?a.default(n,r):a.default:s[t]=e})})}}}return Object.entries(n).forEach(([e,t])=>{o[e]=t.angularJsBind}),s.$inject=a||[],angular.module("piwikApp").directive(i,s),s}ne.$inject=["$parse"],angular.module("piwikApp").directive("piwikDialog",ne);const ie={class:"loadingPiwik"},oe=Object(Z["createElementVNode"])("img",{src:"plugins/Morpheus/images/loading-blue.gif",alt:""},null,-1);function se(e,t,r,n,a,i){return Object(Z["withDirectives"])((Object(Z["openBlock"])(),Object(Z["createElementBlock"])("div",ie,[oe,Object(Z["createElementVNode"])("span",null,Object(Z["toDisplayString"])(e.loadingMessage),1)],512)),[[Z["vShow"],e.loading]])}var le=Object(Z["defineComponent"])({props:{loading:{type:Boolean,required:!0,default:!1},loadingMessage:{type:String,required:!1,default:j("General_LoadingData")}}});le.render=se;var ue=le,de=ae({component:ue,scope:{loading:{vue:"loading",angularJsBind:"<"},loadingMessage:{vue:"loadingMessage",angularJsBind:"<",default:()=>j("General_LoadingData")}},$inject:[],directiveName:"piwikActivityIndicator"});
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function ce(e,t,r,n,a,i){return Object(Z["openBlock"])(),Object(Z["createElementBlock"])("div",{class:Object(Z["normalizeClass"])(["alert",{["alert-"+e.severity]:!0}])},[Object(Z["renderSlot"])(e.$slots,"default")],2)}var pe=Object(Z["defineComponent"])({props:{severity:{type:String,required:!0}}});pe.render=ce;var ge=pe;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function he(){return{restrict:"A",transclude:!0,scope:{severity:"@piwikAlert"},template:"<div ng-transclude/>",compile:function(){return{post:function(e,t){const r=t.find("[ng-transclude]"),n=Object(Z["createApp"])({template:'<alert :severity="severity"><div ref="transcludeTarget"/></alert>',data(){return{severity:e.severity}},setup(){const e=Object(Z["ref"])(null);return{transcludeTarget:e}}});n.config.globalProperties.$sanitize=window.vueSanitize,n.component("alert",ge);const a=n.mount(t[0]);e.$watch("severity",e=>{a.severity=e}),$(a.transcludeTarget).append(r)}}}}}he.$inject=[],angular.module("piwikApp").directive("piwikAlert",he)}})}));
