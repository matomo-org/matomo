 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function _e(){return{restrict:"A",link:function(e,t,n){var r={instance:null,value:{blur:function(){setTimeout((function(){e.$apply(n.piwikFocusAnywhereButHere)}),0)}},oldValue:null,modifiers:{},dir:{}};Re.mounted(t[0],r),t.on("$destroy",(function(){return Re.unmounted(t[0],r)}))}}}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function Ue(e,t){t.arg&&setTimeout((function(){e.focus(),t.value.afterFocus&&t.value.afterFocus()}),5)}_e.$inject=[],angular.module("piwikApp.directive").directive("piwikFocusAnywhereButHere",_e);var Je={mounted:function(e,t){Ue(e,t)},updated:function(e,t){Ue(e,t)}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
