 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function bc(e){const t=[];if("INPUT"===e.tagName&&"password"===e.type)t.push(e);else{const o=e.querySelectorAll('input[type="password"]');o.forEach(e=>t.push(e))}return t}function fc(e,t){let o,i=e.value;const n=()=>{e.value="",e.dispatchEvent(new Event("input"))},a=()=>{o&&clearTimeout(o),o=setTimeout(n,1e3*t)},r=()=>a(),s=()=>a();e.addEventListener("input",r),e.addEventListener("change",s),e.dataset.autoClearEnabled="true";const l=setInterval(()=>{e.value!==i&&(i=e.value,a())},300);e.onUmounted={cleanup(){clearTimeout(o),clearInterval(l),e.removeEventListener("input",r),e.removeEventListener("change",s),delete e.dataset.autoClearEnabled}}}hc(),lc(pc);var vc={mounted(e,t){const o=t.value&&t.value.delay||600,i=bc(e);i.forEach(e=>fc(e,o))},unmounted(e){const t=bc(e);t.forEach(e=>{e.onUmounted&&"function"===typeof e.onUmounted.cleanup&&(e.onUmounted.cleanup(),delete e.onUmounted)})}};const Oc={class:"entire-copy-modal"},jc={class:"modal-header"},yc=Object(E["createElementVNode"])("span",{class:"btn-close modal-close"},[Object(E["createElementVNode"])("i",{class:"icon-close"})],-1),wc={key:0,class:"modal-content copy-loading"},kc={class:"Piwik_Popover_Loading"},Cc={class:"Piwik_Popover_Loading_Name"},Sc={class:"modal-sub-header"},Ec=["innerHTML"],Dc={class:"modal-content"},Pc={class:"modal-inputs"},Tc={class:"modal-sub-footer"},Vc=["innerHTML"],Nc=["innerHTML"],Bc={class:"modal-footer"},xc=["disabled"];function Mc(e,t,o,i,n,a){const r=Object(E["resolveComponent"])("Field"),s=Object(E["resolveDirective"])("form");return Object(E["openBlock"])(),Object(E["createElementBlock"])("div",{class:Object(E["normalizeClass"])({modal:!0,"matomo-copy-modal":!0,"slot-configured":e.$slots.default}),ref:"root"},[Object(E["withDirectives"])(Object(E["createElementVNode"])("div",Oc,[Object(E["createElementVNode"])("div",jc,[yc,Object(E["createElementVNode"])("h2",null,Object(E["toDisplayString"])(e.getModalTitle),1)]),e.isLoading?(Object(E["openBlock"])(),Object(E["createElementBlock"])("div",wc,[Object(E["createElementVNode"])("div",kc,[Object(E["createElementVNode"])("div",Cc,[Object(E["createElementVNode"])("h2",null,Object(E["toDisplayString"])(e.translate("General_Loading")),1)])])])):(Object(E["openBlock"])(),Object(E["createElementBlock"])(E["Fragment"],{key:1},[Object(E["createElementVNode"])("div",Sc,[Object(E["createElementVNode"])("p",null,[Object(E["createTextVNode"])(Object(E["toDisplayString"])(e.getCopyDescription)+"  ",1),e.descriptionLearnMoreLink?(Object(E["openBlock"])(),Object(E["createElementBlock"])("span",{key:0,innerHTML:e.$sanitize(e.getLearnMoreLink)},null,8,Ec)):Object(E["createCommentVNode"])("",!0)]),Object(E["createVNode"])(r,{uicontrol:"site",name:"siteSelector",title:e.translate("CoreHome_ChooseWebsite"),modelValue:e.site,"onUpdate:modelValue":t[0]||(t[0]=t=>e.site=t),"ui-control-attributes":{sitesWithAtLeastWriteAccess:!0,siteTypesToExclude:["rollup"]}},null,8,["title","modelValue"])]),Object(E["createElementVNode"])("div",Dc,[Object(E["withDirectives"])((Object(E["openBlock"])(),Object(E["createElementBlock"])("div",Pc,[Object(E["renderSlot"])(e.$slots,"default")])),[[s]])]),Object(E["createElementVNode"])("div",Tc,[e.copyErrors.length>0?(Object(E["openBlock"])(),Object(E["createElementBlock"])("div",{key:0,class:Object(E["normalizeClass"])(e.getAlertClasses)},[Object(E["createElementVNode"])("ul",null,[(Object(E["openBlock"])(!0),Object(E["createElementBlock"])(E["Fragment"],null,Object(E["renderList"])(e.copyErrors,(t,o)=>(Object(E["openBlock"])(),Object(E["createElementBlock"])("li",{key:o,innerHTML:e.$sanitize(t)},null,8,Vc))),128))])],2)):Object(E["createCommentVNode"])("",!0),0===e.copyErrors.length?(Object(E["openBlock"])(),Object(E["createElementBlock"])("p",{key:1,class:"note-text",innerHTML:e.$sanitize(e.getNoteText)},null,8,Nc)):Object(E["createCommentVNode"])("",!0)]),Object(E["createElementVNode"])("div",Bc,[Object(E["createElementVNode"])("button",{class:"btn",disabled:!e.getIsValid||e.hasBeenSubmitted,onClick:t[1]||(t[1]=t=>e.submitCopy())},Object(E["toDisplayString"])(e.translate("General_Copy")),9,xc)])],64))],512),[[E["vShow"],e.isModalVisible]])],2)}function Ic(e,t,o){return t in e?Object.defineProperty(e,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[t]=o,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */class Fc{constructor(e,t,o){Ic(this,"state",Object(E["reactive"])({isModalVisible:!1,isWatchSuppressed:!1,commonFormData:{},entityFormData:{},copyEntityType:"",copyEntityTypeTranslation:""})),this.state.copyEntityType=e,this.state.copyEntityTypeTranslation=t,this.state.commonFormData=null!==o&&void 0!==o?o:{}}showModal(e){this.resetFormData(),Object.entries(null!==e&&void 0!==e?e:{}).forEach(([e,t])=>{this.state.entityFormData[e]=t}),this.state.isModalVisible=!0}hideModal(){this.state.isModalVisible=!1,this.resetFormData()}resetFormData(){this.state.isWatchSuppressed=!0,Object.keys(this.state.entityFormData).forEach(e=>{delete this.state.entityFormData[e]})}disableWatchSuppression(){this.state.isWatchSuppressed=!1}getFormValues(e){const t=Array.isArray(e)?e:[];return e&&!Array.isArray(e)&&t.push(e),Object.assign(Object.assign({module:"CoreHome",action:"copyEntity",idSite:B.idSite||A.parsed.value.idSite,idDestinationSites:t,entityTypeName:this.state.copyEntityType},this.state.commonFormData),this.state.entityFormData)}get getEntityTypeTranslation(){let e="CoreHome_ReportLowercase";return this.state.copyEntityTypeTranslation&&(e=this.state.copyEntityTypeTranslation),r(e)}}function Lc(e,t,o){return Object(E["reactive"])(new Fc(e,t,o))}const _c=be("CorePluginsAdmin","Field"),Ac=be("CorePluginsAdmin","Form"),{$:Rc}=window;var Hc=Object(E["defineComponent"])({directives:{Form:Ac},components:{Field:_c},props:{modalStore:{type:Fc,required:!0}},data(){return{isLoading:!0,isValidated:!1,descriptionLearnMoreLink:"",copyErrors:[],site:null,hasSiteBeenInitialised:!1,hasBeenSubmitted:!1}},emits:["copySuccessful","copyFailed"],watch:{isModalVisible(e){e&&(this.showCopyModal(),this.isLoading=!1)},site(){this.onSiteChange()}},methods:{closeModal(){const e=this.$refs.root,t=Rc(e);t.modal("close")},resetModal(){this.modalStore.hideModal(),this.site=null,this.isLoading=!0,this.isValidated=!1,this.copyErrors=[],this.hasSiteBeenInitialised=!1,this.hasBeenSubmitted=!1},showCopyModal(){const e=this.$refs.root,t=Rc(e);t.modal({dismissible:!0,onCloseEnd:()=>{this.resetModal()}}).modal("open")},submitCopy(){var e;if(this.hasBeenSubmitted=!0,this.modalStore.disableWatchSuppression(),this.validateFormFields(),!this.getIsValid)return void(this.hasBeenSubmitted=!1);const t=new W;t.removeDefaultParameter("date"),t.removeDefaultParameter("period"),t.removeDefaultParameter("segment"),t.withTokenInUrl(),t.addParams(this.modalStore.getFormValues(null===(e=this.site)||void 0===e?void 0:e.id),"POST"),t.setFormat("json"),t.send().then(e=>{e&&e.isCopySuccessful?(this.$emit("copySuccessful",e),this.closeModal()):this.emitFailureAndSetErrorMessage()}).catch(e=>{this.emitFailureAndSetErrorMessage(),console.log("Unexpected server error during request.",e)}).finally(()=>{this.hasBeenSubmitted=!1})},validateFormFields(){var e;if(this.isValidated=!0,this.copyErrors=[],!this.modalStore.state.isModalVisible)return;const t={formValues:this.modalStore.getFormValues(null===(e=this.site)||void 0===e?void 0:e.id),errorMessages:[]};B.postEvent("MatomoCopyModal:validateFormFields",t),t&&Array.isArray(t.errorMessages)&&t.errorMessages.length>0&&(this.copyErrors=t.errorMessages)},onSiteChange(){this.isValidated=!1},emitFailureAndSetErrorMessage(e=null){let t=e;t||(t={isCopySuccessful:!1,errorMessage:a("General_ErrorRequest")}),t.errorMessage&&0!==t.errorMessage.length||(t.errorMessage=a("General_ErrorRequest")),this.copyErrors=[],this.copyErrors.push(t.errorMessage),this.$emit("copyFailed",t)}},mounted(){Object(E["watch"])(()=>this.modalStore.state.entityFormData,()=>{this.modalStore.state.isWatchSuppressed||(this.isValidated=!1)},{deep:!0})},computed:{isModalVisible(){var e;return null!==(e=this.modalStore.state.isModalVisible)&&void 0!==e&&e},getModalTitle(){return a("CoreHome_CopyX",this.modalStore.getEntityTypeTranslation)},getNoteText(){const e=a("CoreHome_CopyModalNote","<strong>","</strong>",this.modalStore.getEntityTypeTranslation);return""+e},getCopyDescription(){return a("CoreHome_CopyXDescription",this.modalStore.getEntityTypeTranslation)},getLearnMoreLink(){if(!this.descriptionLearnMoreLink)return"";const e=ne(this.descriptionLearnMoreLink);return a("CoreHome_LearnMoreFullStop",e,"</a>")},getAlertClasses(){const e=this.copyErrors.length>1?" error-list":"";return"alert alert-danger"+e},getIsValid(){return!this.isValidated||Array.isArray(this.copyErrors)&&0===this.copyErrors.length}}});Hc.render=Mc;var $c=Hc;const Uc=["title","aria-disabled"];function qc(e,t,o,i,n,a){const r=Object(E["resolveDirective"])("tooltips");return Object(E["withDirectives"])((Object(E["openBlock"])(),Object(E["createElementBlock"])("a",{class:Object(E["normalizeClass"])([{"matomo-copy-action":!0,"table-action":!0,"icon-content-copy":!0,"is-disabled":!e.isActionEnabled},e.extraClasses]),title:e.getActionTooltip,"aria-disabled":!e.isActionEnabled,onClick:t[0]||(t[0]=t=>!e.isActionEnabled||e.handleClick())},null,10,Uc)),[[r],[E["vShow"],e.isActionVisible]])}var Wc=Object(E["defineComponent"])({props:{actionFormData:{type:Object,required:!0},modalStore:{type:Fc,required:!0},isActionVisible:{type:Boolean,required:!0,default:!1},isActionEnabled:{type:Boolean,required:!1,default:!1},tooltipTextOverride:{type:String,required:!1,default:""},tooltipTextOverrideDisabled:{type:String,required:!1,default:""},extraClasses:{type:[String,Array,Object],default:""}},directives:{Tooltips:Ze},methods:{handleClick(){this.modalStore.showModal(this.actionFormData)}},computed:{getActionTooltip(){return this.isActionEnabled&&this.tooltipTextOverride.length?r(this.tooltipTextOverride):!this.isActionEnabled&&this.tooltipTextOverrideDisabled.length?r(this.tooltipTextOverrideDisabled):a("CoreHome_CopyX",this.modalStore.getEntityTypeTranslation)}}});Wc.render=qc;var zc=Wc;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
