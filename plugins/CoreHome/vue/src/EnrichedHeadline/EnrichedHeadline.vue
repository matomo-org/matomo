...
export default defineComponent({
  ...
  watch: {
    inlineHelp(newValue: string) {
      ...
      // The owner may swap in a report that has no documentation (a related report, for
      // instance); close the popup instead of leaving it open and blank, since the info icon
      // that would reopen it is hidden when there is no help.
      if (!newValue) {
