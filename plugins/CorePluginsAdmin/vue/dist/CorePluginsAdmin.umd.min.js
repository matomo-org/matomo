 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var Jn=window,Dn=Jn.$;function Hn(e){e.preventDefault(),i["Matomo"].helper.modalConfirm("#installPluginByUpload",{})}function In(e){var t=Dn("[name=pluginZip]"),n=t.val();n&&".zip"===n.slice(-4)?t.data("maxSize")>0&&t[0].files[0].size>1048576*t.data("maxSize")&&(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_FileExceedsUploadLimit"))):(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_NoZipFileSelected")))}var Ln={mounted:function(){setTimeout((function(){Dn(".uploadPlugin").click(Hn),Dn("#uploadPluginForm").submit(In)}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function zn(){return{restrict:"A",link:function(){Ln.mounted()}}}window.angular.module("piwikApp").directive("piwikPluginUpload",zn);
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var Un=window,Kn=Un.$;function _n(e){return e.find(".origin a.active").data("filter-origin")}function Rn(e){return e.find(".status a.active").data("filter-status")}function qn(e,t){var n="#plugins tr";return n+="all"===e?"[data-filter-origin]":"[data-filter-origin=".concat(e,"]"),n+="all"===t?"[data-filter-status]":"[data-filter-status=".concat(t,"]"),Kn(n)}function Wn(e,t,n,o){var r=qn(n,o).length,i=" (".concat(r,")");e.find("".concat(t," .counter")).text(i)}function Gn(e){var t=_n(e),n=Rn(e);Wn(e,'[data-filter-status="all"]',t,"all"),Wn(e,'[data-filter-status="active"]',t,"active"),Wn(e,'[data-filter-status="inactive"]',t,"inactive"),Wn(e,'[data-filter-origin="all"]',"all",n),Wn(e,'[data-filter-origin="core"]',"core",n),Wn(e,'[data-filter-origin="official"]',"official",n),Wn(e,'[data-filter-origin="thirdparty"]',"thirdparty",n)}function Zn(e){var t=_n(e),n=Rn(e),o=qn(t,n);Kn("#plugins tr[data-filter-origin][data-filter-status]").css("display","none"),o.css("display","table-row"),Gn(e)}function Yn(e,t){t.preventDefault(),Kn(t.target).siblings().removeClass("active"),Kn(t.target).addClass("active"),Zn(e)}function Qn(e,t){t.preventDefault(),Kn(t.target).siblings().removeClass("active"),Kn(t.target).addClass("active"),Zn(e)}var Xn={mounted:function(e){setTimeout((function(){Gn(Kn(e)),Kn(e).find(".status").on("click","a",Yn.bind(null,Kn(e))),Kn(e).find(".origin").on("click","a",Qn.bind(null,Kn(e)))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function eo(){return{restrict:"A",link:function(e,t){Xn.mounted(t[0])}}}window.angular.module("piwikApp").directive("piwikPluginFilter",eo);var to={class:"matomo-save-button",style:{display:"inline-block"}},no=["disabled","value"];function oo(e,t,n,o,r,i){var a=Object(l["resolveComponent"])("ActivityIndicator");return Object(l["openBlock"])(),Object(l["createElementBlock"])("div",to,[Object(l["createElementVNode"])("input",{type:"button",onClick:t[0]||(t[0]=function(t){return e.onConfirm(t)}),disabled:e.saving||e.disabled,class:"btn",value:e.value?e.value:e.translate("General_Save")},null,8,no),Object(l["createVNode"])(a,{loading:e.saving},null,8,["loading"])])}var ro=Object(l["defineComponent"])({props:{saving:Boolean,value:String,disabled:Boolean},components:{ActivityIndicator:i["ActivityIndicator"]},emits:["confirm"],methods:{onConfirm:function(e){this.$emit("confirm",e)}}});ro.render=oo;var io=ro,lo=(Object(i["createAngularJsAdapter"])({component:io,scope:{saving:{angularJsBind:"=?"},value:{angularJsBind:"@?"},disabled:{angularJsBind:"=?"},onconfirm:{angularJsBind:"&?",vue:"confirm"}},events:{confirm:function(e,t,n,o,r,i,l){o[0].click(),l()}},replace:!0,directiveName:"piwikSaveButton",$inject:["$timeout"]}),window),ao=lo.$,uo={mounted:function(e){setTimeout((function(){ao(e).find("input[type=text]").keypress((function(t){var n=t.keyCode||t.which;13===n&&ao(e).find(".matomo-save-button input").triggerHandler("click")}))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function co(){return{restrict:"A",link:function(e,t){uo.mounted(t[0])}}}window.angular.module("piwikApp").directive("piwikForm",co)}})}));
