 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var Jn=window,Dn=Jn.$;function Hn(e){e.preventDefault(),i["Matomo"].helper.modalConfirm("#installPluginByUpload",{})}function Ln(e){var t=Dn("[name=pluginZip]"),n=t.val();n&&".zip"===n.slice(-4)?t.data("maxSize")>0&&t[0].files[0].size>1048576*t.data("maxSize")&&(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_FileExceedsUploadLimit"))):(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_NoZipFileSelected")))}var In={mounted:function(){setTimeout((function(){Dn(".uploadPlugin").click(Hn),Dn("#uploadPluginForm").submit(Ln)}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function zn(){return{restrict:"A",link:function(){In.mounted()}}}window.angular.module("piwikApp").directive("piwikPluginUpload",zn);
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
