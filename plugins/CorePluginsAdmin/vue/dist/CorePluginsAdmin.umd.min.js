 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var er=window,tr=er.$;function nr(e){e.preventDefault(),i["Matomo"].helper.modalConfirm("#installPluginByUpload",{})}function rr(e){var t=tr("[name=pluginZip]"),n=t.val();n&&".zip"===n.slice(-4)?t.data("maxSize")>0&&t[0].files[0].size>1048576*t.data("maxSize")&&(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_FileExceedsUploadLimit"))):(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_NoZipFileSelected")))}var or={mounted:function(){setTimeout((function(){tr(".uploadPlugin").click(nr),tr("#uploadPluginForm").submit(rr)}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function ir(){return{restrict:"A",link:function(){or.mounted()}}}window.angular.module("piwikApp").directive("piwikPluginUpload",ir);
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var lr=window,ar=lr.$;function ur(e){return e.find(".origin a.active").data("filter-origin")}function cr(e){return e.find(".status a.active").data("filter-status")}function sr(e,t){var n="#plugins tr";return n+="all"===e?"[data-filter-origin]":"[data-filter-origin=".concat(e,"]"),n+="all"===t?"[data-filter-status]":"[data-filter-status=".concat(t,"]"),ar(n)}function dr(e,t,n,r){var o=sr(n,r).length,i=" (".concat(o,")");e.find("".concat(t," .counter")).text(i)}function mr(e){var t=ur(e),n=cr(e);dr(e,'[data-filter-status="all"]',t,"all"),dr(e,'[data-filter-status="active"]',t,"active"),dr(e,'[data-filter-status="inactive"]',t,"inactive"),dr(e,'[data-filter-origin="all"]',"all",n),dr(e,'[data-filter-origin="core"]',"core",n),dr(e,'[data-filter-origin="official"]',"official",n),dr(e,'[data-filter-origin="thirdparty"]',"thirdparty",n)}function fr(e){var t=ur(e),n=cr(e),r=sr(t,n);ar("#plugins tr[data-filter-origin][data-filter-status]").css("display","none"),r.css("display","table-row"),mr(e)}function pr(e,t){t.preventDefault(),ar(t.target).siblings().removeClass("active"),ar(t.target).addClass("active"),fr(e)}function br(e,t){t.preventDefault(),ar(t.target).siblings().removeClass("active"),ar(t.target).addClass("active"),fr(e)}var vr={mounted:function(e){setTimeout((function(){mr(ar(e)),ar(e).find(".status").on("click","a",pr.bind(null,ar(e))),ar(e).find(".origin").on("click","a",br.bind(null,ar(e)))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function gr(){return{restrict:"A",link:function(e,t){vr.mounted(t[0])}}}window.angular.module("piwikApp").directive("piwikPluginFilter",gr);var hr={class:"matomo-save-button",style:{display:"inline-block"}},Or=["disabled","value"];function yr(e,t,n,r,o,i){var a=Object(l["resolveComponent"])("ActivityIndicator");return Object(l["openBlock"])(),Object(l["createElementBlock"])("div",hr,[Object(l["createElementVNode"])("input",{type:"button",onClick:t[0]||(t[0]=function(t){return e.onConfirm(t)}),disabled:e.saving||e.disabled,class:"btn",value:e.value?e.value:e.translate("General_Save")},null,8,Or),Object(l["createVNode"])(a,{loading:e.saving},null,8,["loading"])])}var jr=Object(l["defineComponent"])({props:{saving:Boolean,value:String,disabled:Boolean},components:{ActivityIndicator:i["ActivityIndicator"]},emits:["confirm"],methods:{onConfirm:function(e){this.$emit("confirm",e)}}});jr.render=yr;var wr=jr,Vr=(Object(i["createAngularJsAdapter"])({component:wr,scope:{saving:{angularJsBind:"=?"},value:{angularJsBind:"@?"},disabled:{angularJsBind:"=?"},onconfirm:{angularJsBind:"&?",vue:"confirm"}},events:{confirm:function(e,t,n,r,o,i,l){r[0].click(),l()}},replace:!0,directiveName:"piwikSaveButton",$inject:["$timeout"]}),window),Cr=Vr.$,Sr={mounted:function(e){setTimeout((function(){Cr(e).find("input[type=text]").keypress((function(t){var n=t.keyCode||t.which;13===n&&Cr(e).find(".matomo-save-button input").triggerHandler("click")}))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function kr(){return{restrict:"A",link:function(e,t){Sr.mounted(t[0])}}}window.angular.module("piwikApp").directive("piwikForm",kr)}})}));
