 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */const{$:Ol}=window;function jl(e){e.preventDefault(),Ci["Matomo"].helper.modalConfirm("#installPluginByUpload",{})}function wl(e){const t=Ol("[name=pluginZip]"),n=t.val();n&&".zip"===n.slice(-4)?t.data("maxSize")>0&&t[0].files[0].size>1048576*t.data("maxSize")&&(e.preventDefault(),alert(Object(Ci["translate"])("CorePluginsAdmin_FileExceedsUploadLimit"))):(e.preventDefault(),alert(Object(Ci["translate"])("CorePluginsAdmin_NoZipFileSelected")))}var Nl={mounted(){setTimeout(()=>{Ol(".uploadPlugin").click(jl),Ol("#uploadPluginForm").submit(wl)})}};const kl={class:"matomo-save-button",style:{display:"inline-block"}},xl=["disabled","value"];function El(e,t,n,r,o,i){const a=Object(Oi["resolveComponent"])("ActivityIndicator");return Object(Oi["openBlock"])(),Object(Oi["createElementBlock"])("div",kl,[Object(Oi["createElementVNode"])("input",{type:"button",onClick:t[0]||(t[0]=t=>e.onConfirm(t)),disabled:e.saving||e.disabled,class:"btn",value:e.value?e.value:e.translate("General_Save")},null,8,xl),Object(Oi["createVNode"])(a,{loading:e.saving},null,8,["loading"])])}var Cl=Object(Oi["defineComponent"])({props:{saving:Boolean,value:String,disabled:Boolean},components:{ActivityIndicator:Ci["ActivityIndicator"]},emits:["confirm"],methods:{onConfirm(e){this.$emit("confirm",e)}}});Cl.render=El;var Sl=Cl;
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
