 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var Qn=window,Xn=Qn.$;function er(e){e.preventDefault(),i["Matomo"].helper.modalConfirm("#installPluginByUpload",{})}function tr(e){var t=Xn("[name=pluginZip]"),n=t.val();n&&".zip"===n.slice(-4)?t.data("maxSize")>0&&t[0].files[0].size>1048576*t.data("maxSize")&&(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_FileExceedsUploadLimit"))):(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_NoZipFileSelected")))}var nr={mounted:function(){setTimeout((function(){Xn(".uploadPlugin").click(er),Xn("#uploadPluginForm").submit(tr)}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function rr(){return{restrict:"A",link:function(){nr.mounted()}}}window.angular.module("piwikApp").directive("piwikPluginUpload",rr);
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var or=window,ir=or.$;function lr(e){return e.find(".origin a.active").data("filter-origin")}function ar(e){return e.find(".status a.active").data("filter-status")}function ur(e,t){var n="#plugins tr";return n+="all"===e?"[data-filter-origin]":"[data-filter-origin=".concat(e,"]"),n+="all"===t?"[data-filter-status]":"[data-filter-status=".concat(t,"]"),ir(n)}function cr(e,t,n,r){var o=ur(n,r).length,i=" (".concat(o,")");e.find("".concat(t," .counter")).text(i)}function sr(e){var t=lr(e),n=ar(e);cr(e,'[data-filter-status="all"]',t,"all"),cr(e,'[data-filter-status="active"]',t,"active"),cr(e,'[data-filter-status="inactive"]',t,"inactive"),cr(e,'[data-filter-origin="all"]',"all",n),cr(e,'[data-filter-origin="core"]',"core",n),cr(e,'[data-filter-origin="official"]',"official",n),cr(e,'[data-filter-origin="thirdparty"]',"thirdparty",n)}function dr(e){var t=lr(e),n=ar(e),r=ur(t,n);ir("#plugins tr[data-filter-origin][data-filter-status]").css("display","none"),r.css("display","table-row"),sr(e)}function mr(e,t){t.preventDefault(),ir(t.target).siblings().removeClass("active"),ir(t.target).addClass("active"),dr(e)}function fr(e,t){t.preventDefault(),ir(t.target).siblings().removeClass("active"),ir(t.target).addClass("active"),dr(e)}var pr={mounted:function(e){setTimeout((function(){sr(ir(e)),ir(e).find(".status").on("click","a",mr.bind(null,ir(e))),ir(e).find(".origin").on("click","a",fr.bind(null,ir(e)))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function br(){return{restrict:"A",link:function(e,t){pr.mounted(t[0])}}}window.angular.module("piwikApp").directive("piwikPluginFilter",br);var vr={class:"matomo-save-button",style:{display:"inline-block"}},hr=["disabled","value"];function gr(e,t,n,r,o,i){var a=Object(l["resolveComponent"])("ActivityIndicator");return Object(l["openBlock"])(),Object(l["createElementBlock"])("div",vr,[Object(l["createElementVNode"])("input",{type:"button",onClick:t[0]||(t[0]=function(t){return e.onConfirm(t)}),disabled:e.saving||e.disabled,class:"btn",value:e.value?e.value:e.translate("General_Save")},null,8,hr),Object(l["createVNode"])(a,{loading:e.saving},null,8,["loading"])])}var Or=Object(l["defineComponent"])({props:{saving:Boolean,value:String,disabled:Boolean},components:{ActivityIndicator:i["ActivityIndicator"]},emits:["confirm"],methods:{onConfirm:function(e){this.$emit("confirm",e)}}});Or.render=gr;var yr=Or,jr=(Object(i["createAngularJsAdapter"])({component:yr,scope:{saving:{angularJsBind:"=?"},value:{angularJsBind:"@?"},disabled:{angularJsBind:"=?"},onconfirm:{angularJsBind:"&?",vue:"confirm"}},events:{confirm:function(e,t,n,r,o,i,l){r[0].click(),l()}},replace:!0,directiveName:"piwikSaveButton",$inject:["$timeout"]}),window),wr=jr.$,Vr={mounted:function(e){setTimeout((function(){wr(e).find("input[type=text]").keypress((function(t){var n=t.keyCode||t.which;13===n&&wr(e).find(".matomo-save-button input").triggerHandler("click")}))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function Cr(){return{restrict:"A",link:function(e,t){Vr.mounted(t[0])}}}window.angular.module("piwikApp").directive("piwikForm",Cr)}})}));
