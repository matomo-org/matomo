 ...
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function Qn(){return{restrict:"A",link:function(){Zn.mounted()}}}Qn.$inject=[],angular.module("piwikApp").directive("piwikPluginUpload",Qn);var Xn={style:{display:"inline-block"}},er=["disabled","value"];function tr(e,t,n,r,o,i){var a=Object(l["resolveComponent"])("ActivityIndicator");return Object(l["openBlock"])(),Object(l["createElementBlock"])("div",Xn,[Object(l["createElementVNode"])("input",{type:"button",onClick:t[0]||(t[0]=function(t){return e.onConfirm()}),disabled:e.saving||e.disabled,class:"btn",value:e.value?e.value:e.translate("General_Save")},null,8,er),Object(l["createVNode"])(a,{loading:e.saving},null,8,["loading"])])}var nr=Object(l["defineComponent"])({props:{saving:Boolean,value:String,disabled:Boolean},components:{ActivityIndicator:i["ActivityIndicator"]},emits:["confirm"],methods:{onConfirm:function(){this.$emit("confirm")}}});nr.render=tr;var rr=nr,or=(Object(i["createAngularJsAdapter"])({component:rr,scope:{saving:{angularJsBind:"=?"},value:{angularJsBind:"@?"},disabled:{angularJsBind:"=?"},onconfirm:{angularJsBind:"&?",vue:"confirm"}},directiveName:"piwikSaveButton"}),window),ir=or.$,lr={mounted:function(e){setTimeout((function(){ir(e).find("input[type=text]").keypress((function(t){var n=t.keyCode||t.which;13===n&&ir(e).find("[piwik-save-button] input").triggerHandler("click")}))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function ar(){return{restrict:"A",link:function(e,t){lr.mounted(t[0])}}}ar.$inject=[],angular.module("piwikApp").directive("piwikForm",ar);
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
