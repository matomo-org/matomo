 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var Rn=window,Wn=Rn.$;function Gn(e){e.preventDefault(),i["Matomo"].helper.modalConfirm("#installPluginByUpload",{})}function Yn(e){var t=Wn("[name=pluginZip]"),n=t.val();n&&".zip"===n.slice(-4)?t.data("maxSize")>0&&t[0].files[0].size>1048576*t.data("maxSize")&&(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_FileExceedsUploadLimit"))):(e.preventDefault(),alert(Object(i["translate"])("CorePluginsAdmin_NoZipFileSelected")))}var Zn={mounted:function(){setTimeout((function(){Wn(".uploadPlugin").click(Gn),Wn("#uploadPluginForm").submit(Yn)}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function Qn(){return{restrict:"A",link:function(){Zn.mounted()}}}Qn.$inject=[],angular.module("piwikApp").directive("piwikPluginUpload",Qn);
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var Xn=window,er=Xn.$;function tr(e){return e.find(".origin a.active").data("filter-origin")}function nr(e){return e.find(".status a.active").data("filter-status")}function rr(e,t){var n="#plugins tr";return n+="all"===e?"[data-filter-origin]":"[data-filter-origin=".concat(e,"]"),n+="all"===t?"[data-filter-status]":"[data-filter-status=".concat(t,"]"),er(n)}function or(e,t,n,r){var o=rr(n,r).length,i=" (".concat(o,")");e.find("".concat(t," .counter")).text(i)}function ir(e){var t=tr(e),n=nr(e);or(e,'[data-filter-status="all"]',t,"all"),or(e,'[data-filter-status="active"]',t,"active"),or(e,'[data-filter-status="inactive"]',t,"inactive"),or(e,'[data-filter-origin="all"]',"all",n),or(e,'[data-filter-origin="core"]',"core",n),or(e,'[data-filter-origin="official"]',"official",n),or(e,'[data-filter-origin="thirdparty"]',"thirdparty",n)}function lr(e){var t=tr(e),n=nr(e),r=rr(t,n);er("#plugins tr[data-filter-origin][data-filter-status]").css("display","none"),r.css("display","table-row"),ir(e)}function ar(e,t){t.preventDefault(),er(t.target).siblings().removeClass("active"),er(t.target).addClass("active"),lr(e)}function ur(e,t){t.preventDefault(),er(t.target).siblings().removeClass("active"),er(t.target).addClass("active"),lr(e)}var cr={mounted:function(e){setTimeout((function(){ir(er(e)),er(e).find(".status").on("click","a",ar.bind(null,er(e))),er(e).find(".origin").on("click","a",ur.bind(null,er(e)))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function sr(){return{restrict:"A",link:function(e,t){cr.mounted(t[0])}}}sr.$inject=[],angular.module("piwikApp").directive("piwikPluginFilter",sr);var dr={class:"matomo-save-button",style:{display:"inline-block"}},mr=["disabled","value"];function fr(e,t,n,r,o,i){var a=Object(l["resolveComponent"])("ActivityIndicator");return Object(l["openBlock"])(),Object(l["createElementBlock"])("div",dr,[Object(l["createElementVNode"])("input",{type:"button",onClick:t[0]||(t[0]=function(t){return e.onConfirm(t)}),disabled:e.saving||e.disabled,class:"btn",value:e.value?e.value:e.translate("General_Save")},null,8,mr),Object(l["createVNode"])(a,{loading:e.saving},null,8,["loading"])])}var pr=Object(l["defineComponent"])({props:{saving:Boolean,value:String,disabled:Boolean},components:{ActivityIndicator:i["ActivityIndicator"]},emits:["confirm"],methods:{onConfirm:function(e){this.$emit("confirm",e)}}});pr.render=fr;var br=pr,vr=(Object(i["createAngularJsAdapter"])({component:br,scope:{saving:{angularJsBind:"=?"},value:{angularJsBind:"@?"},disabled:{angularJsBind:"=?"},onconfirm:{angularJsBind:"&?",vue:"confirm"}},events:{confirm:function(e,t,n,r,o,i,l){r[0].click(),l()}},replace:!0,directiveName:"piwikSaveButton",$inject:["$timeout"]}),window),hr=vr.$,gr={mounted:function(e){setTimeout((function(){hr(e).find("input[type=text]").keypress((function(t){var n=t.keyCode||t.which;13===n&&hr(e).find(".matomo-save-button input").triggerHandler("click")}))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
function Or(){return{restrict:"A",link:function(e,t){gr.mounted(t[0])}}}Or.$inject=[],angular.module("piwikApp").directive("piwikForm",Or)}})}));
