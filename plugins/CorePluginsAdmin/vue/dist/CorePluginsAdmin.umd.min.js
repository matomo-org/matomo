 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var Un=window,Kn=Un.$;function _n(e){return e.find(".origin a.active").data("filter-origin")}function qn(e){return e.find(".status a.active").data("filter-status")}function Rn(e,t){var n="#plugins tr";return n+="all"===e?"[data-filter-origin]":"[data-filter-origin=".concat(e,"]"),n+="all"===t?"[data-filter-status]":"[data-filter-status=".concat(t,"]"),Kn(n)}function Wn(e,t,n,o){var r=Rn(n,o).length,i=" (".concat(r,")");e.find("".concat(t," .counter")).text(i)}function Gn(e){var t=_n(e),n=qn(e);Wn(e,'[data-filter-status="all"]',t,"all"),Wn(e,'[data-filter-status="active"]',t,"active"),Wn(e,'[data-filter-status="inactive"]',t,"inactive"),Wn(e,'[data-filter-origin="all"]',"all",n),Wn(e,'[data-filter-origin="core"]',"core",n),Wn(e,'[data-filter-origin="official"]',"official",n),Wn(e,'[data-filter-origin="thirdparty"]',"thirdparty",n)}function Zn(e){var t=_n(e),n=qn(e),o=Rn(t,n);Kn("#plugins tr[data-filter-origin][data-filter-status]").css("display","none"),o.css("display","table-row"),Gn(e)}function Yn(e,t){t.preventDefault(),Kn(t.target).siblings().removeClass("active"),Kn(t.target).addClass("active"),Zn(e)}function Qn(e,t){t.preventDefault(),Kn(t.target).siblings().removeClass("active"),Kn(t.target).addClass("active"),Zn(e)}var Xn={mounted:function(e){setTimeout((function(){Gn(Kn(e)),Kn(e).find(".status").on("click","a",Yn.bind(null,Kn(e))),Kn(e).find(".origin").on("click","a",Qn.bind(null,Kn(e)))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
