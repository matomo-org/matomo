 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
var qn=window,Gn=qn.$;function Rn(e){return e.find(".origin a.active").data("filter-origin")}function Wn(e){return e.find(".status a.active").data("filter-status")}function Zn(e,t){var n="#plugins tr";return n+="all"===e?"[data-filter-origin]":"[data-filter-origin=".concat(e,"]"),n+="all"===t?"[data-filter-status]":"[data-filter-status=".concat(t,"]"),Gn(n)}function Yn(e,t,n,o){var r=Zn(n,o).length,i=" (".concat(r,")");e.find("".concat(t," .counter")).text(i)}function Qn(e){var t=Rn(e),n=Wn(e);Yn(e,'[data-filter-status="all"]',t,"all"),Yn(e,'[data-filter-status="active"]',t,"active"),Yn(e,'[data-filter-status="inactive"]',t,"inactive"),Yn(e,'[data-filter-origin="all"]',"all",n),Yn(e,'[data-filter-origin="core"]',"core",n),Yn(e,'[data-filter-origin="official"]',"official",n),Yn(e,'[data-filter-origin="thirdparty"]',"thirdparty",n)}function Xn(e){var t=Rn(e),n=Wn(e),o=Zn(t,n);Gn("#plugins tr[data-filter-origin][data-filter-status]").css("display","none"),o.css("display","table-row"),Qn(e)}function eo(e,t){t.preventDefault(),Gn(t.target).siblings().removeClass("active"),Gn(t.target).addClass("active"),Xn(e)}function to(e,t){t.preventDefault(),Gn(t.target).siblings().removeClass("active"),Gn(t.target).addClass("active"),Xn(e)}var no={mounted:function(e){setTimeout((function(){Qn(Gn(e)),Gn(e).find(".status").on("click","a",eo.bind(null,Gn(e))),Gn(e).find(".origin").on("click","a",to.bind(null,Gn(e)))}))}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
