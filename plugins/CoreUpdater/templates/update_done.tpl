...
{else}
	...
	{if count($deactivatedPlugins) > 0 || count($warningMessages) > 0}
		<p class="success">{'CoreUpdater_UpgradeComplete'|translate}</p>
	{/if}
	
	{if count($warningMessages) > 0 || count($deactivatedPlugins) > 0}
		<div class="warning">
