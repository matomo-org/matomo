...
class UpdateTest extends ConsoleCommandTestCase
{
    ...
    {
        print "1 cli mode: " . var_export(Common::$isCliMode, true) . "\n";
        parent::setUpBeforeClass(); // TODO: Change the autogenerated stub
        print "2 cli mode: " . var_export(Common::$isCliMode, true) . "\n";
    }

    public function setUp(): void
    {
        print "3 cli mode: " . var_export(Common::$isCliMode, true) . "\n";
        parent::setUp();
        print "4 cli mode: " . var_export(Common::$isCliMode, true) . "\n";
