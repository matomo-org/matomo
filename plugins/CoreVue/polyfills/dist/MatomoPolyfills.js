(function() {
  ...
  module.exports = function(options, source) {
    ...
    if (GLOBAL) {
      ...
      target = globalThis$4[TARGET] || defineGlobalProperty$1(TARGET, {});
    } else {
  ...
  const require$$2$1 = /* @__PURE__ */ getAugmentedNamespace(_export);
  ...
  const globalThis$3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$3$1 = /* @__PURE__ */ getAugmentedNamespace(globalThis$3);
  var fails;
  var hasRequiredFails;
  function requireFails() {
    if (hasRequiredFails) return fails;
    hasRequiredFails = 1;
    fails = function(exec2) {
      try {
        return !!exec2();
      } catch (error) {
        return true;
  ...
  function requireFunctionCall() {
    ...
    var NATIVE_BIND2 = requireFunctionBindNative();
    var call2 = Function.prototype.call;
    functionCall = NATIVE_BIND2 ? call2.bind(call2) : function() {
  ...
  function requireEnvironmentUserAgent() {
    ...
    var globalThis2 = require$$3$1;
    var navigator = globalThis2.navigator;
    var userAgent2 = navigator && navigator.userAgent;
  ...
  module.exports = function(it) {
    return _typeof(it) == "object" ? it !== null : isCallable$2(it);
  };
  const isObject$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$22 = /* @__PURE__ */ getAugmentedNamespace(isObject$1);
  var anObject$1;
  var hasRequiredAnObject;
  function requireAnObject() {
    if (hasRequiredAnObject) return anObject$1;
    hasRequiredAnObject = 1;
    var isObject2 = require$$22;
    var $String = String;
    var $TypeError2 = TypeError;
    anObject$1 = function(argument) {
      if (isObject2(argument)) return argument;
      throw new $TypeError2($String(argument) + " is not an object");
    };
    return anObject$1;
  }
  var classofRaw;
  ...
  function requireIndexedObject() {
    ...
    var $Object2 = Object;
    var split2 = uncurryThis2("".split);
    indexedObject = fails2(function() {
      return !$Object2("z").propertyIsEnumerable(0);
    }) ? function(it) {
      return classof2(it) === "String" ? split2(it, "") : $Object2(it);
    } : $Object2;
  ...
  module.exports = USE_SYMBOL_AS_UID ? function(it) {
    ...
    return isCallable$1($Symbol) && isPrototypeOf$1($Symbol.prototype, $Object(it));
  };
  const isSymbol = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$11 = /* @__PURE__ */ getAugmentedNamespace(isSymbol);
  ...
  const isCallable = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$17 = /* @__PURE__ */ getAugmentedNamespace(isCallable);
  var tryToString$1;
  ...
  function requireACallable() {
    ...
    var isCallable2 = require$$17;
    var tryToString2 = requireTryToString();
    var $TypeError2 = TypeError;
    aCallable = function(argument) {
      if (isCallable2(argument)) return argument;
      throw new $TypeError2(tryToString2(argument) + " is not a function");
    };
    return aCallable;
  }
  var getMethod;
  ...
  function requireDefineGlobalProperty() {
    ...
    defineGlobalProperty = function(key, value) {
      try {
        defineProperty2(globalThis2, key, {
          value,
          configurable: true,
          writable: true
        });
  ...
  var hasRequiredUid;
  function requireUid() {
    if (hasRequiredUid) return uid$1;
    hasRequiredUid = 1;
    var uncurryThis2 = requireFunctionUncurryThis();
    var id2 = 0;
    var postfix = Math.random();
    var toString2 = uncurryThis2(1.1.toString);
    uid$1 = function(key) {
  ...
  const useSymbolAsUid = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$5 = /* @__PURE__ */ getAugmentedNamespace(useSymbolAsUid);
  var wellKnownSymbol;
  ...
  function requireWellKnownSymbol() {
    ...
    var uid2 = requireUid();
    var NATIVE_SYMBOL2 = requireSymbolConstructorDetection();
    var USE_SYMBOL_AS_UID2 = require$$5;
    var _Symbol = globalThis2.Symbol;
    var WellKnownSymbolsStore = shared2("wks");
    var createWellKnownSymbol = USE_SYMBOL_AS_UID2 ? _Symbol["for"] || _Symbol : _Symbol && _Symbol.withoutSetter || uid2;
    wellKnownSymbol = function(name) {
      if (!hasOwn2(WellKnownSymbolsStore, name)) {
        WellKnownSymbolsStore[name] = NATIVE_SYMBOL2 && hasOwn2(_Symbol, name) ? _Symbol[name] : createWellKnownSymbol("Symbol." + name);
      }
  ...
  function requireClassof() {
    if (hasRequiredClassof) return classof$2;
    ...
    classof$2 = TO_STRING_TAG_SUPPORT ? classofRaw2 : function(it) {
      var O, tag, result;
  ...
  function requireV8PrototypeDefineBug() {
    ...
    var DESCRIPTORS2 = requireDescriptors();
    var fails2 = requireFails();
    v8PrototypeDefineBug = DESCRIPTORS2 && fails2(function() {
  ...
  function requireIe8DomDefine() {
    ...
    ie8DomDefine = !DESCRIPTORS2 && !fails2(function() {
  ...
  function requireObjectDefineProperty() {
    ...
    objectDefineProperty.f = DESCRIPTORS2 ? V8_PROTOTYPE_DEFINE_BUG ? function defineProperty2(O, P, Attributes) {
      anObject2(O);
      P = toPropertyKey2(P);
  ...
  function requireObjectDefineProperties() {
    ...
    objectDefineProperties.f = DESCRIPTORS2 && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O, Properties) {
      anObject2(O);
  ...
  function requireGetBuiltIn() {
    if (hasRequiredGetBuiltIn) return getBuiltIn$1;
  ...
  function requireObjectCreate() {
    ...
    var _NullProtoObject = function NullProtoObject() {
      ...
      while (length--) delete _NullProtoObject[PROTOTYPE][enumBugKeys2[length]];
  ...
  const objectGetOwnPropertyNamesExternal = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$2 = /* @__PURE__ */ getAugmentedNamespace(objectGetOwnPropertyNamesExternal);
  ...
  function requireObjectPropertyIsEnumerable() {
    ...
    var NASHORN_BUG = getOwnPropertyDescriptor2 && !$propertyIsEnumerable.call({
      1: 2
    }, 1);
  ...
  function requireObjectGetOwnPropertyDescriptor() {
    ...
    var IE8_DOM_DEFINE = requireIe8DomDefine();
    var $getOwnPropertyDescriptor = Object.getOwnPropertyDescriptor;
    objectGetOwnPropertyDescriptor.f = DESCRIPTORS2 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor2(O, P) {
  ...
  function requireCreateNonEnumerableProperty() {
    ...
    var definePropertyModule = requireObjectDefineProperty();
    var createPropertyDescriptor2 = requireCreatePropertyDescriptor();
    createNonEnumerableProperty = DESCRIPTORS2 ? function(object, key, value) {
  ...
  function requireMakeBuiltIn() {
    ...
    var getInternalState = InternalStateModule2.get;
    var $String = String;
    var defineProperty2 = Object.defineProperty;
    var stringSlice2 = uncurryThis2("".slice);
    ...
    var makeBuiltIn$1 = makeBuiltIn.exports = function(value, name, options) {
      ...
      if (!hasOwn2(value, "name") || CONFIGURABLE_FUNCTION_NAME && value.name !== name) {
        if (DESCRIPTORS2) defineProperty2(value, "name", {
          value: name,
          configurable: true
        });
      ...
      if (CONFIGURABLE_LENGTH && options && hasOwn2(options, "arity") && value.length !== options.arity) {
        defineProperty2(value, "length", {
          value: options.arity
        });
      }
      try {
        if (options && hasOwn2(options, "constructor") && options.constructor) {
          if (DESCRIPTORS2) defineProperty2(value, "prototype", {
            writable: false
          });
  ...
  function requireWellKnownSymbolDefine() {
    ...
    wellKnownSymbolDefine = function(NAME) {
      var _Symbol = path2.Symbol || (path2.Symbol = {});
      if (!hasOwn2(_Symbol, NAME)) defineProperty2(_Symbol, NAME, {
  ...
  function requireSymbolDefineToPrimitive() {
    ...
    symbolDefineToPrimitive = function() {
      var _Symbol = getBuiltIn2("Symbol");
  ...
  function requireFunctionUncurryThisClause() {
    ...
    functionUncurryThisClause = function(fn) {
      if (classofRaw2(fn) === "Function") return uncurryThis2(fn);
    };
  ...
  function requireFunctionBindContext() {
    ...
    var uncurryThis2 = requireFunctionUncurryThisClause();
    var aCallable2 = requireACallable();
    var NATIVE_BIND2 = requireFunctionBindNative();
    var bind2 = uncurryThis2(uncurryThis2.bind);
    functionBindContext = function(fn, that) {
      aCallable2(fn);
      return that === void 0 ? fn : NATIVE_BIND2 ? bind2(fn, that) : function() {
  ...
  function requireIsConstructor() {
    ...
    var exec2 = uncurryThis2(constructorRegExp.exec);
  ...
  function requireCreateProperty() {
    if (hasRequiredCreateProperty) return createProperty$1;
    hasRequiredCreateProperty = 1;
    var DESCRIPTORS2 = requireDescriptors();
    var definePropertyModule = requireObjectDefineProperty();
    var createPropertyDescriptor2 = requireCreatePropertyDescriptor();
    createProperty$1 = function(object, key, value) {
      if (DESCRIPTORS2) definePropertyModule.f(object, key, createPropertyDescriptor2(0, value));
  ...
  function requireEs_symbol_constructor() {
    ...
    var getOwnPropertyNamesExternal = require$$2;
    ...
    var getInternalState = InternalStateModule2.getterFor(SYMBOL);
    ...
    var $defineProperties = function defineProperties(O, Properties) {
      ...
      $forEach(keys, function(key) {
        if (!DESCRIPTORS2 || call2($propertyIsEnumerable, properties, key)) $defineProperty(O, key, properties[key]);
      });
      return O;
    };
    ...
    var $getOwnPropertyNames2 = function getOwnPropertyNames(O) {
      var names = nativeGetOwnPropertyNames(toIndexedObject2(O));
      var result = [];
      $forEach(names, function(key) {
        if (!hasOwn2(AllSymbols, key) && !hasOwn2(hiddenKeys2, key)) push2(result, key);
      });
      return result;
    };
    ...
    if (!NATIVE_SYMBOL2) {
      $Symbol = function _Symbol() {
        if (isPrototypeOf2(SymbolPrototype, this)) throw new TypeError2("Symbol is not a constructor");
        ...
        var _setter = function setter(value) {
          ...
          if ($this === ObjectPrototype) call2(_setter, ObjectPrototypeSymbols, value);
        ...
        if (DESCRIPTORS2 && USE_SETTER) setSymbolDescriptor(ObjectPrototype, tag, {
          configurable: true,
          set: _setter
        });
      ...
      getOwnPropertyNamesModule2.f = getOwnPropertyNamesExternal.f = $getOwnPropertyNames2;
      ...
      if (DESCRIPTORS2) {
        ...
        if (!IS_PURE) {
          defineBuiltIn2(ObjectPrototype, "propertyIsEnumerable", $propertyIsEnumerable, {
            unsafe: true
          });
        }
      }
  ...
  function requireSymbolRegistryDetection() {
    ...
    var NATIVE_SYMBOL2 = requireSymbolConstructorDetection();
    symbolRegistryDetection = NATIVE_SYMBOL2 && !!Symbol["for"] && !!Symbol.keyFor;
  ...
  module.exports = (typeof Reflect === "undefined" ? "undefined" : _typeof(Reflect)) == "object" && Reflect.apply || (NATIVE_BIND ? call$1.bind(apply$1) : function() {
    return call$1.apply(apply$1, arguments);
  });
  const functionApply = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$1 = /* @__PURE__ */ getAugmentedNamespace(functionApply);
  var isRawJson;
  ...
  function requireArraySlice() {
    if (hasRequiredArraySlice) return arraySlice$1;
    hasRequiredArraySlice = 1;
    var uncurryThis2 = requireFunctionUncurryThis();
    arraySlice$1 = uncurryThis2([].slice);
    return arraySlice$1;
  }
  var parseJsonString;
  ...
  function requireParseJsonString() {
    ...
    var at2 = uncurryThis2("".charAt);
    var slice = uncurryThis2("".slice);
    var exec2 = uncurryThis2(/./.exec);
    var codePoints = {
      '\\"': '"',
      "\\\\": "\\",
      "\\/": "/",
      ...
      while (i < source.length) {
        ...
        if (chr === "\\") {
          ...
          if (hasOwn2(codePoints, twoChars)) {
            ...
            if (!exec2(IS_4_HEX_DIGITS, fourHexDigits)) throw new $SyntaxError2("Bad Unicode escape at: " + i);
            value += fromCharCode($parseInt(fourHexDigits, 16));
            i += 4;
          } else throw new $SyntaxError2('Unknown escape sequence: "' + twoChars + '"');
        } else if (chr === '"') {
          unterminated = false;
          i++;
          break;
        } else {
          if (exec2(IS_C0_CONTROL_CODE, chr)) throw new $SyntaxError2("Bad control character in string literal at: " + i);
          value += chr;
          i++;
        }
      }
      if (unterminated) throw new $SyntaxError2("Unterminated string at: " + i);
      return {
        value,
        end: i
      };
  ...
  function requireEs_json_stringify() {
    ...
    var uid2 = requireUid();
    var NATIVE_SYMBOL2 = requireSymbolConstructorDetection();
    var NATIVE_RAW_JSON2 = requireNativeRawJson();
    var $String = String;
    ...
    var slice = uncurryThis2("".slice);
    var push2 = uncurryThis2([].push);
    var numberToString2 = uncurryThis2(1.1.toString);
    var surrogates = /[\uD800-\uDFFF]/g;
    var leadingSurrogates = /^[\uD800-\uDBFF]$/;
    var trailingSurrogates = /^[\uDC00-\uDFFF]$/;
    var MARK = uid2();
    var MARK_LENGTH = MARK.length;
    var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL2 || fails2(function() {
    ...
    var stringifyWithProperSymbolsConversion = WRONG_SYMBOLS_CONVERSION ? function(it, replacer) {
      ...
      args[1] = function(key, value) {
        if (isCallable2($replacer)) value = call2($replacer, this, $String(key), value);
        if (!isSymbol2(value)) return value;
      };
      return apply2($stringify, null, args);
    } : $stringify;
    var fixIllFormedJSON = function fixIllFormedJSON2(match, offset, string) {
      var prev = charAt2(string, offset - 1);
      var next = charAt2(string, offset + 1);
      if (exec2(leadingSurrogates, match) && !exec2(trailingSurrogates, next) || exec2(trailingSurrogates, match) && !exec2(leadingSurrogates, prev)) {
        return "\\u" + numberToString2(charCodeAt(match, 0), 16);
      }
      return match;
    };
    var getReplacerFunction = function getReplacerFunction2(replacer) {
      ...
      for (var i = 0; i < rawLength; i++) {
        ...
        else if (typeof element == "number" || classof2(element) === "Number" || classof2(element) === "String") push2(keys, toString2(element));
      }
    ...
    if ($stringify) $2({
      ...
      stat: true,
      arity: 3,
      forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE || !NATIVE_RAW_JSON2
    }, {
      stringify: function stringify(text2, replacer, space) {
        ...
        var json = stringifyWithProperSymbolsConversion(text2, function(key, value) {
          ...
          return !NATIVE_RAW_JSON2 && isRawJSON(v) ? MARK + (push2(rawStrings, v.rawJSON) - 1) : v;
        }, space);
        if (typeof json != "string") return json;
        if (ILL_FORMED_UNICODE) json = replace2(json, surrogates, fixIllFormedJSON);
        if (NATIVE_RAW_JSON2) return json;
        var result = "";
  ...
  function requireEs_object_getOwnPropertySymbols() {
    ...
    var getOwnPropertySymbolsModule = requireObjectGetOwnPropertySymbols();
    var toObject2 = requireToObject();
    var FORCED = !NATIVE_SYMBOL2 || fails2(function() {
  ...
  function requireOwnKeys() {
    ...
    ownKeys = getBuiltIn2("Reflect", "ownKeys") || function ownKeys2(it) {
      var keys = getOwnPropertyNamesModule2.f(anObject2(it));
      var getOwnPropertySymbols = getOwnPropertySymbolsModule.f;
  ...
  function requireEs_symbol_description() {
    ...
    if (DESCRIPTORS2 && isCallable2(NativeSymbol) && (!("description" in SymbolPrototype) || // Safari 12 bug
    NativeSymbol().description !== void 0)) {
      ...
      SymbolWrapper["for"] = {
        "for": function _for(key) {
          ...
          var symbol = call2(nativeFor, this, stringKey);
      ...
      var NATIVE_SYMBOL2 = String(NativeSymbol("description detection")) === "Symbol(description detection)";
      var thisSymbolValue = uncurryThis2(SymbolPrototype.valueOf);
      var symbolDescriptiveString = uncurryThis2(SymbolPrototype.toString);
      var regexp = /^Symbol\((.*)\)[^)]+$/;
      var replace2 = uncurryThis2("".replace);
      var stringSlice2 = uncurryThis2("".slice);
      defineBuiltInAccessor2(SymbolPrototype, "description", {
        ...
        get: function description() {
          ...
          var desc = NATIVE_SYMBOL2 ? stringSlice2(string, 7, -1) : replace2(string, regexp, "$1");
  ...
  function requireEs_symbol_asyncDispose() {
    ...
    if (_Symbol) {
      var descriptor = getOwnPropertyDescriptor2(_Symbol, "asyncDispose");
      if (descriptor.enumerable && descriptor.configurable && descriptor.writable) {
        defineProperty2(_Symbol, "asyncDispose", {
  ...
  function requireEs_symbol_dispose() {
    ...
    if (_Symbol) {
      var descriptor = getOwnPropertyDescriptor2(_Symbol, "dispose");
      if (descriptor.enumerable && descriptor.configurable && descriptor.writable) {
        defineProperty2(_Symbol, "dispose", {
          value: descriptor.value,
          enumerable: false,
          configurable: false,
          writable: false
  ...
  function requireAPossiblePrototype() {
    ...
    aPossiblePrototype = function(argument) {
      ...
      throw new $TypeError2("Can't set " + $String(argument) + " as a prototype");
    };
  ...
  function requireWrapErrorConstructorWithCause() {
    ...
    wrapErrorConstructorWithCause = function(FULL_NAME, wrapper, FORCED, IS_AGGREGATE_ERROR) {
      ...
      var WrappedError = wrapper(function(a, b) {
        ...
        if (this && isPrototypeOf2(OriginalErrorPrototype, this)) inheritIfRequired2(result, this, WrappedError);
      ...
      if (ERROR_NAME !== "Error") {
        ...
        else copyConstructorProperties2(WrappedError, BaseError, {
          name: true
        });
      } else if (DESCRIPTORS2 && STACK_TRACE_LIMIT in OriginalError) {
  ...
  function requireEs_error_cause() {
    ...
    var exportGlobalErrorCauseWrapper = function exportGlobalErrorCauseWrapper2(ERROR_NAME, wrapper) {
      var O = {};
    ...
    var exportWebAssemblyErrorCauseWrapper = function exportWebAssemblyErrorCauseWrapper2(ERROR_NAME, wrapper) {
  ...
  var isArrayIteratorMethod$1 = require("../internals/is-array-iterator-method");
  ...
  var iteratorClose$1 = require("../internals/iterator-close");
  ...
  module.exports = function(iterable, unboundFunction, options) {
    ...
    var callFn = function callFn2(value2) {
      if (AS_ENTRIES) {
        anObject(value2);
  ...
  const iterate = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$12 = /* @__PURE__ */ getAugmentedNamespace(iterate);
  ...
  function requireEs_aggregateError_constructor() {
    ...
    else copyConstructorProperties2($AggregateError, $Error, {
      name: true
    });
  ...
  function requireEs_suppressedError_constructor() {
    ...
    var $SuppressedError = function SuppressedError2(error, suppressed, message) {
      var isInstance = isPrototypeOf2(SuppressedErrorPrototype, this);
      var that;
      if (setPrototypeOf2) {
    ...
    else copyConstructorProperties2($SuppressedError, $Error, {
      name: true
    });
  ...
  function requireDoesNotExceedSafeInteger() {
    ...
    doesNotExceedSafeInteger = function(it) {
      if (it > MAX_SAFE_INTEGER) throw new $TypeError2("Maximum allowed index exceeded");
      return it;
    };
  ...
  function requireFlattenIntoArray() {
    ...
    var bind2 = requireFunctionBindContext();
    var createProperty2 = requireCreateProperty();
    var _flattenIntoArray = function flattenIntoArray2(target, original, source, sourceLen, start, depth, mapper, thisArg) {
  ...
  function requireEs_array_flat() {
    ...
    var $2 = require$$2$1;
    var flattenIntoArray2 = requireFlattenIntoArray();
    var toObject2 = requireToObject();
    var lengthOfArrayLike2 = requireLengthOfArrayLike();
    var toIntegerOrInfinity2 = requireToIntegerOrInfinity();
    var arraySpeciesCreate2 = requireArraySpeciesCreate();
    $2({
      ...
      flat: function flat() {
        ...
        var A = arraySpeciesCreate2(O, 0);
        flattenIntoArray2(A, O, O, sourceLen, 0, depthNum);
        return A;
      }
    });
  ...
  function requireEs_array_flatMap() {
    ...
    $2({
      ...
      flatMap: function flatMap(callbackfn) {
        ...
        flattenIntoArray2(A, O, O, sourceLen, 0, 1, callbackfn, arguments.length > 1 ? arguments[1] : void 0);
        return A;
      }
    });
  ...
  function requireGetIterator() {
    ...
    getIterator = function(argument, usingIterator) {
      ...
      throw new $TypeError2(tryToString2(argument) + " is not iterable");
    };
    return getIterator;
  }
  var arrayFrom$1;
  ...
  function requireArrayFrom() {
    if (hasRequiredArrayFrom) return arrayFrom$1;
    ...
    var iteratorClose2 = requireIteratorClose();
    var $Array = Array;
    arrayFrom$1 = function from(arrayLike) {
  ...
  function requireCheckCorrectnessOfIteration() {
    ...
    checkCorrectnessOfIteration = function(exec2, SKIP_CLOSING) {
      try {
  ...
  function requireIteratorDefine() {
    ...
    iteratorDefine = function(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
      ...
      if ((!IS_PURE || FORCED) && IterablePrototype[ITERATOR] !== defaultIterator) {
        defineBuiltIn2(IterablePrototype, ITERATOR, defaultIterator, {
          name: DEFAULT
        });
      }
  ...
  function requireEs_array_iterator() {
    ...
    var setInternalState2 = InternalStateModule2.set;
    var getInternalState = InternalStateModule2.getterFor(ARRAY_ITERATOR);
  ...
  function requireEs_array_push() {
    ...
    var properErrorOnNonWritableLength = function properErrorOnNonWritableLength2() {
      try {
        Object.defineProperty([], "length", {
          writable: false
        }).push();
  ...
  function requireArrayReduce() {
    ...
    var createMethod = function createMethod2(IS_RIGHT) {
      return function(that, callbackfn, argumentsLength, memo) {
        var O = toObject2(that);
        var self2 = IndexedObject(O);
        var length = lengthOfArrayLike2(O);
        aCallable2(callbackfn);
        if (length === 0 && argumentsLength < 2) throw new $TypeError2(REDUCE_EMPTY);
        ...
        if (argumentsLength < 2) while (true) {
          ...
          if (IS_RIGHT ? index < 0 : length <= index) {
            throw new $TypeError2(REDUCE_EMPTY);
          }
        }
  ...
  var userAgentStartsWith = function userAgentStartsWith2(string) {
  ...
  module.exports = (function() {
    ...
    if (globalThis$2.Deno && _typeof(Deno.version) == "object") return "DENO";
    if (classof(globalThis$2.process) === "process") return "NODE";
  ...
  const require$$3 = /* @__PURE__ */ getAugmentedNamespace(environment);
  ...
  function requireArraySort() {
    ...
    var _sort = function sort(array, comparefn) {
      ...
      if (length < 8) {
        ...
        var left = _sort(arraySlice2(array, 0, middle), comparefn);
        var right = _sort(arraySlice2(array, middle), comparefn);
  ...
  function requireEs_array_sort() {
    ...
    var push2 = uncurryThis2(test.push);
    ...
    var getSortCompare = function getSortCompare2(comparefn) {
      return function(x, y) {
  ...
  function requireEs_array_toSorted() {
    ...
    var addToUnscopables2 = requireAddToUnscopables();
    var $Array = Array;
    var sort = uncurryThis2(getBuiltInPrototypeMethod2("Array", "sort"));
    $2({
      target: "Array",
      proto: true
    }, {
  ...
  function requireIeee754() {
    ...
    var log = Math.log;
    var LN2 = Math.LN2;
    var pack = function pack2(number, mantissaLength, bytes) {
    ...
    var unpack = function unpack2(buffer, mantissaLength) {
  ...
  function requireArrayBuffer() {
    ...
    var getInternalArrayBufferState = InternalStateModule2.getterFor(ARRAY_BUFFER);
    ...
    var RangeError2 = globalThis2.RangeError;
    var fill = uncurryThis2(arrayFill2);
    var reverse = uncurryThis2([].reverse);
    ...
    var addGetter = function addGetter2(Constructor, key, getInternalState) {
    ...
    if (!NATIVE_ARRAY_BUFFER) {
      ...
      var $setInt8 = uncurryThis2(DataViewPrototype.setInt8);
  ...
  function requireEs_arrayBuffer_slice() {
    ...
    var nativeArrayBufferSlice = uncurryThis2(ArrayBuffer2.prototype.slice);
    var getUint8 = uncurryThis2(DataViewPrototype.getUint8);
    var setUint8 = uncurryThis2(DataViewPrototype.setUint8);
  ...
  function requireEs_dataView_getFloat16() {
    ...
    var MIN_SUBNORMAL16 = pow2(2, -24);
    var SIGNIFICAND_DENOM16 = 9765625e-10;
    var unpackFloat16 = function unpackFloat162(bytes) {
      var sign = bytes >>> 15;
      var exponent = bytes >>> 10 & EXP_MASK16;
      var significand = bytes & SIGNIFICAND_MASK16;
      if (exponent === EXP_MASK16) return significand === 0 ? sign === 0 ? Infinity : -Infinity : NaN;
      if (exponent === 0) return significand * (sign === 0 ? MIN_SUBNORMAL16 : -MIN_SUBNORMAL16);
      return pow2(2, exponent - 15) * (sign === 0 ? 1 + significand * SIGNIFICAND_DENOM16 : -1 - significand * SIGNIFICAND_DENOM16);
    };
    var getUint16 = uncurryThis2(DataView.prototype.getUint16);
    $2({
      target: "DataView",
      proto: true
    }, {
  ...
  function requireADataView() {
    ...
    aDataView = function(argument) {
      ...
      throw new $TypeError2("Argument is not a DataView");
    };
    return aDataView;
  }
  var mathLog2;
  ...
  function requireEs_dataView_setFloat16() {
    ...
    var packFloat16 = function packFloat162(value) {
      ...
      var exponent = floor2(log2(value));
      if (exponent === -15) {
        return neg << 15 | REC_SIGNIFICAND_DENOM16;
      }
      var significand = roundTiesToEven((value * pow2(2, -exponent) - 1) * REC_SIGNIFICAND_DENOM16);
      if (significand === REC_SIGNIFICAND_DENOM16) {
        return neg << 15 | exponent + 16 << 10;
      }
      return neg << 15 | exponent + 15 << 10 | significand;
    };
    var setUint16 = uncurryThis2(DataView.prototype.setUint16);
    $2({
      target: "DataView",
      proto: true
    }, {
      setFloat16: function setFloat16(byteOffset, value) {
        setUint16(aDataView2(this), toIndex2(byteOffset), packFloat16(+value), arguments.length > 2 ? arguments[2] : false);
      }
    });
  ...
  function requireEs_arrayBuffer_detached() {
    ...
    if (DESCRIPTORS2 && !("detached" in ArrayBufferPrototype)) {
  ...
  function requireArrayBufferNotDetached() {
    ...
    arrayBufferNotDetached = function(it) {
      if (isDetached(it)) throw new $TypeError2("ArrayBuffer is detached");
      return it;
    };
  ...
  function requireStructuredCloneProperTransfer() {
    ...
    structuredCloneProperTransfer = !!structuredClone && !fails2(function() {
      ...
      var clone2 = structuredClone(buffer, {
        transfer: [buffer]
      });
  ...
  function requireDetachTransferable() {
    ...
    if (PROPER_STRUCTURED_CLONE_TRANSFER) {
      detach = function detach2(transferable) {
  ...
  function requireArrayBufferTransfer() {
    ...
    var DataViewPrototype = DataView2.prototype;
    var slice = uncurryThis2(ArrayBufferPrototype.slice);
    var isResizable = uncurryThisAccessor(ArrayBufferPrototype, "resizable", "get");
    var maxByteLength = uncurryThisAccessor(ArrayBufferPrototype, "maxByteLength", "get");
    var getInt8 = uncurryThis2(DataViewPrototype.getInt8);
    var setInt8 = uncurryThis2(DataViewPrototype.setInt8);
    arrayBufferTransfer = (PROPER_STRUCTURED_CLONE_TRANSFER || detachTransferable2) && function(arrayBuffer2, newLength, preserveResizability) {
      ...
      if (byteLength >= newByteLength && (!preserveResizability || fixedLength)) {
        ...
        var options = preserveResizability && !fixedLength && maxByteLength ? {
          maxByteLength: max(newByteLength, maxByteLength(arrayBuffer2))
        } : void 0;
  ...
  function requireDateToPrimitive() {
    ...
    dateToPrimitive = function(hint) {
      ...
      else if (hint !== "number") throw new $TypeError2("Incorrect hint");
  ...
  function requireAddDisposableResource() {
    ...
    var push2 = uncurryThis2([].push);
    var getDisposeMethod = function getDisposeMethod2(V, hint) {
    ...
    var createDisposableResource = function createDisposableResource2(V, hint, method) {
  ...
  function requireEs_disposableStack_constructor() {
    ...
    var setInternalState2 = InternalStateModule2.set;
    var getDisposableStackInternalState = InternalStateModule2.getterFor(DISPOSABLE_STACK);
    var HINT = "sync-dispose";
    var DISPOSED = "disposed";
    var PENDING = "pending";
    var getPendingDisposableStackInternalState = function getPendingDisposableStackInternalState2(stack) {
    ...
    var $DisposableStack = function DisposableStack() {
      setInternalState2(anInstance2(this, DisposableStackPrototype), {
        type: DISPOSABLE_STACK,
        state: PENDING,
        stack: []
      });
      if (!DESCRIPTORS2) this.disposed = false;
    };
    ...
    defineBuiltIns2(DisposableStackPrototype, {
      dispose: function dispose() {
        ...
        if (!DESCRIPTORS2) this.disposed = true;
    ...
    if (DESCRIPTORS2) defineBuiltInAccessor2(DisposableStackPrototype, "disposed", {
      configurable: true,
      get: function disposed() {
        return getDisposableStackInternalState(this).state === DISPOSED;
      }
    });
    defineBuiltIn2(DisposableStackPrototype, DISPOSE, DisposableStackPrototype.dispose, {
      name: "dispose"
    });
    defineBuiltIn2(DisposableStackPrototype, TO_STRING_TAG, DISPOSABLE_STACK, {
      nonWritable: true
    });
    $2({
      global: true,
  ...
  function requireEs_function_hasInstance() {
    ...
    var FunctionPrototype2 = Function.prototype;
    if (!(HAS_INSTANCE in FunctionPrototype2)) {
      definePropertyModule.f(FunctionPrototype2, HAS_INSTANCE, {
        value: makeBuiltIn2(function(O) {
          if (!isCallable2(this) || !isObject2(O)) return false;
          var P = this.prototype;
          return isObject2(P) ? isPrototypeOf2(P, O) : O instanceof this;
        }, HAS_INSTANCE)
      });
    }
  ...
  function requireEs_iterator_constructor() {
    ...
    var defineIteratorPrototypeAccessor = function defineIteratorPrototypeAccessor2(key, value) {
      if (DESCRIPTORS2) {
  ...
  function requireIteratorCreateProxy() {
    ...
    var THROW = "throw";
    var setInternalState2 = InternalStateModule2.set;
    var createIteratorProxyPrototype = function createIteratorProxyPrototype2(IS_ITERATOR) {
      var getInternalState = InternalStateModule2.getterFor(IS_ITERATOR ? WRAP_FOR_VALID_ITERATOR : ITERATOR_HELPER);
      return defineBuiltIns2(create2(IteratorPrototype), {
        ...
        "return": function _return() {
          ...
          if (IS_ITERATOR) {
            ...
            return returnMethod ? call2(returnMethod, iterator) : createIterResultObject2(void 0, true);
          }
    ...
    var IteratorProxy = createIteratorProxy(function() {
      while (true) {
        ...
        if (!iterator) {
          ...
          iterator = this.iterator = anObject2(call2(entry.method, entry.iterable));
          this.next = iterator.next;
        }
        var result = anObject2(call2(this.next, iterator));
        if (result.done) {
          this.iterator = null;
          this.next = null;
          continue;
  ...
  function requireEs_iterator_drop() {
    ...
    var IteratorProxy = createIteratorProxy(function() {
      ...
      while (this.remaining) {
        this.remaining--;
        result = anObject2(call2(next, iterator));
    ...
    $2({
      ...
      drop: function drop(limit) {
        ...
        if (dropWithoutClosingOnEarlyError) return call2(dropWithoutClosingOnEarlyError, this, remaining);
  ...
  function requireEs_iterator_every() {
    ...
    $2({
      ...
      every: function every(predicate) {
        ...
        if (everyWithoutClosingOnEarlyError) return call2(everyWithoutClosingOnEarlyError, this, predicate);
  ...
  function requireEs_iterator_filter() {
    ...
    $2({
      ...
      filter: function filter(predicate) {
        ...
        if (filterWithoutClosingOnEarlyError) return call2(filterWithoutClosingOnEarlyError, this, predicate);
        return new IteratorProxy(getIteratorDirect2(this), {
          predicate
        });
      }
  ...
  function requireEs_iterator_find() {
    ...
    $2({
      ...
      find: function find(predicate) {
        ...
        if (findWithoutClosingOnEarlyError) return call2(findWithoutClosingOnEarlyError, this, predicate);
        var record = getIteratorDirect2(this);
        var counter = 0;
        return iterate2(record, function(value, stop) {
  ...
  function requireGetIteratorFlattenable() {
    ...
    getIteratorFlattenable = function(obj, stringHandling) {
      ...
      return getIteratorDirect2(anObject2(method !== void 0 ? call2(method, obj) : obj));
    };
  ...
  function requireEs_iterator_flatMap() {
    ...
    var IteratorProxy = createIteratorProxy(function() {
      ...
      while (true) {
        if (inner = this.inner) try {
          result = anObject2(call2(inner.next, inner.iterator));
          if (!result.done) return result.value;
          this.inner = null;
        } catch (error) {
          iteratorClose2(iterator, "throw", error);
        }
        result = anObject2(call2(this.next, iterator));
    ...
    $2({
      ...
      flatMap: function flatMap(mapper) {
        ...
        if (flatMapWithoutClosingOnEarlyError) return call2(flatMapWithoutClosingOnEarlyError, this, mapper);
        return new IteratorProxy(getIteratorDirect2(this), {
          mapper,
          inner: null
        });
  ...
  function requireEs_iterator_forEach() {
    ...
    $2({
      ...
      forEach: function forEach(fn) {
        ...
        if (forEachWithoutClosingOnEarlyError) return call2(forEachWithoutClosingOnEarlyError, this, fn);
        var record = getIteratorDirect2(this);
        var counter = 0;
  ...
  function requireEs_iterator_from() {
    ...
    var IteratorProxy = createIteratorProxy(function() {
      return call2(this.next, this.iterator);
    }, true);
    $2({
      target: "Iterator",
      stat: true,
      ...
      from: function from(O) {
        ...
        return isPrototypeOf2(IteratorPrototype, iteratorRecord.iterator) ? iteratorRecord.iterator : new IteratorProxy(iteratorRecord);
      }
    });
  ...
  function requireEs_iterator_map() {
    ...
    $2({
      ...
      map: function map(mapper) {
        ...
        if (mapWithoutClosingOnEarlyError) return call2(mapWithoutClosingOnEarlyError, this, mapper);
        return new IteratorProxy(getIteratorDirect2(this), {
          mapper
        });
      }
  ...
  function requireEs_iterator_reduce() {
    ...
    var reduceWithoutClosingOnEarlyError = !FAILS_ON_INITIAL_UNDEFINED && iteratorHelperWithoutClosingOnEarlyError2("reduce", $TypeError2);
    $2({
      target: "Iterator",
      proto: true,
      real: true,
  ...
  function requireEs_iterator_some() {
    ...
    $2({
      ...
      some: function some(predicate) {
        ...
        if (someWithoutClosingOnEarlyError) return call2(someWithoutClosingOnEarlyError, this, predicate);
        var record = getIteratorDirect2(this);
        var counter = 0;
        return iterate2(record, function(value, stop) {
          if (predicate(value, counter++)) return stop();
  ...
  function requireEs_iterator_take() {
    ...
    $2({
      ...
      take: function take(limit) {
        ...
        if (takeWithoutClosingOnEarlyError) return call2(takeWithoutClosingOnEarlyError, this, remaining);
        return new IteratorProxy(getIteratorDirect2(this), {
          remaining
        });
      }
  ...
  function requireEs_json_parse() {
    ...
    var PRIMITIVE = 0;
    var OBJECT = 1;
    var $parse = function $parse2(source, reviver) {
      ...
      return isCallable2(reviver) ? _internalize({
        "": value
      }, "", reviver, root) : value;
    };
    var _internalize = function internalize(holder, name, reviver, node) {
      var val = holder[name];
      ...
      if (isObject2(val)) {
        ...
        if (nodeIsArray) {
          ...
          for (i = 0; i < len; i++) {
            internalizeProperty(val, i, _internalize(val, "" + i, reviver, i < elementRecordsLen ? nodes[i] : void 0));
          }
        } else {
          ...
          for (i = 0; i < len; i++) {
            P = keys[i];
            internalizeProperty(val, P, _internalize(val, P, reviver, hasOwn2(nodes, P) ? nodes[P] : void 0));
          }
        }
      }
      return call2(reviver, holder, name, val, context);
    };
    var internalizeProperty = function internalizeProperty2(object, key, value) {
      if (DESCRIPTORS2) {
    ...
    var Node = function Node2(value, end, source, nodes) {
      this.value = value;
      this.end = end;
      this.source = source;
      this.nodes = nodes;
    };
    var Context = function Context2(source, index) {
      this.source = source;
      this.index = index;
    };
    Context.prototype = {
      ...
      parse: function parse2() {
        ...
        var chr = at2(source, i);
        if (exec2(IS_NUMBER_START, chr)) return fork.number();
        switch (chr) {
          case "{":
            return fork.object();
          case "[":
      ...
      object: function object() {
        ...
        while (i < source.length) {
          ...
          createProperty2(object2, key, result.value);
      ...
      number: function number() {
        ...
        if (at2(source, i) === "-") i++;
        if (at2(source, i) === "0") i++;
        else if (exec2(IS_NON_ZERO_DIGIT, at2(source, i))) i = this.skip(IS_DIGIT, i + 1);
      ...
      keyword: function keyword(value) {
        var keyword2 = "" + value;
        var index = this.index;
        var endIndex = index + keyword2.length;
        if (slice(this.source, index, endIndex) !== keyword2) throw new SyntaxError2("Failed to parse value at: " + index);
        return this.node(PRIMITIVE, value, index, endIndex);
      },
      skip: function skip(regex, i) {
        var source = this.source;
        for (; i < source.length; i++) if (!exec2(regex, at2(source, i))) break;
        return i;
      },
    ...
    var PROPER_BASE_PARSE = NATIVE_SYMBOL2 && !fails2(function() {
  ...
  var isWhitespace = function isWhitespace2(it) {
    return it === " " || it === "	" || it === "\n" || it === "\r";
  };
  $$2({
    target: "JSON",
    ...
    rawJSON: function rawJSON(text2) {
      var jsonString = toString(text2);
      if (jsonString === "" || isWhitespace(at(jsonString, 0)) || isWhitespace(at(jsonString, jsonString.length - 1))) {
        throw new $SyntaxError(ERROR_MESSAGE);
      }
      var parsed = parse(jsonString);
      if (_typeof(parsed) == "object" && parsed !== null) throw new $SyntaxError(ERROR_MESSAGE);
      var obj = create$1(null);
      setInternalState$1(obj, {
        type: "RawJSON"
      });
  ...
  function requireIsForced() {
    ...
    var isForced2 = function isForced3(feature, detection) {
  ...
  var id = 0;
  var setMetadata = function setMetadata2(it) {
  ...
  var fastKey = function fastKey2(it, create2) {
  ...
  var getWeakData = function getWeakData2(it, create2) {
    if (!hasOwn$1(it, METADATA)) {
  ...
  const internalMetadata = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null
  }, Symbol.toStringTag, { value: "Module" }));
  const require$$4 = /* @__PURE__ */ getAugmentedNamespace(internalMetadata);
  var collection;
  ...
  function requireCollection() {
    ...
    var globalThis2 = require$$3$1;
    var uncurryThis2 = requireFunctionUncurryThis();
    var isForced2 = requireIsForced();
    var defineBuiltIn2 = requireDefineBuiltIn();
    var InternalMetadataModule = require$$4;
    var iterate2 = require$$12;
    var anInstance2 = requireAnInstance();
    var isCallable2 = require$$17;
    var isNullOrUndefined2 = requireIsNullOrUndefined();
    ...
    collection = function(CONSTRUCTOR_NAME, wrapper, common) {
      ...
      var REPLACE = isForced2(CONSTRUCTOR_NAME, !isCallable2(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails2(function() {
      ...
      if (REPLACE) {
        ...
        if (!ACCEPT_ITERABLES) {
          Constructor = wrapper(function(dummy, iterable) {
            ...
            if (!isNullOrUndefined2(iterable)) iterate2(iterable, that[ADDER], {
              that,
              AS_ENTRIES: IS_MAP
            });
            return that;
  ...
  function requireCollectionStrong() {
    ...
    var setSpecies2 = requireSetSpecies();
    var DESCRIPTORS2 = requireDescriptors();
    var fastKey2 = require$$4.fastKey;
    var InternalStateModule2 = requireInternalState();
    var setInternalState2 = InternalStateModule2.set;
    ...
    collectionStrong = {
      getConstructor: function getConstructor(wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
        ...
        var define2 = function define3(that, key, value) {
  ...
  function requireMapHelpers() {
    ...
    mapHelpers = {
      ...
      Map,
      set: uncurryThis2(MapPrototype.set),
      get: uncurryThis2(MapPrototype.get),
      has: uncurryThis2(MapPrototype.has),
      remove: uncurryThis2(MapPrototype["delete"]),
      proto: MapPrototype
    };
    return mapHelpers;
  }
  ...
  function requireEs_math_sumPrecise() {
    ...
    var pow2 = Math.pow;
    var push2 = uncurryThis2([].push);
    var POW_2_1023 = pow2(2, 1023);
    var MAX_SAFE_INTEGER = pow2(2, 53) - 1;
    var MAX_DOUBLE = Number.MAX_VALUE;
    var MAX_ULP = pow2(2, 971);
    var NOT_A_NUMBER = {};
    var MINUS_INFINITY = {};
    var PLUS_INFINITY = {};
    var MINUS_ZERO = {};
    var FINITE = {};
    var twosum = function twosum2(x, y) {
      var hi = x + y;
      var lo = y - (hi - x);
      return {
        hi,
    ...
    $2({
      ...
      sumPrecise: function sumPrecise(items) {
        ...
        iterate2(items, function(n2) {
          ...
          if (typeof n2 != "number") throw new $TypeError2("Value is not a number");
  ...
  function requireEs_number_constructor() {
    ...
    var FORCED = isForced2(NUMBER, !NativeNumber(" 0o1") || !NativeNumber("0b1") || NativeNumber("+0x1"));
    ...
    var copyConstructorProperties2 = function copyConstructorProperties3(target, source) {
      for (var keys = DESCRIPTORS2 ? getOwnPropertyNames(source) : (
        // ES3:
  ...
  function requireStringRepeat() {
    ...
    stringRepeat = function repeat(count) {
      ...
      for (; n > 0; (n = floor2(n / 2)) && (str += str)) if (n % 2) result += str;
      return result;
    };
    return stringRepeat;
  }
  ...
  function requireEs_number_toExponential() {
    ...
    var nativeToExponential = uncurryThis2(1.1.toExponential);
    var repeat = uncurryThis2($repeat);
    var stringSlice2 = uncurryThis2("".slice);
    var POW_10_308 = pow2(10, 308);
    ...
    var throwsOnInfinityFraction = function throwsOnInfinityFraction2() {
    ...
    var properNonFiniteThisCheck = function properNonFiniteThisCheck2() {
      return !fails2(function() {
    ...
    $2({
      ...
      toExponential: function toExponential(fractionDigits) {
        ...
        if (x === 0) {
          ...
          e = floor2(l);
          if (f - e >= 308) {
            xScaled = x * POW_10_308 * pow2(10, f - e - 308);
          } else {
            xScaled = x / pow2(10, e - f);
          }
          n = round(xScaled);
          if (xScaled - n >= 0.5) {
            n += 1;
        ...
        if (f !== 0) {
          m = stringSlice2(m, 0, 1) + "." + stringSlice2(m, 1);
        }
        if (e === 0) {
          c = "+";
          d = "0";
  ...
  function requireObjectAssign() {
    ...
    objectAssign = !$assign || fails2(function() {
      if (DESCRIPTORS2 && $assign({
        b: 1
      }, $assign(defineProperty2({}, "a", {
        enumerable: true,
        get: function get() {
      ...
      while (argumentsLength > index) {
        ...
        while (length > j) {
          key = keys[j++];
          if (!DESCRIPTORS2 || call2(propertyIsEnumerable, S, key)) T[key] = S[key];
        }
      }
      return T;
    } : $assign;
    ...
    if (DESCRIPTORS2) {
      $2({
        ...
        __defineGetter__: function __defineGetter__(P, getter) {
          definePropertyModule.f(toObject2(this), P, {
            get: aCallable2(getter),
            enumerable: true,
            configurable: true
          });
        }
  ...
  function requireEs_object_freeze() {
    ...
    var $2 = require$$2$1;
    var FREEZING2 = requireFreezing();
    var fails2 = requireFails();
    var isObject2 = require$$22;
    var onFreeze2 = require$$4.onFreeze;
    ...
    $2({
      ...
      freeze: function freeze2(it) {
        return $freeze && isObject2(it) ? $freeze(onFreeze2(it)) : it;
      }
    });
  ...
  function requireEs_object_getOwnPropertyDescriptor() {
    ...
    var DESCRIPTORS2 = requireDescriptors();
    var FORCED = !DESCRIPTORS2 || fails2(function() {
  ...
  function requireEs_object_getOwnPropertyNames() {
    ...
    var $2 = require$$2$1;
    var fails2 = requireFails();
    var getOwnPropertyNames = require$$2.f;
    var FAILS_ON_PRIMITIVES = fails2(function() {
    ...
    $2({
      ...
      groupBy: function groupBy(items, callbackfn) {
        ...
        iterate2(items, function(value) {
          ...
          if (key in obj) push2(obj[key], value);
  ...
  function requireObjectIsExtensible() {
    ...
    objectIsExtensible = FAILS_ON_PRIMITIVES || ARRAY_BUFFER_NON_EXTENSIBLE ? function isExtensible2(it) {
  ...
  function requireEs_object_preventExtensions() {
    ...
    $2({
      ...
      preventExtensions: function preventExtensions(it) {
        return $preventExtensions && isObject2(it) ? $preventExtensions(onFreeze2(it)) : it;
      }
    });
  ...
  function requireEs_object_seal() {
    ...
    $2({
      ...
      seal: function seal2(it) {
        return $seal && isObject2(it) ? $seal(onFreeze2(it)) : it;
      }
    });
  ...
  function requireEs_object_toString() {
    ...
    if (!TO_STRING_TAG_SUPPORT) {
      defineBuiltIn2(Object.prototype, "toString", toString2, {
        unsafe: true
      });
    }
  ...
  function requireAConstructor() {
    ...
    aConstructor = function(argument) {
      ...
      throw new $TypeError2(tryToString2(argument) + " is not a constructor");
    };
    return aConstructor;
  }
  ...
  function requireValidateArgumentsLength() {
    ...
    validateArgumentsLength$1 = function(passed, required) {
      if (passed < required) throw new $TypeError2("Not enough arguments");
      return passed;
    };
  ...
  function requireTask() {
    ...
    var run = function run2(id2) {
      if (hasOwn2(queue2, id2)) {
        var fn = queue2[id2];
        delete queue2[id2];
        fn();
      }
    };
    var runner = function runner2(id2) {
      return function() {
        run(id2);
      };
    };
    ...
    var globalPostMessageDefer = function globalPostMessageDefer2(id2) {
    ...
    if (!set || !clear) {
      ...
      if (IS_NODE) {
        defer = function defer2(id2) {
          process.nextTick(runner(id2));
        };
  ...
  function requireSafeGetBuiltIn() {
    ...
    safeGetBuiltIn = function(name) {
      if (!DESCRIPTORS2) return globalThis2[name];
  ...
  function requirePromiseConstructorDetection() {
    ...
    var FORCED_PROMISE_CONSTRUCTOR = isForced2("Promise", function() {
      ...
      if (!V8_VERSION || V8_VERSION < 51 || !/native code/.test(PROMISE_CONSTRUCTOR_SOURCE)) {
        ...
        var FakePromise = function FakePromise2(exec2) {
          exec2(function() {
          }, function() {
          });
        };
  ...
  function requireNewPromiseCapability() {
    ...
    var PromiseCapability = function PromiseCapability2(C) {
      ...
      this.promise = new C(function($$resolve, $$reject) {
        if (resolve !== void 0 || reject !== void 0) throw new $TypeError2("Bad Promise constructor");
        resolve = $$resolve;
        reject = $$reject;
      });
  ...
  function requireEs_promise_constructor() {
      ...
      try {
        ...
        if (then) {
          microtask(function() {
            ...
            try {
              call2(then, value, bind2(_internalResolve, wrapper, state), bind2(internalReject, wrapper, state));
            } catch (error) {
    ...
    if (FORCED_PROMISE_CONSTRUCTOR) {
      PromiseConstructor = function Promise2(executor) {
        ...
        try {
          executor(bind2(_internalResolve, state), bind2(internalReject, state));
        } catch (error) {
      ...
      OwnPromiseCapability = function OwnPromiseCapability2() {
        ...
        this.resolve = bind2(_internalResolve, state);
        this.reject = bind2(internalReject, state);
      };
      newPromiseCapabilityModule.f = newPromiseCapability2 = function newPromiseCapability3(C) {
      ...
      allSettled: function allSettled(iterable) {
        ...
        var result = perform2(function() {
          ...
          iterate2(iterable, function(promise) {
            ...
            var alreadyCalled = false;
            remaining++;
            call2(promiseResolve2, C, promise).then(function(value) {
              if (alreadyCalled) return;
              alreadyCalled = true;
              values[index] = {
                status: "fulfilled",
  ...
  function requireEs_promise_finally() {
    ...
    if (!IS_PURE && isCallable2(NativePromiseConstructor)) {
      ...
      if (NativePromisePrototype["finally"] !== method) {
        defineBuiltIn2(NativePromisePrototype, "finally", method, {
          unsafe: true
        });
      }
    }
  ...
  function requireAsyncFromSyncIterator() {
    ...
    var setInternalState2 = InternalStateModule2.set;
    var getInternalState = InternalStateModule2.getterFor(ASYNC_FROM_SYNC_ITERATOR);
    var asyncFromSyncIteratorContinuation = function asyncFromSyncIteratorContinuation2(result, resolve, reject, syncIterator, closeOnRejection) {
    ...
    var AsyncFromSyncIterator = function AsyncIterator2(iteratorRecord) {
      ...
      setInternalState2(this, iteratorRecord);
    };
    AsyncFromSyncIterator.prototype = defineBuiltIns2(create2(AsyncIteratorPrototype), {
      next: function next() {
        ...
        return new Promise2(function(resolve, reject) {
          var result = anObject2(hasValue ? call2(state.next, state.iterator, value) : call2(state.next, state.iterator));
      ...
      "return": function _return() {
        ...
        return new Promise2(function(resolve, reject) {
          ...
          var result = anObject2(hasValue ? call2($return, iterator, value) : call2($return, iterator));
      ...
      "throw": function _throw() {
        ...
        return new Promise2(function(resolve, reject) {
          ...
          var result = anObject2(hasValue ? call2($throw, iterator, value) : call2($throw, iterator));
  ...
  function requireGetAsyncIterator() {
    ...
    getAsyncIterator = function(it, usingIterator) {
      ...
      return method ? anObject2(call2(method, it)) : new AsyncFromSyncIterator(getIteratorDirect2(getIterator2(it)));
    };
  ...
  function requireAsyncIteratorClose() {
    ...
    asyncIteratorClose = function(iterator, method, argument, reject) {
      try {
        var returnMethod = getMethod2(iterator, "return");
        if (returnMethod) {
          return getBuiltIn2("Promise").resolve(call2(returnMethod, iterator)).then(function(result) {
            try {
  ...
  function requireAsyncIteratorIteration() {
    ...
    var createMethod = function createMethod2(TYPE) {
      ...
      return function(object, fn, target) {
        ...
        var counter = 0;
        return new Promise2(function(resolve, reject) {
          var ifAbruptCloseAsyncIterator = function ifAbruptCloseAsyncIterator2(error) {
          ...
          var _loop = function loop() {
            try {
              ...
              Promise2.resolve(anObject2(call2(next, iterator))).then(function(step) {
                try {
                  if (anObject2(step).done) {
                    ...
                    try {
                      if (MAPPING) {
                        ...
                        var handler = function handler2($result) {
                          if (IS_FOR_EACH) {
                            _loop();
                          } else if (IS_EVERY) {
                            $result ? _loop() : closeAsyncIteration(iterator, resolve, false, reject);
                          } else if (IS_TO_ARRAY) {
                            try {
                            ...
                            $result ? closeAsyncIteration(iterator, resolve, IS_SOME || value, reject) : _loop();
                          }
                        };
  ...
  function requireArrayFromAsync() {
    ...
    var ASYNC_ITERATOR = wellKnownSymbol2("asyncIterator");
    var arrayIterator = uncurryThis2(getBuiltInPrototypeMethod2("Array", "values"));
    var arrayIteratorNext = uncurryThis2(arrayIterator([]).next);
    var safeArrayIterator = function safeArrayIterator2() {
      return new SafeArrayIterator(this);
    };
    var SafeArrayIterator = function SafeArrayIterator2(O) {
  ...
  function requireEs_asyncDisposableStack_constructor() {
    ...
    var setInternalState2 = InternalStateModule2.set;
    var getAsyncDisposableStackInternalState = InternalStateModule2.getterFor(ASYNC_DISPOSABLE_STACK);
    var HINT = "async-dispose";
    var DISPOSED = "disposed";
    var PENDING = "pending";
    var getPendingAsyncDisposableStackInternalState = function getPendingAsyncDisposableStackInternalState2(stack) {
    ...
    var $AsyncDisposableStack = function AsyncDisposableStack() {
      setInternalState2(anInstance2(this, AsyncDisposableStackPrototype), {
    ...
    defineBuiltIns2(AsyncDisposableStackPrototype, {
      disposeAsync: function disposeAsync() {
        ...
        return new Promise2(function(resolve, reject) {
          ...
          internalState2.state = DISPOSED;
          if (!DESCRIPTORS2) asyncDisposableStack.disposed = true;
          var stack = internalState2.stack;
          var i = stack.length;
          var thrown = false;
          var suppressed;
          var handleError = function handleError2(result) {
            if (thrown) {
          ...
          var _loop = function loop() {
            if (i) {
              ...
              stack[i] = null;
              try {
                Promise2.resolve(disposeMethod()).then(_loop, handleError);
              } catch (error) {
                handleError(error);
              }
            } else {
    ...
    if (DESCRIPTORS2) defineBuiltInAccessor2(AsyncDisposableStackPrototype, "disposed", {
      configurable: true,
      get: function disposed() {
        return getAsyncDisposableStackInternalState(this).state === DISPOSED;
      }
    });
    defineBuiltIn2(AsyncDisposableStackPrototype, ASYNC_DISPOSE, AsyncDisposableStackPrototype.disposeAsync, {
      name: "disposeAsync"
    });
    defineBuiltIn2(AsyncDisposableStackPrototype, TO_STRING_TAG, ASYNC_DISPOSABLE_STACK, {
      nonWritable: true
    });
  ...
  function requireEs_asyncIterator_asyncDispose() {
    ...
    var ASYNC_DISPOSE = wellKnownSymbol2("asyncDispose");
    var Promise2 = getBuiltIn2("Promise");
    if (!hasOwn2(AsyncIteratorPrototype, ASYNC_DISPOSE)) {
      defineBuiltIn2(AsyncIteratorPrototype, ASYNC_DISPOSE, function() {
        var O = this;
        return new Promise2(function(resolve, reject) {
          var $return = getMethod2(O, "return");
          if ($return) {
            Promise2.resolve(call2($return, O)).then(function() {
              resolve(void 0);
            }, reject);
          } else resolve(void 0);
        });
  ...
  function requireFunctionBind() {
    ...
    var join2 = uncurryThis2([].join);
    var factories = {};
    var construct2 = function construct3(C, argsLength, args) {
    ...
    functionBind = NATIVE_BIND2 ? $Function.bind : function bind2(that) {
    ...
    $2({
      ...
      construct: function construct2(Target, args) {
        ...
        if (Target === newTarget) {
          ...
          return new (apply2(bind2, Target, $args))();
        }
  ...
  function requireEs_reflect_defineProperty() {
    ...
    $2({
      ...
      defineProperty: function defineProperty2(target, propertyKey, attributes) {
        ...
        var get, set;
        anObject2(attributes);
        if (("get" in attributes || "set" in attributes) && ("get" in attributes && !isCallable2(get = attributes.get) && get !== void 0 || "set" in attributes && !isCallable2(set = attributes.set) && set !== void 0 || "value" in attributes || "writable" in attributes)) throw new $TypeError2("Invalid property descriptor");
        try {
  ...
  function requireEs_reflect_get() {
    ...
    var getPrototypeOf2 = requireObjectGetPrototypeOf();
    var toPropertyKey2 = requireToPropertyKey();
    var _$get = function $get(target, propertyKey, receiver) {
      if (anObject2(target) === receiver) return target[propertyKey];
      var descriptor = getOwnPropertyDescriptorModule.f(target, propertyKey);
      if (descriptor) return isDataDescriptor2(descriptor) ? descriptor.value : descriptor.get === void 0 ? void 0 : call2(descriptor.get, receiver);
      var prototype = getPrototypeOf2(target);
      if (isObject2(prototype)) return _$get(prototype, propertyKey, receiver);
    };
    $2({
      target: "Reflect",
      stat: true
      ...
      get: function get(target, propertyKey) {
        return _$get(anObject2(target), toPropertyKey2(propertyKey), arguments.length < 3 ? target : arguments[2]);
      }
    });
  ...
  function requireEs_reflect_set() {
    ...
    var createPropertyDescriptor2 = requireCreatePropertyDescriptor();
    var toPropertyKey2 = requireToPropertyKey();
    var _$set = function $set(target, propertyKey, V, receiver) {
      ...
      if (!ownDescriptor) {
        if (isObject2(prototype = getPrototypeOf2(target))) {
          return _$set(prototype, propertyKey, V, receiver);
        }
    ...
    $2({
      ...
      set: function set(target, propertyKey, V) {
        return _$set(anObject2(target), toPropertyKey2(propertyKey), V, arguments.length < 4 ? target : arguments[3]);
      }
    });
  ...
  function requireRegexpFlagsDetection() {
    ...
    var FLAGS_GETTER_IS_CORRECT = !fails2(function() {
      ...
      var addGetter = function addGetter2(key2, chr) {
  ...
  function requireRegexpGetFlags() {
    ...
    regexpGetFlags = regExpFlagsDetection.correct ? function(it) {
      ...
      return !regExpFlagsDetection.correct && isPrototypeOf2(RegExpPrototype, it) && !hasOwn2(it, "flags") ? call2(regExpFlagsGetterImplementation, it) : it.flags;
    };
  ...
  function requireEs_regexp_constructor() {
    ...
    var SyntaxError2 = globalThis2.SyntaxError;
    var exec2 = uncurryThis2(RegExpPrototype.exec);
    var charAt2 = uncurryThis2("".charAt);
    var replace2 = uncurryThis2("".replace);
    ...
    var BASE_FORCED = DESCRIPTORS2 && (!CORRECT_NEW || MISSED_STICKY || UNSUPPORTED_DOT_ALL || UNSUPPORTED_NCG || fails2(function() {
      re2[MATCH] = false;
    ...
    var handleDotAll = function handleDotAll2(string) {
      ...
      for (; index2 < length; index2++) {
        chr = charAt2(string, index2);
        if (chr === "\\") {
          result += chr + charAt2(string, ++index2);
          continue;
        }
        if (!brackets && chr === ".") {
          result += "[\\s\\S]";
    ...
    var handleNCG = function handleNCG2(string) {
      ...
      for (; index2 < length; index2++) {
        ...
        if (chr === "\\") {
          ...
          case chr === "(":
            result += chr;
            if (exec2(IS_NCG, stringSlice2(string, index2 + 1))) {
              index2 += 2;
              ncg = true;
              groupid++;
            } else if (charAt2(string, index2 + 1) !== "?") {
              groupid++;
            }
            continue;
          case (chr === ">" && ncg):
      ...
      for (var ni = 0; ni < named.length; ni++) {
        ...
        while (stringIndexOf2(result, backref) > -1) {
          result = replace2(result, backref, numRef);
        }
      }
      return [result, named];
    };
    if (isForced2("RegExp", BASE_FORCED)) {
      var RegExpWrapper = function RegExp2(pattern, flags) {
        var thisIsRegExp = isPrototypeOf2(RegExpPrototype, this);
        ...
        if (patternIsRegExp || isPrototypeOf2(RegExpPrototype, pattern)) {
        ...
        if (UNSUPPORTED_DOT_ALL && "dotAll" in re1) {
          ...
          if (dotAll) flags = replace2(flags, /s/g, "");
        }
        rawFlags = flags;
        if (MISSED_STICKY && "sticky" in re1) {
          sticky = !!flags && stringIndexOf2(flags, "y") > -1;
          if (sticky && UNSUPPORTED_Y) flags = replace2(flags, /y/g, "");
        }
        if (UNSUPPORTED_NCG) {
      ...
      defineBuiltIn2(globalThis2, "RegExp", RegExpWrapper, {
        constructor: true
      });
    }
    setSpecies2("RegExp");
  ...
  function requireAString() {
    ...
    aString = function(argument) {
      ...
      throw new $TypeError2("Argument is not a string");
    };
    return aString;
  }
  var stringPad;
  ...
  function requireStringPad() {
    ...
    var stringSlice2 = uncurryThis2("".slice);
    var ceil = Math.ceil;
    var createMethod = function createMethod2(IS_END) {
      return function($this, maxLength, fillString) {
        ...
        if (stringFiller.length > fillLen) stringFiller = stringSlice2(stringFiller, 0, fillLen);
  ...
  function requireEs_regexp_escape() {
    ...
    var exec2 = uncurryThis2(FIRST_DIGIT_OR_ASCII.exec);
    var ControlEscape = {
      "	": "t",
      "\n": "n",
      "\v": "v",
    ...
    var escapeChar = function escapeChar2(chr) {
    ...
    $2({
      ...
      escape: function escape(S) {
        ...
        for (var i = 0; i < length; i++) {
          var chr = charAt2(S, i);
          if (i === 0 && exec2(FIRST_DIGIT_OR_ASCII, chr)) {
            result[i] = escapeChar(chr);
          } else if (hasOwn2(ControlEscape, chr)) {
            result[i] = "\\" + ControlEscape[chr];
          } else if (exec2(SYNTAX_SOLIDUS, chr)) {
            result[i] = "\\" + chr;
          } else if (exec2(OTHER_PUNCTUATORS_AND_WHITESPACES, chr)) {
            result[i] = escapeChar(chr);
          } else {
  ...
  function requireEs_regexp_dotAll() {
    ...
    var RegExpPrototype = RegExp.prototype;
    var $TypeError2 = TypeError;
    if (DESCRIPTORS2 && UNSUPPORTED_DOT_ALL) {
      defineBuiltInAccessor2(RegExpPrototype, "dotAll", {
        ...
        get: function dotAll() {
          ...
          throw new $TypeError2("Incompatible receiver, RegExp required");
        }
      });
    }
  ...
  function requireRegexpExec() {
    ...
    var setGroups = function setGroups2(re, groups) {
  ...
  function requireEs_regexp_flags() {
    ...
    var regExpFlagsDetection = requireRegexpFlagsDetection();
    var regExpFlagsGetterImplementation = requireRegexpFlags();
    if (DESCRIPTORS2 && !regExpFlagsDetection.correct) {
  ...
  function requireEs_regexp_test() {
    ...
    $2({
      ...
      test: function test(S) {
        ...
        var exec2 = R.exec;
        if (!isCallable2(exec2)) return call2(nativeTest, R, string);
        var result = call2(exec2, R, string);
  ...
  function requireSetHelpers() {
    ...
    setHelpers = {
      ...
      Set,
      add: uncurryThis2(SetPrototype.add),
      has: uncurryThis2(SetPrototype.has),
      remove: uncurryThis2(SetPrototype["delete"]),
      proto: SetPrototype
    };
    return setHelpers;
  }
  ...
  function requireSetIterate() {
    ...
    var forEach = uncurryThis2(SetPrototype.forEach);
    var keys = uncurryThis2(SetPrototype.keys);
  ...
  function requireGetSetRecord() {
    ...
    var $TypeError2 = TypeError;
    var max = Math.max;
    var SetRecord = function SetRecord2(set, intSize) {
      this.set = set;
    ...
    SetRecord.prototype = {
      getIterator: function getIterator2() {
        return getIteratorDirect2(anObject2(call2(this.keys, this.set)));
      },
  ...
  function requireSetMethodAcceptSetLike() {
    ...
    var getBuiltIn2 = requireGetBuiltIn();
    var createSetLike = function createSetLike2(size) {
      return {
        size,
        has: function has() {
          return false;
    ...
    var createSetLikeWithInfinitySize = function createSetLikeWithInfinitySize2(size) {
      return {
        size,
        has: function has() {
          return true;
  ...
  function requireEs_string_codePointAt() {
    ...
    var $2 = require$$2$1;
    var codeAt2 = requireStringMultibyte().codeAt;
    $2({
      target: "String",
      proto: true
    }, {
      codePointAt: function codePointAt(pos) {
        return codeAt2(this, pos);
      }
    });
  ...
  function requireNotARegexp() {
    ...
    notARegexp = function(it) {
      if (isRegExp(it)) {
        throw new $TypeError2("The method doesn't accept regular expressions");
      }
      return it;
    };
    return notARegexp;
  ...
  function requireEs_string_includes() {
    ...
    $2({
      ...
      includes: function includes(searchString) {
        return !!~stringIndexOf2(toString2(requireObjectCoercible2(this)), toString2(notARegExp(searchString)), arguments.length > 1 ? arguments[1] : void 0);
      }
    });
  ...
  function requireEs_string_iterator() {
    ...
    var charAt2 = requireStringMultibyte().charAt;
    var toString2 = requireToString();
    var InternalStateModule2 = requireInternalState();
    var defineIterator = requireIteratorDefine();
    var createIterResultObject2 = requireCreateIterResultObject();
    ...
    var setInternalState2 = InternalStateModule2.set;
    var getInternalState = InternalStateModule2.getterFor(STRING_ITERATOR);
  ...
  function requireFixRegexpWellKnownSymbolLogic() {
    ...
    var SPECIES = wellKnownSymbol2("species");
    var RegExpPrototype = RegExp.prototype;
    fixRegexpWellKnownSymbolLogic = function(KEY, exec2, FORCED, SHAM) {
          ...
          if ($exec === regexpExec2 || $exec === RegExpPrototype.exec) {
            if (DELEGATES_TO_SYMBOL && !forceStringMethod) {
              return {
                ...
                value: call2(nativeRegExpMethod, regexp, str, arg2)
              };
            }
            return {
              done: true,
              value: call2(nativeMethod, str, regexp, arg2)
            };
          }
          return {
            done: false
  ...
  function requireAdvanceStringIndex() {
    ...
    advanceStringIndex = function(S, index, unicode) {
      return index + (unicode ? charAt2(S, index).length || 1 : 1);
    };
  ...
  function requireRegexpExecAbstract() {
    ...
    regexpExecAbstract = function(R, S) {
      ...
      if (isCallable2(exec2)) {
        var result = call2(exec2, R, S);
        if (result !== null) anObject2(result);
        return result;
      }
      if (classof2(R) === "RegExp") return call2(regexpExec2, R, S);
      throw new $TypeError2("RegExp#exec called on incompatible receiver");
    };
  ...
  function requireEs_string_matchAll() {
    ...
    var setInternalState2 = InternalStateModule2.set;
    var getInternalState = InternalStateModule2.getterFor(REGEXP_STRING_ITERATOR);
    var RegExpPrototype = RegExp.prototype;
    var $TypeError2 = TypeError;
    var stringIndexOf2 = uncurryThis2("".indexOf);
    var nativeMatchAll = uncurryThis2("".matchAll);
      ...
      matchAll: function matchAll(regexp) {
        ...
        if (isObject2(regexp)) {
          if (isRegExp(regexp)) {
            ...
            if (!~stringIndexOf2(flags, "g")) throw new $TypeError2("`.matchAll` does not allow non-global regexes");
          }
          if (WORKS_WITH_NON_GLOBAL_REGEX) return nativeMatchAll(O, regexp);
          matcher = getMethod2(regexp, MATCH_ALL);
          if (matcher === void 0 && IS_PURE && classof2(regexp) === "RegExp") matcher = $matchAll;
          if (matcher) return call2(matcher, regexp, O);
        } else if (WORKS_WITH_NON_GLOBAL_REGEX) return nativeMatchAll(O, regexp);
        S = toString2(O);
        rx = new RegExp(regexp, "g");
        return IS_PURE ? call2($matchAll, rx, S) : rx[MATCH_ALL](S);
      }
    });
  ...
  function requireStringPadWebkitBug() {
    ...
    var userAgent2 = requireEnvironmentUserAgent();
    stringPadWebkitBug = /Version\/10(?:\.\d+){1,2}(?: [\w./]+)?(?: Mobile\/\w+)? Safari\//.test(userAgent2);
  ...
  function requireEs_string_raw() {
    ...
    $2({
      ...
      raw: function raw(template) {
        ...
        var i = 0;
        while (true) {
          push2(elements, toString2(rawTemplate[i++]));
          if (i === literalSegments) return join2(elements, "");
          if (i < argumentsLength) push2(elements, toString2(arguments[i]));
        }
      }
    });
  ...
  function requireEs_string_replace() {
    ...
    var stringIndexOf2 = uncurryThis2("".indexOf);
    var stringSlice2 = uncurryThis2("".slice);
    var maybeToString = function maybeToString2(it) {
      ...
      replaceAll: function replaceAll(searchValue, replaceValue) {
        ...
        if (isObject2(searchValue)) {
          ...
          if (IS_REG_EXP) {
            ...
            if (!~indexOf(flags, "g")) throw new $TypeError2("`.replaceAll` does not allow non-global regexes");
          }
        ...
        while (position !== -1) {
          ...
          result += stringSlice2(string, endOfLastMatch, position) + replacement;
          endOfLastMatch = position + searchLength;
          position = position + advanceBy > string.length ? -1 : indexOf(string, searchString, position + advanceBy);
        }
        if (endOfLastMatch < string.length) {
          result += stringSlice2(string, endOfLastMatch);
        }
        return result;
      }
    });
    ...
    fixRegExpWellKnownSymbolLogic("search", function(SEARCH, nativeSearch, maybeCallNative) {
      return [
        ...
        function search(regexp) {
          ...
          return searcher ? call2(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString2(O));
        },
  ...
  function requireEs_string_toWellFormed() {
    ...
    $2({
      ...
      toWellFormed: function toWellFormed() {
        var S = toString2(requireObjectCoercible2(this));
        if (TO_STRING_CONVERSION_BUG) return call2($toWellFormed, S);
        var length = S.length;
        var result = $Array(length);
        for (var i = 0; i < length; i++) {
          var charCode = charCodeAt(S, i);
          if ((charCode & 63488) !== 55296) result[i] = charAt2(S, i);
  ...
  function requireArrayBufferViewCore() {
    ...
    var _getTypedArrayConstructor = function getTypedArrayConstructor(it) {
      ...
      return state && hasOwn2(state, TYPED_ARRAY_CONSTRUCTOR) ? state[TYPED_ARRAY_CONSTRUCTOR] : _getTypedArrayConstructor(proto);
    };
    ...
    var aTypedArrayConstructor = function aTypedArrayConstructor2(C) {
      if (isCallable2(C) && (!setPrototypeOf2 || isPrototypeOf2(TypedArray, C))) return C;
      throw new TypeError2(tryToString2(C) + " is not a typed array constructor");
    };
    var exportTypedArrayMethod = function exportTypedArrayMethod2(KEY, property, forced, options) {
      if (!DESCRIPTORS2) return;
    ...
    if (DESCRIPTORS2 && !hasOwn2(TypedArrayPrototype, TO_STRING_TAG)) {
  ...
  function requireToBigInt() {
    ...
    toBigInt = function(argument) {
      ...
      if (typeof prim == "number") throw new $TypeError2("Can't convert number to bigint");
      return BigInt(prim);
    };
    return toBigInt;
  }
  ...
  function requireTypedArrayConstructor() {
    ...
    var WRONG_LENGTH = "Wrong length";
    var addGetter = function addGetter2(it, key) {
    ...
    var isArrayBuffer = function isArrayBuffer2(it) {
      var klass;
      return isPrototypeOf2(ArrayBufferPrototype, it) || (klass = classof2(it)) === "ArrayBuffer" || klass === "SharedArrayBuffer";
    };
    var isTypedArrayIndex = function isTypedArrayIndex2(target, key) {
        ...
        if (!NATIVE_ARRAY_BUFFER_VIEWS) {
          TypedArrayConstructor = wrapper(function(that, data, offset, $length) {
            ...
            if (!isObject2(data)) {
              ...
              return call2(typedArrayFrom2, TypedArrayConstructor, data);
            }
            setInternalState2(that, {
              buffer,
              byteOffset,
  ...
  function requireEs_typedArray_copyWithin() {
    ...
    var u$ArrayCopyWithin = uncurryThis2($ArrayCopyWithin);
    var aTypedArray = ArrayBufferViewCore.aTypedArray;
    var exportTypedArrayMethod = ArrayBufferViewCore.exportTypedArrayMethod;
  ...
  function requireEs_typedArray_iterator() {
    ...
    var arrayValues = uncurryThis2(ArrayIterators.values);
    var arrayKeys = uncurryThis2(ArrayIterators.keys);
    var arrayEntries = uncurryThis2(ArrayIterators.entries);
    var aTypedArray = ArrayBufferViewCore.aTypedArray;
    var exportTypedArrayMethod = ArrayBufferViewCore.exportTypedArrayMethod;
  ...
  function requireEs_typedArray_set() {
    ...
    exportTypedArrayMethod("set", function set(arrayLike) {
      ...
      if (WORKS_WITH_OBJECTS_AND_GENERIC_ON_TYPED_ARRAYS) return call2($set, this, src, offset);
  ...
  function requireEs_typedArray_sort() {
    ...
    var nativeSort = Uint16Array && uncurryThis2(Uint16Array.prototype.sort);
  ...
  function requireEs_typedArray_toLocaleString() {
    ...
    exportTypedArrayMethod("toLocaleString", function toLocaleString() {
      return apply2($toLocaleString, TO_LOCALE_STRING_BUG ? arraySlice2(aTypedArray(this)) : aTypedArray(this), arraySlice2(arguments));
    }, FORCED);
  ...
  function requireEs_typedArray_toSorted() {
    ...
    var getTypedArrayConstructor = ArrayBufferViewCore.getTypedArrayConstructor;
    var exportTypedArrayMethod = ArrayBufferViewCore.exportTypedArrayMethod;
    var sort = uncurryThis2(ArrayBufferViewCore.TypedArrayPrototype.sort);
  ...
  function requireAnObjectOrUndefined() {
    ...
    anObjectOrUndefined = function(argument) {
      ...
      throw new $TypeError2($String(argument) + " is not an object or undefined");
    };
  ...
  function requireBase64Map() {
    ...
    var inverse = function inverse2(characters) {
      var result = {};
      var index = 0;
  ...
  function requireGetAlphabetOption() {
    ...
    getAlphabetOption = function(options) {
      ...
      throw new $TypeError2("Incorrect `alphabet` option");
    };
  ...
  function requireUint8FromBase64() {
    ...
    var TypeError2 = globalThis2.TypeError;
    var at2 = uncurryThis2("".charAt);
    var skipAsciiWhitespace = function skipAsciiWhitespace2(string, index) {
      var length = string.length;
      for (; index < length; index++) {
        var chr = at2(string, index);
        if (chr !== " " && chr !== "	" && chr !== "\n" && chr !== "\f" && chr !== "\r") break;
      }
      return index;
    };
    var decodeBase64Chunk = function decodeBase64Chunk2(chunk, alphabet, throwOnExtraBits) {
      var chunkLength = chunk.length;
      if (chunkLength < 4) {
        chunk += chunkLength === 2 ? "AA" : "A";
      }
      var triplet = (alphabet[at2(chunk, 0)] << 18) + (alphabet[at2(chunk, 1)] << 12) + (alphabet[at2(chunk, 2)] << 6) + alphabet[at2(chunk, 3)];
    ...
    var writeBytes = function writeBytes2(bytes, elements, written) {
  ...
  function requireUint8FromHex() {
    ...
    var SyntaxError2 = globalThis2.SyntaxError;
    var min = Math.min;
    var stringMatch2 = uncurryThis2("".match);
  ...
  function requireAnUint8Array() {
    ...
    anUint8Array = function(argument) {
      ...
      throw new $TypeError2("Argument is not an Uint8Array");
    };
    return anUint8Array;
  }
  ...
  function requireEs_uint8Array_toBase64() {
    ...
    if (Uint8Array2) $2({
      ...
      toBase64: function toBase64() {
        ...
        var length = array.length;
        var triplet;
        var at2 = function at3(shift2) {
          return charAt2(alphabet, triplet >> 6 * shift2 & 63);
        };
        for (; i + 2 < length; i += 3) {
          triplet = (array[i] << 16) + (array[i + 1] << 8) + array[i + 2];
          result += at2(3) + at2(2) + at2(1) + at2(0);
        }
        if (i + 2 === length) {
          triplet = (array[i] << 16) + (array[i + 1] << 8);
          result += at2(3) + at2(2) + at2(1) + (omitPadding ? "" : "=");
        } else if (i + 1 === length) {
          triplet = array[i] << 16;
          result += at2(3) + at2(2) + (omitPadding ? "" : "==");
        }
        return result;
      }
    });
  ...
  function requireCollectionWeak() {
    ...
    var uncurryThis2 = requireFunctionUncurryThis();
    var defineBuiltIns2 = requireDefineBuiltIns();
    var getWeakData2 = require$$4.getWeakData;
    var anInstance2 = requireAnInstance();
    var anObject2 = requireAnObject();
    var isNullOrUndefined2 = requireIsNullOrUndefined();
    var isObject2 = require$$22;
    ...
    var id2 = 0;
    var uncaughtFrozenStore = function uncaughtFrozenStore2(state) {
    ...
    collectionWeak = {
      getConstructor: function getConstructor(wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
        ...
        var define2 = function define3(that, key, value) {
          var state = getInternalState(that);
          var data = getWeakData2(anObject2(key), true);
  ...
  function requireEs_weakMap_constructor() {
    ...
    var isExtensible2 = $Object2.isExtensible;
    var isFrozen2 = $Object2.isFrozen;
    var isSealed = $Object2.isSealed;
    var freeze2 = $Object2.freeze;
    var seal2 = $Object2.seal;
    var IS_IE11 = !globalThis2.ActiveXObject && "ActiveXObject" in globalThis2;
    var InternalWeakMap;
    var wrapper = function wrapper2(init) {
    ...
    var hasMSEdgeFreezingBug = function hasMSEdgeFreezingBug2() {
      return FREEZING2 && fails2(function() {
    ...
    if (NATIVE_WEAK_MAP) {
      if (IS_IE11) {
        ...
        InternalMetadataModule.enable();
        var nativeDelete = uncurryThis2(WeakMapPrototype["delete"]);
        var nativeHas = uncurryThis2(WeakMapPrototype.has);
        var nativeGet = uncurryThis2(WeakMapPrototype.get);
        defineBuiltIns2(WeakMapPrototype, {
          "delete": function _delete(key) {
            if (isObject2(key) && !isExtensible2(key)) {
  ...
  function requireWeakMapHelpers() {
    ...
    weakMapHelpers = {
      ...
      WeakMap,
      set: uncurryThis2(WeakMapPrototype.set),
      get: uncurryThis2(WeakMapPrototype.get),
      has: uncurryThis2(WeakMapPrototype.has),
      remove: uncurryThis2(WeakMapPrototype["delete"])
    };
  ...
  function requireWeb_domCollections_forEach() {
    ...
    var createNonEnumerableProperty2 = requireCreateNonEnumerableProperty();
    var handlePrototype = function handlePrototype2(CollectionPrototype) {
  ...
  function requireWeb_domException_constructor() {
    ...
    var setInternalState2 = InternalStateModule2.set;
    var getInternalState = InternalStateModule2.getterFor(DOM_EXCEPTION);
    var HAS_STACK = "stack" in new Error2(DOM_EXCEPTION);
    var codeFor = function codeFor2(name) {
      return hasOwn2(DOMExceptionConstants, name) && DOMExceptionConstants[name].m ? DOMExceptionConstants[name].c : 0;
    };
    var $DOMException = function DOMException2() {
      ...
      if (HAS_STACK) {
        ...
        defineProperty2(this, "stack", createPropertyDescriptor2(1, clearErrorStack(error.stack, 1)));
      }
    };
    var DOMExceptionPrototype = $DOMException.prototype = create2(ErrorPrototype);
    var createGetterDescriptor = function createGetterDescriptor2(get) {
      return {
        enumerable: true,
        configurable: true,
        get
    ...
    var getterFor = function getterFor2(key2) {
    ...
    defineProperty2(DOMExceptionPrototype, "constructor", createPropertyDescriptor2(1, $DOMException));
    ...
    if (INCORRECT_CODE && DESCRIPTORS2 && NativeDOMException === PolyfilledDOMException) {
    ...
    for (var key in DOMExceptionConstants) if (hasOwn2(DOMExceptionConstants, key)) {
      ...
      if (!hasOwn2(PolyfilledDOMException, constantName)) {
        defineProperty2(PolyfilledDOMException, constantName, descriptor);
      }
      if (!hasOwn2(PolyfilledDOMExceptionPrototype, constantName)) {
        defineProperty2(PolyfilledDOMExceptionPrototype, constantName, descriptor);
      }
    }
  ...
  function requireWeb_domException_stack() {
    ...
    var $DOMException = function DOMException2() {
      ...
      var error = new Error2(message);
      error.name = DOM_EXCEPTION;
      defineProperty2(that, "stack", createPropertyDescriptor2(1, clearErrorStack(error.stack, 1)));
    ...
    var descriptor = NativeDOMException && DESCRIPTORS2 && Object.getOwnPropertyDescriptor(globalThis2, DOM_EXCEPTION);
    ...
    if (PolyfilledDOMExceptionPrototype.constructor !== PolyfilledDOMException) {
      if (!IS_PURE) {
        defineProperty2(PolyfilledDOMExceptionPrototype, "constructor", createPropertyDescriptor2(1, PolyfilledDOMException));
      }
      for (var key in DOMExceptionConstants) if (hasOwn2(DOMExceptionConstants, key)) {
        var constant = DOMExceptionConstants[key];
        var constantName = constant.s;
        if (!hasOwn2(PolyfilledDOMException, constantName)) {
          defineProperty2(PolyfilledDOMException, constantName, createPropertyDescriptor2(6, constant.c));
        }
      }
    }
  ...
  function requireWeb_queueMicrotask() {
    ...
    var WRONG_ARITY = fails2(function() {
      return DESCRIPTORS2 && Object.getOwnPropertyDescriptor(globalThis2, "queueMicrotask").value.length !== 1;
    });
    $2({
      global: true,
      enumerable: true,
        ...
        if (INCORRECT_VALUE || !descriptor || !descriptor.get || !descriptor.enumerable) {
          defineBuiltInAccessor2(globalThis2, "self", {
            ...
            set: function self2(value) {
              if (this !== globalThis2) throw new $TypeError2("Illegal invocation");
              defineProperty2(globalThis2, "self", {
                value,
                writable: true,
                configurable: true,
                enumerable: true
  ...
  function requireWeb_structuredClone() {
    ...
    var push2 = uncurryThis2([].push);
    var thisBooleanValue = uncurryThis2(true.valueOf);
    var thisNumberValue2 = uncurryThis2(1.1.valueOf);
    var thisStringValue = uncurryThis2("".valueOf);
    var thisTimeValue = uncurryThis2(Date2.prototype.getTime);
    var PERFORMANCE_MARK = uid2("structuredClone");
    var DATA_CLONE_ERROR = "DataCloneError";
    var TRANSFERRING = "Transferring";
    var checkBasicSemantic = function checkBasicSemantic2(structuredCloneImplementation) {
      return !fails2(function() {
    ...
    var checkErrorsCloning = function checkErrorsCloning2(structuredCloneImplementation, $Error) {
      return !fails2(function() {
        var error = new $Error();
    ...
    var checkNewErrorsCloningSemantic = function checkNewErrorsCloningSemantic2(structuredCloneImplementation) {
      return !fails2(function() {
    ...
    var throwUncloneable = function throwUncloneable2(type) {
      throw new DOMException2("Uncloneable type: " + type, DATA_CLONE_ERROR);
    };
    var throwUnpolyfillable = function throwUnpolyfillable2(type, action) {
      throw new DOMException2((action || "Cloning") + " of " + type + " cannot be properly polyfilled in this engine", DATA_CLONE_ERROR);
    };
    var tryNativeRestrictedStructuredClone = function tryNativeRestrictedStructuredClone2(value, type) {
      if (!nativeRestrictedStructuredClone) throwUnpolyfillable(type);
      return nativeRestrictedStructuredClone(value);
    };
    var createDataTransfer = function createDataTransfer2() {
      var dataTransfer;
      try {
    ...
    var cloneBuffer = function cloneBuffer2(value, map, $type) {
    ...
    var cloneView = function cloneView2(value, type, offset, length, map) {
      ...
      switch (type) {
        ...
        case "Object":
          ...
          for (i = 0, length = lengthOfArrayLike2(keys); i < length; i++) {
            key = keys[i];
            createProperty2(cloned, key, _structuredCloneInternal(value[key], map));
          }
          break;
        case "Map":
        ...
        case "Set":
          ...
          break;
        case "Error":
          createNonEnumerableProperty2(cloned, "message", _structuredCloneInternal(value.message, map));
          if (hasOwn2(value, "cause")) {
            createNonEnumerableProperty2(cloned, "cause", _structuredCloneInternal(value.cause, map));
          }
        ...
        case "DOMException":
          if (ERROR_STACK_INSTALLABLE) {
            createNonEnumerableProperty2(cloned, "stack", _structuredCloneInternal(value.stack, map));
          }
      }
      return cloned;
    };
    var tryToTransfer = function tryToTransfer2(rawTransfer, map) {
      ...
      iterate2(rawTransfer, function(value2) {
        push2(transfer, anObject2(value2));
      });
      var i = 0;
    ...
    var detachBuffers = function detachBuffers2(buffers) {
    ...
    $2({
      ...
      structuredClone: function structuredClone(value) {
        ...
        var clone2 = _structuredCloneInternal(value, map);
  ...
  var numberToString$1 = uncurryThis(1.1.toString);
  ...
  var EOF;
  var endsInNumber = function endsInNumber2(input) {
  ...
  var parseIPv6 = function parseIPv62(input) {
    var address = [0, 0, 0, 0, 0, 0, 0, 0];
    var pieceIndex = 0;
    var compress = null;
    var pointer = 0;
    var value, length, numbersSeen, ipv4Piece, number, swaps, swap;
    var chr = function chr2() {
  ...
  var findLongestZeroSequence = function findLongestZeroSequence2(ipv6) {
    var maxIndex = null;
    var maxLength = 1;
    var currStart = null;
    var currLength = 0;
  ...
  var percentEncode = function percentEncode2(chr, set) {
  ...
  var isWindowsDriveLetter = function isWindowsDriveLetter2(string, normalized) {
    var second;
    return string.length === 2 && exec(ALPHA, charAt(string, 0)) && ((second = charAt(string, 1)) === ":" || !normalized && second === "|");
  };
  var startsWithWindowsDriveLetter = function startsWithWindowsDriveLetter2(string) {
    var third;
    return string.length > 1 && isWindowsDriveLetter(stringSlice(string, 0, 2)) && (string.length === 2 || (third = charAt(string, 2)) === "/" || third === "\\" || third === "?" || third === "#");
  };
  var isSingleDot = function isSingleDot2(segment) {
    return segment === "." || toLowerCase(segment) === "%2e";
  };
  var isDoubleDot = function isDoubleDot2(segment) {
  ...
  var _URLState = function URLState(url, isBase, base) {
    ...
    if (isBase) {
      ...
      if (base !== void 0) baseState = new _URLState(base, true);
  ...
  _URLState.prototype = {
    ...
    parse: function parse2(input, stateOverride, base) {
      var url = this;
  ...
  var accessorDescriptor = function accessorDescriptor2(getter, setter) {
    return {
      get: function get() {
  ...
  function requireUrlConstructorDetection() {
    ...
    urlConstructorDetection = !fails2(function() {
      ...
      return IS_PURE && (!url.toJSON || !params2.has("a", 1) || params2.has("a", 2) || !params2.has("a", void 0) || params2.has("b")) || !params.size && (IS_PURE || !DESCRIPTORS2) || !params.sort || url.href !== "https://a/c%20d?a=1&c=3" || params.get("c") !== "3" || String(new URLSearchParams("?a=1")) !== "a=1" || !params[ITERATOR] || new URL("https://a@b").username !== "a" || new URLSearchParams(new URLSearchParams("a=b")).get("a") !== "b" || new URL("https://тест").host !== "xn--e1aybc" || new URL("https://a#б").hash !== "#%D0%B1" || result !== "a1c3" || new URL("https://x", void 0).host !== "x";
    });
  ...
  function requireWeb_url_canParse() {
    ...
    var validateArgumentsLength2 = requireValidateArgumentsLength();
    var toString2 = requireToString();
    var USE_NATIVE_URL2 = requireUrlConstructorDetection();
    var URL2 = getBuiltIn2("URL");
    var THROWS_WITHOUT_ARGUMENTS = USE_NATIVE_URL2 && fails2(function() {
      URL2.canParse();
    });
    var WRONG_ARITY = fails2(function() {
  ...
  function requireWeb_url_toJson() {
    ...
    $2({
      ...
      toJSON: function toJSON() {
        return call2(URL.prototype.toString, this);
      }
    });
  ...
  function requireWeb_urlSearchParams_constructor() {
    ...
    var parseHexOctet = function parseHexOctet2(string, start) {
      var substr = stringSlice2(string, start, start + 2);
      if (!exec2(VALID_HEX, substr)) return NaN;
      return $parseInt(substr, 16);
    };
    var getLeadingOnes = function getLeadingOnes2(octet) {
      var count = 0;
    ...
    var utf8Decode = function utf8Decode2(octets) {
      var codePoint = null;
    ...
    var decode = function decode2(input) {
      ...
      var i = 0;
      while (i < length) {
        var decodedChar = charAt2(input, i);
        if (decodedChar === "%") {
          if (charAt2(input, i + 1) === "%" || i + 3 > length) {
            result += "%";
            i++;
            continue;
          }
          ...
          if (byteSequenceLength === 0) {
            ...
            while (sequenceIndex < byteSequenceLength) {
              i++;
              if (i + 3 > length || charAt2(input, i) !== "%") break;
    ...
    var replacer = function replacer2(match) {
    ...
    var URLSearchParamsState = function URLSearchParamsState2(init) {
      this.entries = [];
      this.url = null;
      if (init !== void 0) {
        if (isObject2(init)) this.parseObject(init);
        else this.parseQuery(typeof init == "string" ? charAt2(init, 0) === "?" ? stringSlice2(init, 1) : init : $toString2(init));
      }
    };
    URLSearchParamsState.prototype = {
      ...
      parseObject: function parseObject(object) {
        ...
        if (iteratorMethod) {
          ...
          while (!(step = call2(next, iterator)).done) {
            ...
            if ((first = call2(entryNext, entryIterator)).done || (second = call2(entryNext, entryIterator)).done || !call2(entryNext, entryIterator).done) throw new TypeError2("Expected sequence with length 2");
            push2(entries2, {
              key: $toString2(first.value),
              value: $toString2(second.value)
            });
          }
        } else for (var key in object) if (hasOwn2(object, key)) {
          push2(entries2, {
            key,
            value: $toString2(object[key])
          });
        }
      },
      ...
      serialize: function serialize() {
        ...
        while (index < entries2.length) {
          ...
          push2(result, _serialize(entry.key) + "=" + _serialize(entry.value));
        }
        return join2(result, "&");
      },
      update: function update() {
    ...
    var URLSearchParamsConstructor = function URLSearchParams2() {
      ...
      var state = setInternalState2(this, new URLSearchParamsState(init));
      if (!DESCRIPTORS2) this.size = state.entries.length;
    };
    ...
    defineBuiltIns2(URLSearchParamsPrototype, {
      ...
      "delete": function _delete(name) {
        ...
        if (!DESCRIPTORS2) this.size = entries2.length;
        state.updateURL();
      },
      ...
      getAll: function getAll(name) {
        ...
        var index = 0;
        for (; index < entries2.length; index++) {
          if (entries2[index].key === key) push2(result, entries2[index].value);
        }
        return result;
      },
    ...
    defineBuiltIn2(URLSearchParamsPrototype, ITERATOR, URLSearchParamsPrototype.entries, {
      name: "entries"
    });
    ...
    if (DESCRIPTORS2) defineBuiltInAccessor2(URLSearchParamsPrototype, "size", {
      get: function size() {
    ...
    if (!USE_NATIVE_URL2 && isCallable2(Headers)) {
      var headersHas = uncurryThis2(HeadersPrototype.has);
      var headersSet = uncurryThis2(HeadersPrototype.set);
      var wrapRequestOptions = function wrapRequestOptions2(init) {
        if (isObject2(init)) {
          var body = init.body;
          var headers;
          if (classof2(body) === URL_SEARCH_PARAMS) {
            ...
            return create2(init, {
              body: createPropertyDescriptor2(0, $toString2(body)),
  ...
  function requireWeb_urlSearchParams_delete() {
    ...
    var append = uncurryThis2(URLSearchParamsPrototype.append);
    var $delete = uncurryThis2(URLSearchParamsPrototype["delete"]);
    var forEach = uncurryThis2(URLSearchParamsPrototype.forEach);
    var push2 = uncurryThis2([].push);
  ...
  function requireWeb_urlSearchParams_has() {
    ...
    var $URLSearchParams = URLSearchParams;
    var URLSearchParamsPrototype = $URLSearchParams.prototype;
    var getAll = uncurryThis2(URLSearchParamsPrototype.getAll);
    var $has = uncurryThis2(URLSearchParamsPrototype.has);
  ...
  function requireWeb_urlSearchParams_size() {
    ...
    var URLSearchParamsPrototype = URLSearchParams.prototype;
    var forEach = uncurryThis2(URLSearchParamsPrototype.forEach);
    if (DESCRIPTORS2 && !("size" in URLSearchParamsPrototype)) {
  ...
  function addToSet(set, array) {
    var transformCaseFunc = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : stringToLowerCase;
    if (setPrototypeOf) {
  ...
  function stringifyValue(value) {
    switch (_typeof(value)) {
      ...
      case "object": {
        ...
        var valueAsRecord = value;
        var valueToString = lookupGetter(valueAsRecord, "toString");
        if (typeof valueToString === "function") {
          var stringified = valueToString(valueAsRecord);
  ...
  function createDOMPurify() {
    ...
    var originalDocument = document2;
    var currentScript = originalDocument.currentScript;
    window2.DocumentFragment;
    var HTMLTemplateElement = window2.HTMLTemplateElement, Node = window2.Node, Element = window2.Element, NodeFilter = window2.NodeFilter, _window$NamedNodeMap = window2.NamedNodeMap;
    _window$NamedNodeMap === void 0 ? window2.NamedNodeMap || window2.MozNamedAttrMap : _window$NamedNodeMap;
    window2.HTMLFormElement;
    var DOMParser = window2.DOMParser, trustedTypes = window2.trustedTypes;
    ...
    var getShadowRoot = lookupGetter(ElementPrototype, "shadowRoot");
    var getAttributes = lookupGetter(ElementPrototype, "attributes");
    var getNodeType = Node && Node.prototype ? lookupGetter(Node.prototype, "nodeType") : null;
    var getNodeName = Node && Node.prototype ? lookupGetter(Node.prototype, "nodeName") : null;
    ...
    var emptyHTML = "";
    var defaultTrustedTypesPolicy;
    var defaultTrustedTypesPolicyResolved = false;
    var IN_TRUSTED_TYPES_POLICY = 0;
    var _assertNotInTrustedTypesPolicy = function _assertNotInTrustedTypesPolicy2() {
      if (IN_TRUSTED_TYPES_POLICY > 0) {
        throw typeErrorCreate('A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the "DOMPurify and Trusted Types" section of the README.');
      }
    };
    var _createTrustedHTML = function _createTrustedHTML2(html2) {
    ...
    var _createTrustedScriptURL = function _createTrustedScriptURL2(scriptUrl) {
      _assertNotInTrustedTypesPolicy();
      IN_TRUSTED_TYPES_POLICY++;
      try {
    ...
    var _getDefaultTrustedTypesPolicy = function _getDefaultTrustedTypesPolicy2() {
    ...
    var SET_CONFIG_ALLOWED_TAGS = null;
    var SET_CONFIG_ALLOWED_ATTR = null;
    ...
    var DEFAULT_MATHML_TEXT_INTEGRATION_POINTS = freeze(["mi", "mo", "mn", "ms", "mtext"]);
    var MATHML_TEXT_INTEGRATION_POINTS = addToSet({}, DEFAULT_MATHML_TEXT_INTEGRATION_POINTS);
    var DEFAULT_HTML_INTEGRATION_POINTS = freeze(["annotation-xml"]);
    var HTML_INTEGRATION_POINTS = addToSet({}, DEFAULT_HTML_INTEGRATION_POINTS);
    ...
    var _parseConfig = function _parseConfig2() {
      ...
      USE_PROFILES = objectHasOwnProperty(cfg, "USE_PROFILES") ? cfg.USE_PROFILES && _typeof(cfg.USE_PROFILES) === "object" ? clone(cfg.USE_PROFILES) : cfg.USE_PROFILES : false;
      ...
      MATHML_TEXT_INTEGRATION_POINTS = objectHasOwnProperty(cfg, "MATHML_TEXT_INTEGRATION_POINTS") && cfg.MATHML_TEXT_INTEGRATION_POINTS && _typeof(cfg.MATHML_TEXT_INTEGRATION_POINTS) === "object" ? clone(cfg.MATHML_TEXT_INTEGRATION_POINTS) : addToSet({}, DEFAULT_MATHML_TEXT_INTEGRATION_POINTS);
      HTML_INTEGRATION_POINTS = objectHasOwnProperty(cfg, "HTML_INTEGRATION_POINTS") && cfg.HTML_INTEGRATION_POINTS && _typeof(cfg.HTML_INTEGRATION_POINTS) === "object" ? clone(cfg.HTML_INTEGRATION_POINTS) : addToSet({}, DEFAULT_HTML_INTEGRATION_POINTS);
      var customElementHandling = objectHasOwnProperty(cfg, "CUSTOM_ELEMENT_HANDLING") && cfg.CUSTOM_ELEMENT_HANDLING && _typeof(cfg.CUSTOM_ELEMENT_HANDLING) === "object" ? clone(cfg.CUSTOM_ELEMENT_HANDLING) : create(null);
      ...
      if (cfg.TRUSTED_TYPES_POLICY) {
        ...
        var previousTrustedTypesPolicy = trustedTypesPolicy;
    ...
    var _checkSvgNamespace = function _checkSvgNamespace2(tagName, parent, parentTagName) {
    ...
    var _checkMathMlNamespace = function _checkMathMlNamespace2(tagName, parent, parentTagName) {
      if (parent.namespaceURI === HTML_NAMESPACE) {
        return tagName === "math";
      }
    ...
    var _checkHtmlNamespace = function _checkHtmlNamespace2(tagName, parent, parentTagName) {
    ...
    var _neutralizeRoot = function _neutralizeRoot2(root) {
      var childNodes = getChildNodes(root);
      if (childNodes) {
        var snapshot = [];
        arrayForEach(childNodes, function(child) {
          arrayPush(snapshot, child);
        });
        arrayForEach(snapshot, function(child) {
          try {
            remove(child);
          } catch (_) {
          }
    ...
    var _removeAttribute = function _removeAttribute2(name, element) {
      try {
        arrayPush(DOMPurify.removed, {
    ...
    var _stripDisallowedAttributes = function _stripDisallowedAttributes2(element) {
    ...
    var _neutralizeSubtree = function _neutralizeSubtree2(root) {
      var stack = [root];
      while (stack.length > 0) {
        var node = stack.pop();
        var nodeType = getNodeType ? getNodeType(node) : node.nodeType;
    ...
    var _initDocument = function _initDocument2(dirty) {
      ...
      var dirtyPayload = trustedTypesPolicy ? _createTrustedHTML(dirty) : dirty;
    ...
    var _createNodeIterator = function _createNodeIterator2(root) {
    ...
    var _stripTemplateExpressions = function _stripTemplateExpressions2(value) {
      value = stringReplace(value, MUSTACHE_EXPR$1, " ");
      value = stringReplace(value, ERB_EXPR$1, " ");
      value = stringReplace(value, TMPLIT_EXPR$1, " ");
      return value;
    };
    var _scrubTemplateExpressions2 = function _scrubTemplateExpressions(node) {
      var _node$querySelectorAl;
      node.normalize();
      var walker = createNodeIterator.call(
      ...
      var templates = (_node$querySelectorAl = node.querySelectorAll) === null || _node$querySelectorAl === void 0 ? void 0 : _node$querySelectorAl.call(node, "template");
      if (templates) {
        arrayForEach(templates, function(tmpl) {
    ...
    var _isClobbered = function _isClobbered2(element) {
      var realTagName = getNodeName ? getNodeName(element) : null;
    ...
    var _isDocumentFragment = function _isDocumentFragment2(value) {
      if (!getNodeType || _typeof(value) !== "object" || value === null) {
        return false;
      }
      try {
    ...
    var _isNode = function _isNode2(value) {
      if (!getNodeType || _typeof(value) !== "object" || value === null) {
        return false;
      }
      try {
    ...
    function _executeHooks(hooks2, currentNode, data) {
      ...
      arrayForEach(hooks2, function(hook) {
        hook.call(DOMPurify, currentNode, data, CONFIG);
      });
    }
    var _isUnsafeNode = function _isUnsafeNode2(currentNode, tagName) {
    ...
    var _sanitizeDisallowedNode = function _sanitizeDisallowedNode2(currentNode, tagName) {
      ...
      if (KEEP_CONTENT && !FORBID_CONTENTS[tagName]) {
        ...
        if (childNodes && parentNode) {
          ...
          for (var i = childCount - 1; i >= 0; --i) {
            var hoisted = IN_PLACE ? childNodes[i] : cloneNode(childNodes[i], true);
    ...
    var _sanitizeElements = function _sanitizeElements2(currentNode) {
      ...
      var tagName = transformCaseFunc(getNodeName ? getNodeName(currentNode) : currentNode.nodeName);
      ...
      var nt = getNodeType ? getNodeType(currentNode) : currentNode.nodeType;
      ...
      if (SAFE_FOR_TEMPLATES && currentNode.nodeType === NODE_TYPE.text) {
        var content = _stripTemplateExpressions(currentNode.textContent);
    ...
    var _isValidAttribute = function _isValidAttribute2(lcTag, lcName, value) {
      ...
      var nameIsPermitted = ALLOWED_ATTR[lcName] || EXTRA_ELEMENT_HANDLING.attributeCheck instanceof Function && EXTRA_ELEMENT_HANDLING.attributeCheck(lcName, lcTag);
    ...
    var RESERVED_CUSTOM_ELEMENT_NAMES = addToSet({}, ["annotation-xml", "color-profile", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "missing-glyph"]);
    var _isBasicCustomElement = function _isBasicCustomElement2(tagName) {
      return !RESERVED_CUSTOM_ELEMENT_NAMES[stringToLowerCase(tagName)] && regExpTest(CUSTOM_ELEMENT$1, tagName);
    };
    var _applyTrustedTypesToAttribute = function _applyTrustedTypesToAttribute2(lcTag, lcName, namespaceURI, value) {
      if (trustedTypesPolicy && _typeof(trustedTypes) === "object" && typeof trustedTypes.getAttributeType === "function" && !namespaceURI) {
    ...
    var _setAttributeValue = function _setAttributeValue2(currentNode, name, namespaceURI, value) {
      try {
        if (namespaceURI) {
    ...
    var _sanitizeShadowDOM2 = function _sanitizeShadowDOM(fragment) {
      var shadowNode = null;
      ...
      while (shadowNode = shadowIterator.nextNode()) {
        ...
        var shadowNodeType = getNodeType ? getNodeType(shadowNode) : shadowNode.nodeType;
        if (shadowNodeType === NODE_TYPE.element) {
          var innerSr = getShadowRoot(shadowNode);
    ...
    var _sanitizeAttachedShadowRoots = function _sanitizeAttachedShadowRoots2(root) {
      var stack = [{
        node: root,
        shadow: null
      }];
      while (stack.length > 0) {
        ...
        var node = item.node;
        var nodeType = getNodeType ? getNodeType(node) : node.nodeType;
        var isElement = nodeType === NODE_TYPE.element;
        var childNodes = getChildNodes(node);
        if (childNodes) {
          for (var i = childNodes.length - 1; i >= 0; --i) {
            stack.push({
        ...
        if (isElement) {
          var rootName = getNodeName ? getNodeName(node) : null;
    ...
    DOMPurify.sanitize = function(dirty) {
      ...
      DOMPurify.removed = [];
      var inPlace = IN_PLACE && typeof dirty !== "string" && _isNode(dirty);
      if (inPlace) {
        var nn = getNodeName ? getNodeName(dirty) : dirty.nodeName;
        if (typeof nn === "string") {
          var tagName = transformCaseFunc(nn);
      ...
      var nodeIterator = _createNodeIterator(inPlace ? dirty : body);
      try {
      ...
      if (inPlace) {
        arrayForEach(DOMPurify.removed, function(entry) {
          if (entry.element) {
  ...
  var _ownKeys = function ownKeys2(o) {
  ...
  (function(factory) {
    ...
    function _callSuper(t, o, e) {
      return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct2() ? Reflect.construct(o, [], _getPrototypeOf(t).constructor) : o.apply(t, e));
    }
    ...
    var AbortSignal = /* @__PURE__ */ (function(_Emitter) {
      ...
      return _createClass(AbortSignal2, [{
        ...
        value: function any(iterable) {
          ...
          function clean() {
            var _iterator = _createForOfIteratorHelper2(iterable), _step;
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          ...
          var _iterator2 = _createForOfIteratorHelper2(iterable), _step2;
          try {
