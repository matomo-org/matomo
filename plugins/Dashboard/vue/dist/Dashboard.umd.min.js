 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */
window.angular.module("piwikApp.service").factory("dashboardsModel",(function(){return f}));var g=window,w=g.$;function D(e,t,r){var o=w(".dashboardSettings");o.show(),window.initTopControls(),w("#topBars").length||(o.after(w("#Dashboard")),w("#Dashboard ul li").removeClass("active"),w("#Dashboard_embeddedIndex_".concat(e)).addClass("active")),window.widgetsHelper.getAvailableWidgets(),w("#dashboardWidgetsArea").off("dashboardempty",window.showEmptyDashboardNotification).on("dashboardempty",window.showEmptyDashboardNotification).dashboard({idDashboard:e,layout:r,name:t?t.name:""});var n=w("#columnPreview").find(">div");n.each((function(){var e=[];w("div",this).each((function(){e.push(this.className.replace(/width-/,""))})),w(this).attr("layout",e.join("-"))})),n.off("click.renderDashboard"),n.on("click.renderDashboard",(function(){n.removeClass("choosen"),w(this).addClass("choosen")}))}function j(e){var t=w("#dashboardWidgetsArea");return t.dashboard("destroyWidgets"),t.empty(),window.globalAjaxQueue.abort(),Promise.all([f.getDashboard(e),f.getDashboardLayout(e)]).then((function(t){var r=b(t,2),o=r[0],n=r[1];w((function(){D(e,o,n)}))}))}function A(){console.log("clearing"),w(".top_controls .dashboard-manager").hide(),w("#dashboardWidgetsArea").dashboard("destroy")}function P(e){"Widgetize"!==e.module&&"Dashboard_Dashboard"!==e.category&&A()}function x(e){"Dashboard_Dashboard"===e.category&&w.isNumeric(e.subcategory)&&(e.promise=j(parseInt(e.subcategory,10)))}var O={mounted:function(e,t){setTimeout((function(){j(t.value.idDashboard)})),Object(a["watch"])((function(){return i["MatomoUrl"].urlParsed.value}),(function(e){P(e)})),i["Matomo"].on("ReportingPage.loadPage",x)},unmounted:function(){P(i["MatomoUrl"].urlParsed.value),i["Matomo"].off("ReportingPage.loadPage",x)}};
/*!
 * Matomo - free/libre analytics platform
 *
 * @link https://matomo.org
 * @license http://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function S(){return{restrict:"A",scope:{dashboardid:"=",layout:"="},link:function(e,t){var r={instance:null,value:{idDashboard:e.dashboardid,layout:e.layout},oldValue:null,modifiers:{},dir:{}};O.mounted(t[0],r),t.on("$destroy",(function(){return O.unmounted()}))}}}window.angular.module("piwikApp").directive("piwikDashboard",S)}})}));
