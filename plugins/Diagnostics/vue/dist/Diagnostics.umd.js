(function(global, factory) {
  ...
  const _hoisted_5 = /* @__PURE__ */ vue.createElementVNode("p", null, null, -1);
  const _hoisted_6 = { class: "diagnostics configfile" };
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(_component_ContentBlock, {
      ...
      default: vue.withCtx(() => [
        ...
        _hoisted_5,
        vue.withDirectives((vue.openBlock(), vue.createElementBlock("table", _hoisted_6, [
                ...
                default: vue.withCtx(() => [
                  vue.createElementVNode("tr", null, [
                    vue.createElementVNode("td", _hoisted_7, [
                      vue.createElementVNode("a", { name: category }, null, 8, _hoisted_8),
                  ...
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(configValues, (configEntry, key) => {
                    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("tr", {
                      ...
                      vue.createElementVNode("td", _hoisted_9, vue.toDisplayString(`${key}${configEntry.value !== null && (configEntry.value instanceof Array || typeof configEntry.value === "object") ? "[]" : ""}`), 1),
                      ...
                      vue.createElementVNode("td", _hoisted_11, [
                        ...
                        (configEntry.isCustomValue || configEntry.value === null) && configEntry.defaultValue !== null ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_13, [
                          configEntry.description ? (vue.openBlock(), vue.createElementBlock("br", _hoisted_14)) : vue.createCommentVNode("", true),
