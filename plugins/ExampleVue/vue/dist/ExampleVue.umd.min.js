 ...
 */
const i=Object(u["defineAsyncComponent"])(()=>n.e(1).then(n.bind(null,"2d21")));function f(){return{restrict:"A",scope:{},template:"",link:function(e,t){const n=Object(u["createApp"])(i);n.mount(t[0])}}}f.$inject=[],angular.module("piwikApp").directive("exampleVueComponent",f)}})}));
