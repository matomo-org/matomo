 ...
 *
 */
namespace Piwik\Plugins\GetLocalSiteTimeDate\Widgets;
 ...
 */
class GetLocalTimeDate extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         */
        $config->setName('GetLocalSiteTimeDate_LocalTimeDate');
	...
	return '<input type="hidden" class="site_timezone" value="'.$site->getTimezone().'">'
		.'<div class="widgetBody"><h2 class="LocalWebTime"></h2></div>';
