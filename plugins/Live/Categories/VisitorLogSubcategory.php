...
class VisitorLogSubcategory extends Subcategory
{
    ...
    public function getHelp()
    {
        ...
        $help .= '<p><a href="https://matomo.org/docs/real-time/?mtm_campaign=App_Help&mtm_source=Matomo_App" target="_blank" rel="noreferrer noopener">' . Piwik::translate('Live_VisitorLogSubcategoryHelp3') . '</a></p>';
        return $help;
    }
}
