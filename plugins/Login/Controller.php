...
class Controller extends \Piwik\Plugin\Controller
{
    ...
    {
        $message = Piwik::translate('Login_InvalidNonceOrHeadersOrReferrer', array('<a target="_blank" rel="noreferrer" href="https://matomo.org/faq/how-to-install/#faq_98">', '</a>'));
    ...
    protected function getMessageExceptionNoAccessWhenInsecureConnectionMayBeUsed()
    {
        ...
        if(Url::isSecureConnectionAssumedByPiwikButNotForcedYet()) {
            $message = '<br/><br/>' . Piwik::translate('Login_InvalidNonceSSLMisconfigured',
                    array(
                        '<a target="_blank" rel="noreferrer" href="https://matomo.org/faq/how-to/faq_91/">',
                        '</a>',
