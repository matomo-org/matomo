...
use Piwik\Plugins\UsersManager\UserChangeToken;
...
class PasswordResetter
{
    ...
    public function isTokenValid($token, $user, $keySuffix)
    {
        ...
        return $userChangeToken->isTokenValid($token, $user, $keySuffix, $user['password']);
    }
    ...
    {
        $userChangeToken = new UserChangeToken();
        return $userChangeToken->generateToken($user, $keySuffix, $user['password'], $expiryTimestamp);
    }
