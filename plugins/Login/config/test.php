<?php
return array(
    'Piwik\Plugins\Login\SystemSettings' => Piwik\DI::decorate(function ($settings, \Psr\Container\ContainerInterface $c) {
    ...
    'Piwik\Plugins\Login\Security\BruteForceDetection' => Piwik\DI::decorate(function ($detection, \Psr\Container\ContainerInterface $c) {
