...
class Marketplace extends \Piwik\Plugin
{
    ...
    public function getClientSideTranslationKeys(&$translationKeys)
    {
        ...
        $translationKeys[] = 'Marketplace_IntroShort';
        ...
        $translationKeys[] = 'Marketplace_ResetFilters';
        $translationKeys[] = 'Marketplace_OneResultFoundFor';
        $translationKeys[] = 'Marketplace_ResultsFoundFor';
        ...
        $translationKeys[] = 'Marketplace_UpdatedOn';
        ...
        $translationKeys[] = 'Marketplace_SeeLess';
        $translationKeys[] = 'Marketplace_SeeLessInCategory';
