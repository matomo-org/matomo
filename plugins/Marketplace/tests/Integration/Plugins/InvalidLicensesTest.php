...
class InvalidLicensesTest extends IntegrationTestCase
{
    ...
    public function test_getMessageExceededLicenses_getMessageExpiredLicenses_noLicenses_PaidPluginActivated()
    {
        ...
        $this->assertEquals('You are using the following plugins without a license: <strong>PaidPlugin1</strong>. <br/>To resolve this issue either update your license key, <a href="https://shop.piwik.org/my-account" target="_blank" rel="noreferrer">get a subscription</a> or deactivate the plugin. <a href="?module=Marketplace&action=subscriptionOverview">Get a summary of your plugin subscriptions.</a>', $expired->getMessageNoLicense());
    }
    ...
    public function test_getMessageExceededLicenses_getMessageExpiredLicenses_invalidLicenses_PaidPluginActivated()
    {
        ...
        $this->assertNull($expired->getMessageExceededLicenses());
        $this->assertEquals('The licenses for the following plugins are expired: <strong>PaidPlugin1</strong>. <br/>You will no longer receive any updates for these plugins. To resolve this issue either <a href="https://shop.piwik.org/my-account" target="_blank" rel="noreferrer">renew your subscription</a>, or deactivate the plugin if you no longer use it. <a href="?module=Marketplace&action=subscriptionOverview">Get a summary of your plugin subscriptions.</a>', $expired->getMessageExpiredLicenses());
    }

    public function test_getMessageExceededLicenses_getMessageExpiredLicenses_exceededLicenses_PaidPluginActivated()
    {
        $expired = $this->buildWithExceededLicense();
        $this->assertEquals('The licenses for the following plugins are no longer valid as the number of authorized users for the license is exceeded: <strong>PaidPlugin2</strong>. <br/>You will not be able to download updates for these plugins. To resolve this issue either delete some users or <a href="https://shop.piwik.org/my-account" target="_blank" rel="noreferrer">upgrade the subscription</a>. <a href="?module=Marketplace&action=subscriptionOverview">Get a summary of your plugin subscriptions.</a>', $expired->getMessageExceededLicenses());
        $this->assertEquals('The licenses for the following plugins are expired: <strong>PaidPlugin1</strong>. <br/>You will no longer receive any updates for these plugins. To resolve this issue either <a href="https://shop.piwik.org/my-account" target="_blank" rel="noreferrer">renew your subscription</a>, or deactivate the plugin if you no longer use it. <a href="?module=Marketplace&action=subscriptionOverview">Get a summary of your plugin subscriptions.</a>', $expired->getMessageExpiredLicenses());
    }
