...
// The Matomo mark on its own, without the wordmark, drawn at the 18x11 the chip uses. It takes its
// colour from the element around it, which images/matomo-badge.png - the four colour mark - cannot
// do: the chip needs one flat brand colour, and one that follows the theme into dark mode.
