...
class Clockwork extends SMSProvider
{
    ...
    {
        return 'You can use <a target="_blank" rel="noreferrer" href="https://www.clockworksms.com/platforms/piwik/"><img src="plugins/MobileMessaging/images/Clockwork.png"/></a> to send SMS Reports from Piwik.<br/>
			<ul>
			<li> First, <a target="_blank" rel="noreferrer" href="https://www.clockworksms.com/platforms/piwik/">get an API Key from Clockwork</a> (Signup is free!)
			...
			</li><li>Most countries and networks are supported but we suggest you check the latest position on their coverage map <a target="_blank" rel="noreferrer" href="https://www.clockworksms.com/sms-coverage/">here</a>.
			</li>
			</ul>
			';
    }
