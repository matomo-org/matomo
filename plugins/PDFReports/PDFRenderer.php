<?php
require_once PIWIK_INCLUDE_PATH . '/plugins/PDFReports/lib/tcpdf/config/lang/eng.php';
require_once PIWIK_INCLUDE_PATH . '/plugins/PDFReports/lib/tcpdf/tcpdf.php';

class Piwik_PDFReports_PDFRenderer extends TCPDF
{
	private $reportFont     	   = 'arialunicid0';
