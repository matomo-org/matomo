<div id='entityEditContainer'>
    ...
    {foreach from=$reports item=report}
        <tr>
            ...
            <td>
                {*download link*}
                <a href="{url module=API period=$report.period segment=null token_auth=$token_auth method='PDFReports.generateReport' idReport=$report.idreport outputType=$downloadOutputType date=$reportDate language=$language}"
