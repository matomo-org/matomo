...
class API extends \Piwik\Plugin\API
{
     ...
     *
     * Unlike the individual toggles this also activates the whole-policy enforcement state,
     * matching what enforcing the policy did before individual settings could be toggled.
     * Every setting stays individually toggleable afterwards.
     *
     * @param int|string $idSite Site ID to update, or `all` for the instance-wide state.
    ...
    public function enforceCompliancePolicySettings(
        ...
        PolicyManager::setPolicyActiveStatus($policy, true, $idSite);
