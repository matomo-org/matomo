...
class LogDataAnonymizerTest extends IntegrationTestCase
{
    ...
    public function test_anonymizeInformation_restrictSites()
    {
        ...
        $result3 = $this->anonymizer->unsetLogLinkVisitActionColumns($idSites = array(1,3), $startDate = '2010-01-01 00:00:00', $endDate = '2035-01-01 23:59:59', ['idaction_name', 'idaction_event_category', 'pageview_position', 'idpageview', 'bandwidth']);
    ...
    public function test_anonymizeInformation_restrictDate()
    {
        ...
        $result3 = $this->anonymizer->unsetLogLinkVisitActionColumns($idSites = null, $startDate, $endDate, ['idaction_name', 'idaction_event_category', 'pageview_position', 'idpageview', 'bandwidth']);
