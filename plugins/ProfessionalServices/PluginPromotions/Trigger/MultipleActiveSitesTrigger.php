 ...
 *
 * The only promotion that looks past the website the dashboard is showing: what makes a
 * portfolio view worth having is the number of *other* websites the same person has to
 * keep an eye on.
 *
 ...
 */
class MultipleActiveSitesTrigger implements PromotionTrigger
{
