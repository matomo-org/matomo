...
class API extends \Piwik\Plugin\API
{
     ...
     * @return \Piwik\DataTable|\Piwik\DataTable\Map Screen resolution metrics for the requested site and period.
     */
     ...
     *                                   Example: "referrerName==example.com"
     *                                   Supports AND (;) and OR (,) operators.
     * @return \Piwik\DataTable|\Piwik\DataTable\Map Device configuration metrics for the requested site and period.
     */
