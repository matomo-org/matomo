...
Segmentation = (function($) {
    ...
    var segmentation = function segmentation(config) {
        ...
        self.panelInstanceId = 'segment-editor-panel-' + Math.random().toString(36).slice(2, 12);
        ...
        var closeAllOpenLists = function() {
            Object.keys(panelInstanceRegistry).forEach(function (panelInstanceId) {
                if (panelInstanceId !== self.panelInstanceId && panelInstanceRegistry[panelInstanceId] && typeof panelInstanceRegistry[panelInstanceId].closePanel === 'function') {
                    panelInstanceRegistry[panelInstanceId].closePanel();
                }
            });
        };
        ...
        panelInstanceRegistry[self.panelInstanceId] = {
            closePanel,
        };
        ...
        this.destroy = function () {
          ...
          delete panelInstanceRegistry[self.panelInstanceId];
        };
