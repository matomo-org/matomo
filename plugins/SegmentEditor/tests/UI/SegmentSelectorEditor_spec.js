...
describe("SegmentSelectorEditorTest", function () {
    ...
    it('should not allow comparing segments more than the limit set', async function() {
      ...
      // await page.click('.segmentationContainer .title');
      // await page.waitForTimeout(100);
      // await page.click(getSegmentCompareQuery(1));
      // await page.waitForTimeout(100);
      ...
      console.log('should i click segmentation title? ', segmentListIsExpanded);
      if (segmentListIsExpanded) {
        await page.click('.segmentationContainer .title');
        await page.waitForTimeout(100);
      }
      // await page.waitForSelector('.segmentEditorPanel.expanded .segmentListContainer .dropdown-body', { visible: true });
      ...
      // await page.click('.segmentationContainer .title');
      // await page.waitForTimeout(100);
      // await page.click(getSegmentCompareQuery(2));
      // await page.click('.segmentationContainer .title');
      // await page.click(getSegmentCompareQuery(3));
      // await page.waitForTimeout(100);
      ...
      console.log('comparedCount', comparedCount);
