...
If you would like to contribute a version of the client in another programming language (Python, Java, Ruby, Perl, etc.) please <a target='_blank' href='{$currentUrlWithoutFilename}misc/redirectToUrl.php?url=http://dev.piwik.org/'>create a ticket</a> in our developer area (attach the client code to the ticket).
