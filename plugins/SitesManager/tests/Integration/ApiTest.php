...
class ApiTest extends IntegrationTestCase
{
    ...
    /**
     * @dataProvider getSitesWithPermissionsTestData
     */
    public function testGetSitesWithPermission(
        string $permission,
        ?string $pattern,
        ?int $limit,
        ...
        $result = Api::getInstance()->getSitesWithPermission($permission, $pattern, $limit, $sitesToExclude, $siteTypesToExclude);
        self::assertEquals($expectedSites, array_column($result, 'idsite'));
    }

    public function getSitesWithPermissionsTestData(): iterable
    {
