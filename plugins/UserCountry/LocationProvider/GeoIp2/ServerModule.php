...
use Piwik\Plugins\UserCountry\SystemSettings;
use Piwik\Url;
...
class ServerModule extends GeoIp2
{
    ...
    public function getInfo()
    {
        ...
        $desc = Piwik::translate('UserCountry_GeoIp2LocationProviderDesc_ServerModule', array('<strong>', '</strong>'))
            . '<br/><br/>'
            . Piwik::translate('UserCountry_GeoIpLocationProviderDesc_ServerBasedAnonWarn')
            . '<br/><br/>'
            . Piwik::translate('UserCountry_GeoIp2LocationProviderDesc_ServerModule2',
