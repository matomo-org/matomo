(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["UserCountryMap"] = factory();
	else
		root["UserCountryMap"] = factory();
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VisitorMap", function() { return /* reexport */ VisitorMap; });
...
// CONCATENATED MODULE: ./plugins/UserCountryMap/vue/src/VisitorMap/VisitorMap.ts
/*!
...
var _window = window,
    $ = _window.$;
/* harmony default export */ var VisitorMap = ({
  mounted: function mounted(el, binding) {
    ...
    if ($('#dashboardWidgetsArea').length) {
      ...
      }).on('widget:maximise', function () {
        visitorMap.resize();
      }).on('widget:minimise', function () {
        visitorMap.resize();
      }).on('widget:destroy', function () {
        visitorMap.destroy();
      });
    } else {
      // stand-alone mode
