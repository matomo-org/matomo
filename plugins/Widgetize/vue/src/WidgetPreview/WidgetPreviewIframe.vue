...
<template>
  <div id="embedThisWidgetIframe">
    <label for="embedThisWidgetIframeInput" v-html="translate('Widgetize_EmbedIframe')"></label>
  ...
  <div>
    <label for="embedThisWidgetDirectLink" v-html="translate('Widgetize_DirectLink')"></label>
