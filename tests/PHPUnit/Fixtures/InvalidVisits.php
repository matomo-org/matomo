...
class InvalidVisits extends Fixture
{
    ...
    private function trackVisits()
    {
        ...
        foreach (array(false, true) as $enable) {
            ...
            API::getInstance()->updateSite($idSite, 'new site name', $url = array('http://site.com'), $ecommerce = 0, $ss = 1, $ss_kwd = '', $ss_cat = '', "$excludedIp\n1.2.3.4", $excludedQueryParameters = null, $timezone = null, $currency = null, $group = null, $startDate = null, $excludedUserAgents = 'excludeduseragentstring');
