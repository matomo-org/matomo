    ...
    protected function checkEnoughUrlsAreTested($requestUrls)
    {
        ...
        if (
            ...
            throw new Exception("Only generated $countUrls API calls to test but was expecting more for this test.\n" .
                    ...
                    "If you want to test other API methods such as add* or update* or any other, please create an IntegrationTestCase instead " .
                    "(see plugins/ExamplePlugin/tests/Integration/SimpleTest.php)\n");
        }
    }
