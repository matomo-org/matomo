...
class QueueConsumerTest extends IntegrationTestCase
{
    ...
    public function testDeletedSegment()
    {
            ...
            2 =>
              array (
                0 =>
                  array (
                    'idarchive' => '1',
                    'name' => 'done3736b708e4d20cfc10610e816a1b2341.ExamplePlugin',
                    'idsite' => '1',
                    'date1' => '2018-03-04',
                    'date2' => '2018-03-04',
                    'period' => '1',
        ...
        $this->assertEquals($iteratedInvalidations, $expectedInvalidationsFound, "Deleted Segment being processed.");
