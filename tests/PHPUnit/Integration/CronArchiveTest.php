...
Found no visits for site ID = 1, day (2020-04-28,2020-04-28), site is using the tracker so skipping archiving...
Skipping invalidated archive : segment 'actions>=4' is not in --force-idsegments
Skipping invalidated archive : segment 'actions>=4' is not in --force-idsegments
Skipping invalidated archive : segment 'actions>=4' is not in --force-idsegments
Found no visits for site ID = 1, day (2020-04-29,2020-04-29), site is using the tracker so skipping archiving...
Found no visits for site ID = 1, day (2020-04-30,2020-04-30), site is using the tracker so skipping archiving...
...
No next invalidated archive.
Finished archiving for site 1, 62 API requests, Time elapsed: %d.%ds [1 / 1 done]
