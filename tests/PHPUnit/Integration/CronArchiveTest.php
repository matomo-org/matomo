...
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 33, idsite = 1, period = day(2020-01-01 - 2020-01-01), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 52, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 52, idsite = 1, period = day(2020-01-01 - 2020-01-01), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 34, idsite = 1, period = month(2020-01-01 - 2020-01-31), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 53, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 53, idsite = 1, period = month(2020-01-01 - 2020-01-31), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 35, idsite = 1, period = year(2020-01-01 - 2020-12-31), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 54, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 54, idsite = 1, period = year(2020-01-01 - 2020-12-31), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 28, idsite = 1, period = day(2019-12-31 - 2019-12-31), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 47, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 47, idsite = 1, period = day(2019-12-31 - 2019-12-31), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 26, idsite = 1, period = day(2019-12-30 - 2019-12-30), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 45, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 45, idsite = 1, period = day(2019-12-30 - 2019-12-30), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 27, idsite = 1, period = week(2019-12-30 - 2020-01-05), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 46, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 46, idsite = 1, period = week(2019-12-30 - 2020-01-05), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 24, idsite = 1, period = day(2019-12-23 - 2019-12-23), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 43, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 43, idsite = 1, period = day(2019-12-23 - 2019-12-23), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 25, idsite = 1, period = week(2019-12-23 - 2019-12-29), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 44, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 44, idsite = 1, period = week(2019-12-23 - 2019-12-29), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 22, idsite = 1, period = day(2019-12-16 - 2019-12-16), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 41, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 41, idsite = 1, period = day(2019-12-16 - 2019-12-16), name = done49a9440bd6dba4b8850035e09d043c67]
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 23, idsite = 1, period = week(2019-12-16 - 2019-12-22), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 42, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 42, idsite = 1, period = week(2019-12-16 - 2019-12-22), name = done49a9440bd6dba4b8850035e09d043c67]
...
Found invalidated archive we can skip (no visits or latest archive is not invalidated): [idinvalidation = 20, idsite = 1, period = day(2019-12-09 - 2019-12-09), name = donee0512c03f7c20af6ef96a8d792c6bb9f]
Skipping invalidated archive 39, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 39, idsite = 1, period = day(2019-12-09 - 2019-12-09), name = done49a9440bd6dba4b8850035e09d043c67]
...
Found archive with intersecting period with others in concurrent batch, skipping until next batch: [idinvalidation = 40, idsite = 1, period = week(2019-12-09 - 2019-12-15), name = done49a9440bd6dba4b8850035e09d043c67]
...
Found archive with intersecting period with others in concurrent batch, skipping until next batch: [idinvalidation = 36, idsite = 1, period = day(2019-12-02 - 2019-12-02), name = done49a9440bd6dba4b8850035e09d043c67]
...
Found archive with intersecting period with others in concurrent batch, skipping until next batch: [idinvalidation = 37, idsite = 1, period = week(2019-12-02 - 2019-12-08), name = done49a9440bd6dba4b8850035e09d043c67]
...
Found archive with intersecting period with others in concurrent batch, skipping until next batch: [idinvalidation = 38, idsite = 1, period = month(2019-12-01 - 2019-12-31), name = done49a9440bd6dba4b8850035e09d043c67]
...
Found archive with intersecting period with others in concurrent batch, skipping until next batch: [idinvalidation = 51, idsite = 1, period = year(2019-01-01 - 2019-12-31), name = done49a9440bd6dba4b8850035e09d043c67]
...
Skipping invalidated archive 40, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 40, idsite = 1, period = week(2019-12-09 - 2019-12-15), name = done49a9440bd6dba4b8850035e09d043c67]
...
Skipping invalidated archive 36, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 36, idsite = 1, period = day(2019-12-02 - 2019-12-02), name = done49a9440bd6dba4b8850035e09d043c67]
...
Skipping invalidated archive 37, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 37, idsite = 1, period = week(2019-12-02 - 2019-12-08), name = done49a9440bd6dba4b8850035e09d043c67]
...
Skipping invalidated archive 38, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 38, idsite = 1, period = month(2019-12-01 - 2019-12-31), name = done49a9440bd6dba4b8850035e09d043c67]
...
Skipping invalidated archive 51, segment 'actions>=4' is not in --force-idsegments: [idinvalidation = 51, idsite = 1, period = year(2019-01-01 - 2019-12-31), name = done49a9440bd6dba4b8850035e09d043c67]
No next invalidated archive.
