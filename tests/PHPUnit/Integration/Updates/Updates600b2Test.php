...
use Piwik\Updates\Updates_6_0_0_b2;

require_once PIWIK_INCLUDE_PATH . '/core/Updates/6.0.0-b2.php';
...
class Updates600b2Test extends IntegrationTestCase
{
    ...
    private function buildUpdate(): Updates_6_0_0_b2
    {
        ...
        return new Updates_6_0_0_b2($migrationFactory);
    }
