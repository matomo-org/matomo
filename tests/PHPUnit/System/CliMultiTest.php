...
class CliMultiTest extends SystemTestCase
{
    ...
    public function testRequestShouldBeAbleToRenderARegularPageInPiwik()
    {
        ...
        $this->assertTrue(str_contains($response[0], '<meta name="generator" content="Matomo - free/libre analytics platform"/>'), $message);
        $this->assertTrue(str_contains($response[0], 'vue-entry="Widgetize.ExportWidget"'), $message);
    }
