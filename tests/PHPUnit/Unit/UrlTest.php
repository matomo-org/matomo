...
class UrlTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testAddCampaignParametersToMatomoLink($url, $expected)
    {
        $this->resetGlobalVariables();
        $_GET['module'] = 'CoreHomeAdmin';
        $_GET['action'] = 'trackingCodeGenerator';
        $this->assertEquals($expected, Url::addCampaignParametersToMatomoLink($url));
    }
    ...
    public function getCampaignParametersToMatomoLink()
    {
        return [
            // Matomo url
            ['https://matomo.org/faq/123', 'https://matomo.org/faq/123?mtm_campaign=Matomo_App&mtm_source=Matomo_App_OnPremise&mtm_medium=CoreHomeAdmin.trackingCodeGenerator'],
            ...
            // Matomo url, anchor
            ['https://matomo.org/faq/123#anchor', 'https://matomo.org/faq/123#anchor?mtm_campaign=Matomo_App&mtm_source=Matomo_App_OnPremise&mtm_medium=CoreHomeAdmin.trackingCodeGenerator'],

            // Matomo url, anchor and parameter
            ['https://matomo.org/faq/123/#anchor?abc=123', 'https://matomo.org/faq/123/#anchor?abc=123&mtm_campaign=Matomo_App&mtm_source=Matomo_App_OnPremise&mtm_medium=CoreHomeAdmin.trackingCodeGenerator'],

            // Matomo url, one parameter
            ['https://matomo.org/faq/123?abc=123', 'https://matomo.org/faq/123?abc=123&mtm_campaign=Matomo_App&mtm_source=Matomo_App_OnPremise&mtm_medium=CoreHomeAdmin.trackingCodeGenerator'],

            // Matomo url, two parameters
            ['https://matomo.org/faq/123?abc=123&def=456', 'https://matomo.org/faq/123?abc=123&def=456&mtm_campaign=Matomo_App&mtm_source=Matomo_App_OnPremise&mtm_medium=CoreHomeAdmin.trackingCodeGenerator'],

            // Matomo url with www subdomain, anchor and two parameters
            ['https://www.matomo.org/faq/123#anchor?abc=123&def=456', 'https://www.matomo.org/faq/123#anchor?abc=123&def=456&mtm_campaign=Matomo_App&mtm_source=Matomo_App_OnPremise&mtm_medium=CoreHomeAdmin.trackingCodeGenerator'],

            // Non-matomo URL, two parameters and anchor - no change expected
            ['https://example.org/faq/123#anchor?abc=123&def=456', 'https://example.org/faq/123#anchor?abc=123&def=456'],
        ];
    }
