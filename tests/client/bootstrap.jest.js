...
// Emptied once per spec file rather than per test: jest runs setupFiles before the test framework
// is installed, so beforeEach is not available here. Specs read the observer created last, so any
// left behind by an earlier test in the same file are ignored anyway.
